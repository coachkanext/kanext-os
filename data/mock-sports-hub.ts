...
export const TEAM_KR = {
  ...
  seasonHigh: 72.0,
  seasonLow:  60.0,
  history:    [60.0, 62.4, 64.8, 66.2, 68.0, 69.4, 70.1, 71.2, 72.0],
};

export const TEAM_SYSTEM = {
  offense: { name: 'Spread PnR',   locked: true,  confidence: 75, pace: 95, primary: 'Pick-and-Roll', secondary: 'Moreyball', transition: 75 },
  defense: { name: 'Pressure Man', locked: true,  confidence: 70, pressure: 'Full Court', help: 'Backline', rebounding: 'Box Out Man' },
  offDesc: 'Extra fast tempo Spread PnR (75%) + Moreyball (25%). Logo-range 3PT from Kalejaiye creates spacing for Williams to attack the rim.',
  defDesc: 'Pressure Man (80%) + Zone (20%). Active hands generating steals and transition opportunities.',
  offCover: ['PnR creation (Kalejaiye)', 'Rim-and-threes shot diet', 'Free throw generation', 'Transition offense'],
  offGaps:  ['No reliable 2nd/3rd spot-up specialist', 'Half-court sets vs zone'],
  defCover: ['POA pressure', 'Steals and transition', 'Active hands'],
  defGaps:  ['No switchable defender wing', 'Rim protection depth', 'No 3-and-D wing'],
  fragility: ['SINGLE-POINT FAILURE: Kalejaiye is sole PnR engine', 'Kalejaiye = 29.2% usage, 33.8% of team scoring'],
};

export const NEXT_GAME = {
  opponent:   'Season Complete — 15-8',
  oppHue:     35,
  date:       'Final: SWS Champions + GAAC Tournament Champions',
  time:       '',
  venue:      'Laney College',
  location:   'H' as const,
  oppRecord:  '',
  oppConfRec: '',
  confStand:  'Back-to-Back Champions',
  countdown:  'Season Over',
  isConference: false,
};
...
export const PLAYERS: Player[] = [
  // ── Starters ──
  {
    ...
    position: 'PG', classYear: 'So', heightFt: '5\'10"', weight: 180, hometown: 'Los Angeles, CA', highSchool: 'Cathedral HS',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 86, offensive: 70, defensive: 50, confidence: 73, tier: 'V2', trend: 'up', delta: 3.0 },
    archetype: 'PNR Ball Handler',
    traits: { shooting: 88, finishing: 80, playmaking: 82, defense: 62, athleticism: 86, iq: 88, tools: 78 },
    badges: ['1st Team All-SWS x2', 'Captain', 'GAAC Tournament Champion', 'Suppression Indicator'],
    stats: { ppg: 27.3, rpg: 2.9, apg: 2.9, spg: 1.4, bpg: 0.0, fgPct: 39.5, fg3Pct: 35.5, ftPct: 88.4, mpg: 37, gp: 15 },
    medical: 'available', eligibility: 'eligible', gpa: 3.0, credits: 52, role: 'Starter',
    systemFitOff: 92, systemFitDef: 62,
  },
  {
    id: 'p02', name: 'Brandon Williams', initials: 'BW', number: 1, hue: 190,
    position: 'SG', classYear: 'Jr', heightFt: '6\'4"', weight: 185, hometown: 'Miami, FL', highSchool: 'Albany Tech CC',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 76, offensive: 54, defensive: 52, confidence: 48, tier: 'V2', trend: 'flat', delta: 0.0 },
    archetype: 'Shot-Creating Wing',
    traits: { shooting: 55, finishing: 92, playmaking: 70, defense: 68, athleticism: 84, iq: 72, tools: 80 },
    badges: ['Interior Finisher', 'Elite Rebounder', 'Steal Machine', 'Played Through Injury'],
    stats: { ppg: 19.3, rpg: 6.5, apg: 3.2, spg: 2.6, bpg: 0.3, fgPct: 60.6, fg3Pct: 25.7, ftPct: 77.9, mpg: 32, gp: 14 },
    medical: 'available', eligibility: 'eligible', gpa: 2.8, credits: 64, role: 'Starter',
    systemFitOff: 72, systemFitDef: 68,
  },
  {
    id: 'p03', name: 'Claude McKesey',   initials: 'CM', number: 3, hue: 160,
    position: 'SG', classYear: 'Gr', heightFt: '5\'10"', weight: 190, hometown: 'View Park, CA', highSchool: 'St. Bernard HS',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 71, offensive: 40, defensive: 50, confidence: 48, tier: 'V2', trend: 'flat', delta: 0.0 },
    archetype: 'Playmaking Guard',
    traits: { shooting: 40, finishing: 72, playmaking: 84, defense: 68, athleticism: 74, iq: 78, tools: 72 },
    badges: ['Elite Passer', 'Highest Lift Factor (1.61)', 'Senior Leader', 'Effort-Based Production'],
    stats: { ppg: 12.4, rpg: 6.3, apg: 4.7, spg: 1.5, bpg: 0.1, fgPct: 41.1, fg3Pct: 6.3, ftPct: 65.7, mpg: 30, gp: 15 },
    medical: 'available', eligibility: 'eligible', gpa: 3.3, credits: 108, role: 'Starter',
    systemFitOff: 55, systemFitDef: 68,
  },
  {
    id: 'p04', name: 'Nathan Chatelain', initials: 'NC', number: 15, hue: 300,
    position: 'SF', classYear: 'Fr', heightFt: '6\'7"', weight: 200, hometown: 'France', highSchool: 'France',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 71, offensive: 52, defensive: 59, confidence: 50, tier: 'V1+', trend: 'up', delta: 2.0 },
    archetype: 'Stretch Four',
    traits: { shooting: 70, finishing: 76, playmaking: 58, defense: 74, athleticism: 74, iq: 72, tools: 84 },
    badges: ['Most Level-Stable', 'Shot Blocker', 'Best Development Upside', '3 Years Remaining'],
    stats: { ppg: 10.5, rpg: 6.6, apg: 1.1, spg: 0.7, bpg: 1.3, fgPct: 52.0, fg3Pct: 26.1, ftPct: 63.9, mpg: 28, gp: 15 },
    medical: 'available', eligibility: 'eligible', gpa: 2.8, credits: 16, role: 'Starter',
    systemFitOff: 68, systemFitDef: 76,
  },
  // ── Rotation ──
  {
    id: 'p05', name: 'Adrian Hernandez', initials: 'AH', number: 10, hue: 50,
    position: 'SG', classYear: 'Jr', heightFt: '5\'11"', weight: 185, hometown: 'Pasadena, CA', highSchool: 'Arcadia HS',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 62, offensive: 40, defensive: 44, confidence: 45, tier: 'V1+', trend: 'flat', delta: 0.0 },
    archetype: 'Spot-Up Shooter',
    traits: { shooting: 72, finishing: 60, playmaking: 58, defense: 62, athleticism: 68, iq: 66, tools: 68 },
    badges: ['Lowest TO Rate', 'Streaky Shooter', 'Level-Dependent'],
    stats: { ppg: 7.6, rpg: 2.1, apg: 1.4, spg: 1.2, bpg: 0.1, fgPct: 41.4, fg3Pct: 34.2, ftPct: 83.3, mpg: 25, gp: 15 },
    medical: 'available', eligibility: 'eligible', gpa: 2.9, credits: 96, role: 'Rotation',
    systemFitOff: 62, systemFitDef: 62,
  },
  {
    id: 'p06', name: 'Chris Plantey',    initials: 'CP', number: 2, hue: 140,
    position: 'SG', classYear: 'So', heightFt: '5\'8"', weight: 170, hometown: 'French Guinea', highSchool: 'Cathedral HS',
    isScholarship: false, isRedshirt: false,
    kr: { overall: 61, offensive: 34, defensive: 49, confidence: 45, tier: 'V1+', trend: 'flat', delta: 0.0 },
    archetype: 'Defensive Anchor',
    traits: { shooting: 66, finishing: 54, playmaking: 56, defense: 74, athleticism: 66, iq: 72, tools: 64 },
    badges: ['Defensive Specialist', 'Consistent Steals', '.571 3P% NAIA'],
    stats: { ppg: 3.2, rpg: 1.1, apg: 1.5, spg: 0.9, bpg: 0.0, fgPct: 31.4, fg3Pct: 33.3, ftPct: 100.0, mpg: 20, gp: 15 },
    medical: 'available', eligibility: 'eligible', gpa: 2.9, credits: 52, role: 'Rotation',
    systemFitOff: 55, systemFitDef: 68,
  },
  {
    id: 'p07', name: 'Samuel Wall',      initials: 'SW', number: 6, hue: 30,
    position: 'SG', classYear: 'Fr', heightFt: '6\'0"', weight: 190, hometown: 'Warwick, Australia', highSchool: 'Warwick State HS',
    isScholarship: false, isRedshirt: false,
    kr: { overall: 60, offensive: 44, defensive: 40, confidence: 48, tier: 'V1+', trend: 'up', delta: 2.0 },
    archetype: 'Spot-Up Shooter',
    traits: { shooting: 82, finishing: 62, playmaking: 56, defense: 56, athleticism: 70, iq: 74, tools: 66 },
    badges: ['.519 3P% Overall', '.667 3P% USCAA', '3 Years Remaining'],
    stats: { ppg: 5.1, rpg: 2.1, apg: 1.1, spg: 0.6, bpg: 0.2, fgPct: 50.0, fg3Pct: 51.9, ftPct: 80.0, mpg: 18, gp: 14 },
    medical: 'available', eligibility: 'eligible', gpa: 3.1, credits: 16, role: 'Rotation',
    systemFitOff: 66, systemFitDef: 58,
  },
  {
    id: 'p08', name: 'Paul Diomande',    initials: 'PD', number: 21, hue: 20,
    position: 'PF', classYear: 'Jr', heightFt: '6\'6"', weight: 215, hometown: 'Abidjan, Ivory Coast', highSchool: 'Alameda CC',
    isScholarship: true, isRedshirt: false,
    kr: { overall: 55, offensive: 37, defensive: 38, confidence: 45, tier: 'V1', trend: 'down', delta: -1.0 },
    archetype: 'Energy Big',
    traits: { shooting: 28, finishing: 72, playmaking: 42, defense: 56, athleticism: 70, iq: 30, tools: 76 },
    badges: ['Interior Finisher', 'Developmental Prospect'],
    stats: { ppg: 3.2, rpg: 2.6, apg: 0.2, spg: 0.0, bpg: 0.4, fgPct: 39.5, fg3Pct: 20.0, ftPct: 68.8, mpg: 15, gp: 13 },
    medical: 'available', eligibility: 'eligible', gpa: 2.6, credits: 62, role: 'Rotation',
    systemFitOff: 58, systemFitDef: 58,
  },
];
...
export const NIL_DEALS: NILDeal[] = [
  ...
  { id: 'nd2', playerId: 'p03', playerName: 'Claude McKesey',   brand: 'East Bay Sports',     type: 'social-post', amount: 900,  status: 'completed',   compliance: 'approved', startDate: 'Jan 15', endDate: 'Mar 31', deliverables: ['4 Instagram posts', '1 Reel'], completed: 100 },
  { id: 'nd3', playerId: 'p08', playerName: 'Paul Diomande',    brand: 'Under Armour Campus', type: 'endorsement', amount: 2400, status: 'in-progress', compliance: 'pending',  startDate: 'Mar 1',  endDate: 'Jun 30', deliverables: ['Photo shoot (complete)', '2 social posts', '1 campus store appearance'], completed: 40 },
  { id: 'nd4', playerId: 'p04', playerName: 'Nathan Chatelain', brand: 'Jordan Brand',        type: 'ambassador',  amount: 4200, status: 'in-progress', compliance: 'approved', startDate: 'Feb 15', endDate: 'Aug 15', deliverables: ['4 social posts', '2 campus store appearances', 'Brand ambassador bio'], completed: 50 },
  { id: 'nd5', playerId: 'p07', playerName: 'Samuel Wall',      brand: 'Nike Campus',         type: 'endorsement', amount: 2800, status: 'in-progress', compliance: 'pending',  startDate: 'Mar 10', endDate: 'Jul 31', deliverables: ['Photo shoot', '3 social posts', '1 campus event'], completed: 25 },
  { id: 'nd6', playerId: 'p02', playerName: 'Brandon Williams', brand: 'Bay Area Hoops Talk', type: 'social-post', amount: 800,  status: 'completed',   compliance: 'approved', startDate: 'Jan 20', endDate: 'Mar 1',  deliverables: ['3 Instagram posts', '1 Twitter thread'], completed: 100 },
];
...
export const NIL_ACTIVITY: NILActivity[] = [
  ...
  { id: 'na2', playerId: 'p04', playerName: 'Nathan Chatelain', initials: 'NC', hue: 300, action: 'Posted 2 brand reels — 480K views', brand: 'Jordan Brand',       timestamp: '5h ago'               },
  { id: 'na3', playerId: 'p08', playerName: 'Paul Diomande',    initials: 'PD', hue: 20,  action: 'Completed photo shoot',             brand: 'Under Armour Campus', timestamp: 'Yesterday'           },
  { id: 'na4', playerId: 'p03', playerName: 'Claude McKesey',   initials: 'CM', hue: 160, action: 'Deal paid out',                     brand: 'East Bay Sports',    timestamp: 'Yesterday', amount: 900 },
  { id: 'na5', playerId: 'p07', playerName: 'Samuel Wall',      initials: 'SW', hue: 30,  action: 'NIL compliance submitted',          brand: 'Nike Campus',        timestamp: '2 days ago'           },
];
...
export const FAN_EXPERIENCES: FanExperience[] = [
  ...
  { id: 'fe2', playerId: 'p08', playerName: 'Paul Diomande',    initials: 'PD', hue: 20,  type: 'signed-item', title: 'Signed Jersey #21',        description: 'Authentic game jersey hand-signed by Paul. Includes certificate of authenticity.',      price: 45, spotsLeft: 0,  isRaffle: false },
  { id: 'fe3', playerId: 'p04', playerName: 'Nathan Chatelain', initials: 'NC', hue: 300, type: 'raffle',      title: 'Meet & Greet Raffle',      description: 'Win a 15-min meet & greet with Nathan at Laney College. Monthly drawing.',              price: 10, spotsLeft: 14, isRaffle: true  },
  { id: 'fe4', playerId: 'p03', playerName: 'Claude McKesey',   initials: 'CM', hue: 160, type: 'training',    title: '1-on-1 Training Session',  description: 'Book a private 45-min ball-handling session with Claude at Laney College.',              price: 65, spotsLeft: 3,  isRaffle: false },
];
...
export const SCHOLARSHIP_ALLOCATIONS: { playerId: string; pct: number; tier: 'Core' | 'Rotation' | 'Depth' | 'Development' }[] = [
  ...
  { playerId: 'p03', pct: 100, tier: 'Core' },
  { playerId: 'p04', pct: 80,  tier: 'Rotation' },
  { playerId: 'p05', pct: 80,  tier: 'Rotation' },
  { playerId: 'p06', pct: 0,   tier: 'Depth' },   // Walk-On
  { playerId: 'p07', pct: 0,   tier: 'Depth' },   // Walk-On
  { playerId: 'p08', pct: 60,  tier: 'Rotation' },
];

export const DEVELOPMENT_PRIORITIES: { playerId: string; priorities: { trait: string; current: number; target: number }[] }[] = [
  { playerId: 'p01', priorities: [{ trait: '3PT Off Dribble', current: 82, target: 90 }, { trait: 'On-Ball Defense', current: 62, target: 72 }, { trait: 'FT%', current: 88, target: 92 }] },
  { playerId: 'p02', priorities: [{ trait: '3PT Shooting', current: 55, target: 65 }, { trait: 'FT%', current: 78, target: 85 }, { trait: 'Half-Court Creation', current: 68, target: 76 }] },
  { playerId: 'p04', priorities: [{ trait: 'Spot-Up 3PT', current: 70, target: 80 }, { trait: 'FT%', current: 64, target: 75 }, { trait: 'PnP Gravity', current: 60, target: 72 }] },
  { playerId: 'p08', priorities: [{ trait: 'FT%', current: 69, target: 76 }, { trait: 'IQ/Decision-Making', current: 30, target: 45 }, { trait: 'Playmaking', current: 42, target: 54 }] },
];
