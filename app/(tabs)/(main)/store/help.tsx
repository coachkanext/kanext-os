/**
 * Store Help — tile-level help for the Store tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'PRODUCTS',
    rows: [
      { icon: 'square.grid.2x2.fill',   title: 'Adding and editing products',    keywords: 'add edit product digital physical'   },
      { icon: 'tag.fill',               title: 'Setting prices and discounts',   keywords: 'price discount sale coupon'          },
      { icon: 'photo',                  title: 'Adding product images',          keywords: 'image photo thumbnail product'       },
    ],
  },
  {
    header: 'SUBSCRIPTIONS',
    rows: [
      { icon: 'star.fill',              title: 'Creating subscriber tiers',      keywords: 'tier subscription membership create' },
      { icon: 'lock.fill',              title: 'Managing subscriber access',     keywords: 'access gated content subscriber'     },
      { icon: 'gift.fill',              title: 'Setting up perks',               keywords: 'perks benefits subscriber reward'    },
    ],
  },
  {
    header: 'ORDERS',
    rows: [
      { icon: 'shippingbox.fill',       title: 'Processing orders',              keywords: 'order process fulfill shipping'      },
      { icon: 'arrow.counterclockwise', title: 'Handling refunds',               keywords: 'refund return cancel order'          },
    ],
  },
  {
    header: 'PAYMENTS',
    rows: [
      { icon: 'arrow.up.right.circle',  title: 'When payouts happen',            keywords: 'payout timing schedule transfer'     },
      { icon: 'percent',                title: 'Understanding fees',             keywords: 'fees commission platform percentage' },
    ],
  },
];
...
export default function StoreHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>Store Help</Text>
            </View>
          </View>
