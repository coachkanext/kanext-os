/**
 * KTV Help — FAQ and support for the KayTV tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'UPLOADING',
    rows: [
      { icon: 'arrow.up.circle.fill', title: 'How to upload a video',         keywords: 'upload video add publish'              },
      { icon: 'video.fill',            title: 'Supported formats and limits',  keywords: 'format mp4 size limit resolution'      },
      { icon: 'captions.bubble.fill',  title: 'Setting up captions',           keywords: 'captions subtitles auto accessibility' },
      { icon: 'eye.slash.fill',        title: 'Public vs private videos',      keywords: 'visibility private public unlisted'    },
    ],
  },
  {
    header: 'YOUR CHANNEL',
    rows: [
      { icon: 'tv',          title: 'Setting up your channel',   keywords: 'channel setup brand customise'    },
      { icon: 'folder.fill', title: 'Organizing your content',   keywords: 'organize playlist categories'     },
      { icon: 'sparkles',    title: 'Featuring videos',          keywords: 'feature pin highlight promoted'   },
    ],
  },
  {
    header: 'MONETIZATION',
    rows: [
      { icon: 'lock.fill',                 title: 'Subscriber-only content',    keywords: 'paywall subscriber access lock'   },
      { icon: 'chart.line.uptrend.xyaxis', title: 'Revenue and ad earnings',    keywords: 'ad revenue money earnings'        },
      { icon: 'arrow.up.right.circle',     title: 'When payouts happen',        keywords: 'payout timing bank transfer'      },
    ],
  },
  {
    header: 'ANALYTICS',
    rows: [
      { icon: 'chart.bar.fill', title: 'Understanding view metrics',  keywords: 'views watch time retention analytics' },
      { icon: 'person.2.fill',  title: 'Audience insights',           keywords: 'audience demographics followers viewers' },
    ],
  },
];
...
export default function KayTVHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>KTV Help</Text>
            </View>
          </View>
