...
const PEOPLE: EduPerson[] = [
  {
    ...
    email: 'rclark@howard.edu',
    phone: '(803) 555-0101',
    status: 'active',
    accessTier: 'founder',
    institutions: [{ id: 'inst-001', name: 'Howard University', shortName: 'Howard' }],
    seats: [SEATS[0]],
...
const AUDIT_LOG: AuditEntry[] = [
  ...
  },
  {
    ...
    target: 'Howard Athletics Director',
    actor: 'System',
