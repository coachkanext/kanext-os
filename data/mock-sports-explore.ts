...
export const CONTINUE_WATCHING: ContinueWatchingItem[] = [
  { id: 'cw-1', title: 'KaNeXT vs Thomas University', subtitle: 'Full Game Replay', duration: '1:48:32', progress: 0.65, thumbnailColor: '#1B4F8A' },
...
export const TOP_GAMES: GameCard[] = [
  { id: 'tg-1', homeTeam: 'KaNeXT Sports', homeInitials: 'KaNeXT', awayTeam: 'Webber Intl', awayInitials: 'WIU', date: 'Feb 21', badge: 'UPCOMING', duration: 'TBD', thumbnailColor: '#1B4F8A' },
  ...
  { id: 'tg-3', homeTeam: 'KaNeXT Sports', homeInitials: 'KaNeXT', awayTeam: 'Thomas Univ', awayInitials: 'THO', score: '82-74', date: 'Feb 15', duration: '1:48:32', thumbnailColor: '#1B4F8A' },
  ...
  { id: 'tg-7', homeTeam: 'KaNeXT Sports', homeInitials: 'KaNeXT', awayTeam: 'Warner', awayInitials: 'WAR', score: '88-76', date: 'Feb 11', duration: '1:52:10', thumbnailColor: '#1B4F8A' },
...
export const NEW_UPLOADS: GameCard[] = [
  { id: 'nu-1', homeTeam: 'KaNeXT', homeInitials: 'KaNeXT', awayTeam: 'Thomas', awayInitials: 'THO', score: '82-74', date: '2h ago', duration: '1:48:32', thumbnailColor: '#1B4F8A' },
  ...
  { id: 'nu-5', homeTeam: 'KaNeXT', homeInitials: 'KaNeXT', awayTeam: 'Warner', awayInitials: 'WAR', score: '88-76', date: '3d ago', duration: '1:52:10', thumbnailColor: '#1B4F8A' },
...
export const TRENDING_PROGRAMS: ProgramTile[] = [
  { id: 'tp-1', name: 'KaNeXT Sports', initials: 'KaNeXT', conference: 'KaNeXT Conference', record: '18-8', thumbnailColor: '#1B4F8A' },
  { id: 'tp-2', name: 'Southeastern', initials: 'SEU', conference: 'KaNeXT Conference', record: '20-6', thumbnailColor: '#C2185B' },
  ...
  { id: 'tp-6', name: 'Webber International', initials: 'WIU', conference: 'KaNeXT Conference', record: '16-10', thumbnailColor: '#7A5CFF' },
  { id: 'tp-7', name: 'St. Thomas', initials: 'STU', conference: 'KaNeXT Conference', record: '13-13', thumbnailColor: '#6AA9FF' },
  { id: 'tp-8', name: 'Thomas University', initials: 'THO', conference: 'KaNeXT Conference', record: '11-15', thumbnailColor: '#424242' },
];
...
export const PLAYERS_TO_WATCH: PlayerSpotlight[] = [
  { id: 'pw-1', name: 'Marcus Reed', position: 'PG', team: 'KaNeXT Sports', stat: '18.5 PPG / 7.1 APG', thumbnailColor: '#1B4F8A' },
  { id: 'pw-2', name: 'Devon Carter', position: 'B', team: 'KaNeXT Sports', stat: '14.0 PPG / 10.2 RPG', thumbnailColor: '#1B4F8A' },
  { id: 'pw-3', name: 'Paul Diomande', position: 'F', team: 'KaNeXT Sports', stat: '15.5 PPG / 8.0 RPG', thumbnailColor: '#1B4F8A' },
  { id: 'pw-4', name: 'Alex Morgan', position: 'CG', team: 'Southeastern', stat: '22.3 PPG / 4.1 APG', thumbnailColor: '#C2185B' },
...
export const EVENTS_SHOWCASES: EventCard[] = [
  ...
  { id: 'ev-4', title: 'South Ridgemont Prep Showcase', date: 'Apr 12-14', location: 'Fort Lauderdale, FL', type: 'showcase', thumbnailColor: '#6AA9FF' },
...
export const COACH_PICKS: CoachPick[] = [
  { id: 'cp-1', title: 'Zone Press Breakdown', subtitle: 'How KaNeXT dismantled Thomas\'s zone — film session', authorName: 'Coach K', thumbnailColor: '#1B4F8A', duration: '14:32' },
