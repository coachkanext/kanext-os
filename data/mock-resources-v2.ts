...
const libraryItems: ResourceItem[] = [
  {
    id: 'res-001',
    title: 'FMU MBB Coaching Philosophy',
    type: 'doc',
    category: 'library',
    scope: 'program',
...
const scoutingItems: ResourceScoutingItem[] = [
  ...
  },
  {
    ...
    type: 'opponent-pack',
    description: 'Full scouting package for South Florida A&T.',
...
const nexusSnapshots: ResourceNexusSnapshot[] = [
  ...
  {
    id: 'snap-005',
    title: 'Postgame Report — vs Lincoln',
    snapshotType: 'postgame-packet',
    context: 'vs Lincoln — Jan 25, 2026',
    createdBy: 'Sammy Kalejaiye',
    createdByInitials: 'SK',
...
const links: ResourceLink[] = [
  ...
  },
  {
    ...
    pinned: true,
    scope: 'program',
    addedBy: 'Sammy Kalejaiye',
    addedByInitials: 'SK',
    addedAt: 'Jan 3, 2026',
  },
  {
    id: 'link-003',
    title: 'FMU MBB Film Playlist',
...
const audit: ResourceAuditEntry[] = [
  ...
  },
  {
    ...
    actor: 'Sammy Kalejaiye',
    actorInitials: 'SK',
    target: 'Postgame Report — vs Lincoln',
    timestamp: 'Jan 25, 2026 — 10:45 PM',
    detail: 'Saved Nexus postgame packet after Lincoln game.',
  },
  {
    id: 'aud-008',
