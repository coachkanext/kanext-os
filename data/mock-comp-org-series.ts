...
export function getCompSeriesData(_scope: string) {
  ...
  const dashboard: SeriesDashboardBlock[] = [
    { id: 'ds-1', label: 'Total Series', value: '12', delta: '+2 this quarter', icon: 'sportscourt.fill', color: '#6AA9FF' },
    ...
    { id: 'ds-4', label: 'Prize Pool', value: '$425K', delta: '+$50K vs last year', icon: 'crown.fill', color: '#8B5CF6' },
    { id: 'ds-5', label: 'Live Series', value: '4', delta: '2 in semifinals', icon: 'play.circle.fill', color: '#EF4444' },
    { id: 'ds-6', label: 'Venues Booked', value: '9', delta: '3 pending confirmation', icon: 'mappin.and.ellipse', color: '#14B8A6' },
  ];

  const quickActions = [
    { id: 'qa-1', label: 'New Series', icon: 'plus.circle.fill', color: '#6AA9FF' },
    ...
    { id: 'qa-4', label: 'Run Report', icon: 'chart.bar.fill', color: '#8B5CF6' },
    { id: 'qa-5', label: 'Manage Awards', icon: 'crown.fill', color: '#EF4444' },
    { id: 'qa-6', label: 'Broadcast Setup', icon: 'video.fill', color: '#14B8A6' },
  ];

  const recentActivity = [
    { id: 'ra-1', text: 'FMU Blazers defeated Tom\u2019s Team (PBD) 3\u20131 in K-1 Invitational Round 3', time: '2h ago' },
    { id: 'ra-2', text: 'ICCLA League standings updated \u2014 Blazers move to 2nd place', time: '3h ago' },
    ...
    { id: 'ra-7', text: 'ICCLA League Round 8 schedule published', time: '1d ago' },
    { id: 'ra-8', text: 'FMU Blazers clinched playoff berth in ICCLA League', time: '1d ago' },
  ...
  const activeSeries: ActiveSeries[] = [
    { id: 'as-1', name: 'ICCLA Premier League', shortName: 'ICCLA', format: 'Round Robin', status: 'live', startDate: 'Sep 2025', endDate: 'May 2026', entrantCount: 16, matchCount: 120, currentRound: 'Matchday 22 of 30', prize: '$150,000' },
    ...
    { id: 'as-5', name: 'ICCLA Super Cup', shortName: 'ISC', format: 'Single Elimination', status: 'upcoming', startDate: 'Jun 2026', endDate: 'Jun 2026', entrantCount: 4, matchCount: 3, currentRound: 'Semifinal draw pending', prize: '$50,000' },
    ...
    { id: 'as-15', name: 'ICCLA Reserve League', shortName: 'IRL', format: 'Round Robin', status: 'live', startDate: 'Sep 2025', endDate: 'May 2026', entrantCount: 16, matchCount: 120, currentRound: 'Matchday 20 of 30', prize: '$20,000' },
  ...
  const formats: SeriesFormat[] = [
    { id: 'fmt-1', name: 'ICCLA Round Robin', type: 'round-robin', description: 'Each team plays every other team twice (home and away). Points awarded: 3 for win, 1 for draw, 0 for loss. Full season league format with relegation.', maxEntrants: 20, tiebreakers: ['Goal Difference', 'Goals Scored', 'Head-to-Head Record', 'Fair Play Points'] },
  ...
  const entrants: SeriesEntrant[] = [
    { id: 'ent-1', name: 'FMU Blazers', shortName: 'FMU', logo: 'flame', seed: 1, wins: 14, losses: 3, draws: 5, points: 47, gd: 22, status: 'active' },
  ...
  const calendar: CalendarEvent[] = [
    { id: 'cal-1', date: '2026-02-17', title: 'FMU Blazers vs Northridge United', type: 'match', series: 'ICCLA Premier League', venue: 'FMU Arena' },
    { id: 'cal-2', date: '2026-02-17', title: 'Tom\u2019s Team vs Metro FC', type: 'match', series: 'ICCLA Premier League', venue: 'PBD Sports Complex' },
    ...
    { id: 'cal-5', date: '2026-02-19', title: 'Transfer Deadline \u2014 ICCLA League', type: 'deadline', series: 'ICCLA Premier League', venue: '\u2014' },
    { id: 'cal-6', date: '2026-02-19', title: 'PBD Cup QF Draw Ceremony', type: 'ceremony', series: 'PBD Cup', venue: 'ICCLA Headquarters' },
    ...
    { id: 'cal-9', date: '2026-02-21', title: 'PBD Cup QF \u2014 FMU vs Eastside', type: 'match', series: 'PBD Cup', venue: 'FMU Arena' },
    { id: 'cal-10', date: '2026-02-21', title: 'PBD Cup QF \u2014 PBD vs Lakewood', type: 'match', series: 'PBD Cup', venue: 'PBD Sports Complex' },
    { id: 'cal-11', date: '2026-02-22', title: 'Eastside vs Central City', type: 'match', series: 'ICCLA Premier League', venue: 'Eastside Stadium' },
    { id: 'cal-12', date: '2026-02-22', title: 'K-1 Invitational R16 \u2014 Match 3', type: 'match', series: 'K-1 Invitational', venue: 'Valley Arena' },
    { id: 'cal-13', date: '2026-02-23', title: 'Award Voting Deadline \u2014 February', type: 'deadline', series: 'ICCLA Premier League', venue: '\u2014' },
    { id: 'cal-14', date: '2026-02-24', title: 'FMU Blazers vs Harbor Town', type: 'match', series: 'ICCLA Premier League', venue: 'FMU Arena' },
    ...
    { id: 'cal-19', date: '2026-02-27', title: 'Valley Rangers vs Hilltop Dynamo', type: 'match', series: 'ICCLA Premier League', venue: 'Valley Arena' },
    { id: 'cal-20', date: '2026-02-28', title: 'Monthly Board Meeting', type: 'ceremony', series: 'All Series', venue: 'ICCLA Headquarters' },
    ...
    { id: 'cal-24', date: '2026-03-04', title: 'ICCLA League Matchday 23', type: 'match', series: 'ICCLA Premier League', venue: 'Various' },
    { id: 'cal-25', date: '2026-03-05', title: 'Broadcast Rights Review Meeting', type: 'media', series: 'All Series', venue: 'ICCLA Headquarters' },
  ];

  // ── Awards ──
  const awards: Award[] = [
    { id: 'aw-1', name: 'League MVP', recipient: 'Marcus Cole (FMU Blazers)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-2', name: 'Golden Boot', recipient: 'Jalen Torres (Tom\u2019s Team PBD)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-3', name: 'Best XI', recipient: 'FMU Blazers (7 players selected)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    ...
    { id: 'aw-6', name: 'Fair Play Award', recipient: 'Lakewood SC', series: 'ICCLA Premier League', season: '2024\u201325', category: 'special', date: 'Jun 2025' },
    ...
    { id: 'aw-8', name: 'Coach of the Year', recipient: 'Sammy Kalejaiye (FMU Blazers)', series: 'All Series', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-9', name: 'Best Defense', recipient: 'FMU Blazers (18 goals conceded)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    ...
    { id: 'aw-13', name: 'Goalkeeper of the Year', recipient: 'Andre Marshall (Northridge United)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    ...
    { id: 'aw-16', name: 'Preseason Challenge Winner', recipient: 'FMU Blazers', series: 'Preseason Challenge', season: '2025\u201326', category: 'team', date: 'Aug 2025' },
    { id: 'aw-17', name: 'Top Assist Provider', recipient: 'Derek Moyo (Tom\u2019s Team PBD)', series: 'ICCLA Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    ...
    { id: 'aw-19', name: 'Most Improved Team', recipient: 'Hilltop Dynamo', series: 'ICCLA Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    { id: 'aw-20', name: 'Winter Classic Champion', recipient: 'FMU Blazers', series: 'Winter Classic', season: '2025\u201326', category: 'team', date: 'Dec 2025' },
  ];

  // ── History ──
  const history: HistoryRecord[] = [
    { id: 'hist-1', season: '2024\u201325', champion: 'FMU Blazers', runnerUp: 'Tom\u2019s Team (PBD)', mvp: 'Marcus Cole', totalMatches: 284, totalGoals: 712 },
    { id: 'hist-2', season: '2023\u201324', champion: 'Northridge United', runnerUp: 'FMU Blazers', mvp: 'Liam Chen', totalMatches: 248, totalGoals: 638 },
    { id: 'hist-3', season: '2022\u201323', champion: 'Metro FC', runnerUp: 'Northridge United', mvp: 'Jordan Blake', totalMatches: 210, totalGoals: 571 },
    { id: 'hist-4', season: '2021\u201322', champion: 'FMU Blazers', runnerUp: 'Metro FC', mvp: 'Deon Harper', totalMatches: 126, totalGoals: 342 },
    ...
    { id: 'hist-10', season: '2025 Holiday', champion: 'FMU Blazers', runnerUp: 'Hilltop Dynamo', mvp: 'Marcus Cole', totalMatches: 30, totalGoals: 86 },
    ...
    { id: 'hist-12', season: '2025 Preseason', champion: 'FMU Blazers', runnerUp: 'Lakewood SC', mvp: 'Marcus Cole', totalMatches: 28, totalGoals: 76 },
    ...
    { id: 'hist-14', season: '2025 Winter Classic', champion: 'FMU Blazers', runnerUp: 'Tom\u2019s Team (PBD)', mvp: 'Isaiah Brooks', totalMatches: 12, totalGoals: 31 },
