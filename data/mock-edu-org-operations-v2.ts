 ...
 * across the ICCLA education portfolio.
 */
...
const INITIATIVES: OpsInitiative[] = [
  {
    ...
    institution: 'FMU',
    owner: 'VP Enrollment',
    description: 'Aggressive campaign to close the 22% deposit gap for Fall 2026 at FMU.',
  ...
  {
    id: 'oi-bcu-partnership',
    name: 'BCU Partnership Review',
    domain: 'policies',
    status: 'on_track',
    owner: 'VP Partnerships',
    description: 'Annual partnership review and MOU renewal for BCU affiliation.',
    startDate: '2026-02-01',
    targetDate: '2026-03-31',
    budgetAllocated: '$12K',
    budgetSpent: '$4K',
    kpis: [
      { label: 'Review Items', current: 18, target: 24, unit: '' },
      { label: 'MOU Clauses Reviewed', current: 12, target: 15, unit: '' },
    ],
    complianceLinked: true,
    blockers: [],
    nextAction: 'Schedule legal review of updated MOU',
  },
  {
  ...
  {
    id: 'oi-stem-expansion',
    name: 'STEM Program Expansion',
    domain: 'academics',
    status: 'on_track',
    institution: 'BCU',
    owner: 'Provost',
    description: 'Launch new Computer Science and Data Analytics programs at BCU.',
    startDate: '2025-08-01',
    targetDate: '2026-08-01',
    budgetAllocated: '$420K',
    budgetSpent: '$285K',
    kpis: [
      { label: 'Faculty Hired', current: 4, target: 6, unit: '' },
      { label: 'Lab Equipment', current: 85, target: 100, unit: '%' },
      { label: 'Pre-Enrolled', current: 68, target: 80, unit: '' },
    ],
    complianceLinked: false,
    blockers: [],
    nextAction: 'Finalize lab-renovation timeline',
  },
  {
  ...
  },
  {
    ...
    description: 'Upgrade FMU residence-hall amenities and digital check-in system.',
  ...
  },
  {
    ...
    description: 'Deploy automated aid packaging and disbursement across both institutions.',
...
const WORKFLOWS: OpsWorkflow[] = [
  ...
  {
    id: 'ow-faculty-hiring',
    name: 'Faculty Hiring Pipeline',
    domain: 'academics',
    status: 'active',
    institution: 'BCU',
    description: 'Posting → screening → interview → committee vote → offer → onboarding.',
    totalSteps: 7,
    completedSteps: 3,
...
const TASKS: OpsTask[] = [
  {
    id: 'ot-1',
    title: 'Review FMU yield-day event plan',
    domain: 'admissions',
    status: 'in_progress',
    priority: 'critical',
    institution: 'FMU',
  ...
  {
    id: 'ot-5',
    title: 'FMU housing Phase 2 walk-through',
    domain: 'campus',
    status: 'pending',
    priority: 'normal',
    institution: 'FMU',
  ...
  {
    id: 'ot-6',
    title: 'BCU lab equipment delivery verification',
    domain: 'academics',
    status: 'in_progress',
    priority: 'normal',
    institution: 'BCU',
    ...
    dueDate: '2026-02-22',
    linkedInitiative: 'oi-stem-expansion',
    description: 'Verify delivery and installation of STEM lab workstations and networking gear.',
  },
  {
    id: 'ot-7',
  ...
  {
    id: 'ot-8',
    title: 'Send FMU retention check-in emails',
    domain: 'academics',
    status: 'pending',
    priority: 'normal',
    institution: 'FMU',
  ...
  {
    id: 'ot-9',
    title: 'Update BCU MOU financial terms',
    domain: 'policies',
    status: 'in_progress',
    priority: 'normal',
    institution: 'BCU',
    ...
    dueDate: '2026-02-25',
    linkedInitiative: 'oi-bcu-partnership',
    description: 'Revise financial contribution and revenue-share sections of BCU MOU.',
  },
  {
    id: 'ot-10',
  ...
  {
    id: 'ot-11',
    title: 'BCU Spring course waitlist processing',
    domain: 'academics',
    status: 'in_progress',
    priority: 'normal',
    institution: 'BCU',
    assignee: 'Registrar',
    dueDate: '2026-02-19',
    linkedWorkflow: 'ow-course-registration',
    description: 'Process waitlist moves for 42 students in oversubscribed Spring courses.',
  },
  {
    id: 'ot-12',
  ...
  {
    id: 'ot-13',
    title: 'Resolve FMU housing maintenance backlog',
    domain: 'campus',
    status: 'in_progress',
    priority: 'normal',
    institution: 'FMU',
    ...
    dueDate: '2026-02-21',
    description: 'Address 15 open maintenance tickets in FMU residential halls.',
  },
  {
    id: 'ot-14',
    title: 'BCU faculty interview scheduling',
    domain: 'academics',
    status: 'pending',
    priority: 'normal',
    institution: 'BCU',
    ...
    dueDate: '2026-02-26',
    linkedWorkflow: 'ow-faculty-hiring',
    description: 'Schedule campus interviews for 3 CS faculty candidates.',
  },
  {
    id: 'ot-15',
    ...
    dueDate: '2026-03-01',
    linkedInitiative: 'oi-title-ix-review',
    description: 'Schedule mandatory Title IX training sessions for all staff across FMU and BCU.',
  },
];
...
const GATES: DecisionGate[] = [
  {
    id: 'og-1',
    title: 'Approve FMU yield-day budget increase',
    domain: 'admissions',
    status: 'pending',
    requiredBy: '2026-02-20',
    requestor: 'Dir. Admissions',
    approvers: ['VP Enrollment', 'CFO – FMU'],
    institution: 'FMU',
    linkedInitiative: 'oi-fall-enrollment',
  ...
  {
    id: 'og-3',
    title: 'BCU STEM lab construction release',
    domain: 'campus',
    status: 'approved',
    requiredBy: '2026-02-15',
    requestor: 'Dir. Facilities',
    approvers: ['Provost', 'CFO – BCU'],
    institution: 'BCU',
    linkedInitiative: 'oi-stem-expansion',
    description: 'Release Phase 2 construction funds for STEM building renovation.',
  },
  {
    id: 'og-4',
