...
export const ENTITIES: Entity[] = [
  ...
  },
  {
    ...
    name: 'Engineering',
    type: 'department',
    description: 'Full-stack engineering, infrastructure, and DevOps. Building the KaNeXT platform across mobile, web, and API layers.',
    headCount: 4,
  ...
  },
  {
    ...
    name: 'Marketing',
    type: 'team',
    description: 'Brand strategy, content production, social media, and growth marketing for KaNeXT and proof wedge organizations.',
    headCount: 2,
    lead: 'Sarah Okafor',
    leadInitials: 'SO',
    status: 'active',
  ...
  },
  {
    ...
    name: 'MLK Classic',
    type: 'project',
    description: 'Flagship annual basketball event celebrating Dr. Martin Luther King Jr. A proof wedge event showcasing the KaNeXT platform in live action.',
    headCount: 6,
    lead: 'Sammy Kalejaiye',
    leadInitials: 'SK',
    status: 'planning',
  ...
  },
  {
    ...
    name: 'Platform V2',
    type: 'project',
    description: 'Next-generation KaNeXT OS with multi-mode switching, Nexus AI assistant, and settlement rails integration.',
    headCount: 8,
    lead: 'Adewale Ogundimu',
    leadInitials: 'AO',
    status: 'active',
