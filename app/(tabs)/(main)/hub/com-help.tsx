/**
 * Community Hub — Help. FAQ and support for the Community Hub tile.
 * Search bar, FAQ sections, GET HELP actions.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'YOUR CHURCH PROFILE',
    rows: [
      { icon: 'building.columns',      title: 'Setting up your church profile',  keywords: 'setup church profile start page'          },
      { icon: 'clock',                 title: 'Adding service times',            keywords: 'service times schedule add worship'        },
      { icon: 'person.badge.plus',     title: 'Editing leadership and staff',    keywords: 'leadership staff pastor edit team'         },
      { icon: 'square.and.arrow.up',   title: 'Sharing your church page',        keywords: 'share link qr code invite church page'     },
    ],
  },
  {
    header: 'SERVICES & EVENTS',
    rows: [
      { icon: 'music.note.list',       title: 'Creating and managing services',  keywords: 'create service manage worship sunday'      },
      { icon: 'calendar.badge.plus',   title: 'Setting up event RSVPs',          keywords: 'rsvp event attendance register signup'     },
      { icon: 'video.fill',            title: 'Live streaming a service',        keywords: 'live stream broadcast online watch'        },
      { icon: 'megaphone.fill',        title: 'Sending service announcements',   keywords: 'announce notify message congregation alert' },
    ],
  },
  {
    header: 'CONGREGATION',
    rows: [
      { icon: 'person.3.fill',         title: 'Managing your member directory',  keywords: 'member directory list manage roster'       },
      { icon: 'person.badge.checkmark',title: 'Welcoming new members',           keywords: 'new member welcome onboard join approve'   },
      { icon: 'heart.fill',            title: 'Setting up care groups',          keywords: 'care group small group ministry fellowship' },
    ],
  },
  {
    header: 'GIVING',
    rows: [
      { icon: 'dollarsign.circle.fill', title: 'Setting up online giving',       keywords: 'online giving donation setup tithe offering' },
      { icon: 'chart.bar.fill',         title: 'Understanding giving reports',   keywords: 'giving report analytics totals stats revenue' },
      { icon: 'arrow.clockwise',        title: 'Configuring recurring gifts',    keywords: 'recurring gift auto donation repeat weekly'   },
    ],
  },
];
...
export default function ComHelp() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>Church Help</Text>
            </View>
          </View>
