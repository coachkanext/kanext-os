/**
 * Studios Help — tile-level help for the KayStudios tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'COURSES',
    rows: [
      { icon: 'square.grid.2x2.fill',         title: 'Creating a course',              keywords: 'create course lesson content'        },
      { icon: 'video.fill',                   title: 'Adding lessons and media',        keywords: 'lesson video audio upload'           },
      { icon: 'lock.fill',                    title: 'Setting course access',           keywords: 'access free paid gated'             },
    ],
  },
  {
    header: 'STUDENTS',
    rows: [
      { icon: 'person.2.fill',                title: 'Managing enrollments',            keywords: 'enroll students members access'      },
      { icon: 'chart.bar.fill',               title: 'Tracking student progress',       keywords: 'progress completion tracking'        },
      { icon: 'checkmark.seal.fill',          title: 'Issuing certificates',            keywords: 'certificate completion badge'        },
    ],
  },
  {
    header: 'ANALYTICS',
    rows: [
      { icon: 'chart.line.uptrend.xyaxis',    title: 'Course performance metrics',      keywords: 'views completion rate analytics'     },
      { icon: 'dollarsign.circle',            title: 'Revenue and enrollments',         keywords: 'revenue sales enrollment count'      },
    ],
  },
  {
    header: 'PRICING',
    rows: [
      { icon: 'tag.fill',                     title: 'Setting course prices',           keywords: 'price free paid one-time'            },
      { icon: 'percent',                      title: 'Discount codes and coupons',      keywords: 'discount coupon promo code'          },
    ],
  },
];
...
export default function KStudiosHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>Studios Help</Text>
            </View>
          </View>
      ...
      >
        ...
        <View style={[s.searchWrap, { backgroundColor: C.surface, borderColor: C.separator }]}>
          ...
          <TextInput
            ...
            placeholder="Search studios help..."
