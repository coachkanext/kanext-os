...
const REVENUE_ITEMS: RevenueItem[] = [
  { id: 'rev-1', source: '2819 Church Championship Gate', category: 'ticketing', amount: 185000, date: 'Jan 18, 2026', series: '2819 Church Championship', status: 'received' },
  { id: 'rev-2', source: 'adidas Title Sponsorship Q1', category: 'sponsorship', amount: 62500, date: 'Jan 1, 2026', series: 'All Series', status: 'received' },
  { id: 'rev-3', source: 'ESPN+ Broadcast Rights — 3SSB Invitational', category: 'broadcast', amount: 120000, date: 'Feb 5, 2026', series: '3SSB Invitational', status: 'received' },
  ...
  { id: 'rev-6', source: 'Team Entry Fees — 3SSB Invitational', category: 'entry-fees', amount: 48000, date: 'Dec 20, 2025', series: '3SSB Invitational', status: 'received' },
  { id: 'rev-7', source: 'Merchandise Sales — 2819 Church Championship', category: 'merchandise', amount: 34200, date: 'Jan 19, 2026', series: '2819 Church Championship', status: 'received' },
  ...
  { id: 'rev-10', source: 'adidas Title Sponsorship Q2', category: 'sponsorship', amount: 62500, date: 'Apr 1, 2026', series: 'All Series', status: 'projected' },
  ...
  { id: 'rev-16', source: '3SSB Invitational VIP Packages', category: 'ticketing', amount: 52000, date: 'Feb 6, 2026', series: '3SSB Invitational', status: 'received' },
...
const EXPENSE_ITEMS: ExpenseItem[] = [
  { id: 'exp-1', description: 'Barclays Center Venue Rental — 2819 Church Championship', category: 'venue', amount: 145000, date: 'Jan 10, 2026', vendor: 'BSE Global', status: 'paid', series: '2819 Church Championship' },
  { id: 'exp-2', description: 'Event Staff & Security — 2819 Church Championship', category: 'staff', amount: 38500, date: 'Jan 17, 2026', vendor: 'Allied Universal', status: 'paid', series: '2819 Church Championship' },
  { id: 'exp-3', description: 'Referee & Official Fees — 3SSB Invitational', category: 'officials', amount: 24000, date: 'Feb 4, 2026', vendor: 'IAABO Officials Bureau', status: 'paid', series: '3SSB Invitational' },
  { id: 'exp-4', description: 'Court Equipment & Scoreboard Rental', category: 'equipment', amount: 18700, date: 'Jan 8, 2026', vendor: 'Daktronics', status: 'paid', series: '2819 Church Championship' },
  { id: 'exp-5', description: 'Team Travel Subsidies — 3SSB Invitational', category: 'travel', amount: 62000, date: 'Feb 1, 2026', vendor: 'Multiple Teams', status: 'paid', series: '3SSB Invitational' },
  ...
  { id: 'exp-8', description: 'Prize Purse Distribution — 2819 Church Championship', category: 'prizes', amount: 175000, date: 'Jan 22, 2026', vendor: 'Prize Pool Fund', status: 'paid', series: '2819 Church Championship' },
  ...
  { id: 'exp-12', description: 'Medical Staff & Athletic Trainers', category: 'staff', amount: 22000, date: 'Feb 3, 2026', vendor: 'Select Medical', status: 'paid', series: '3SSB Invitational' },
  { id: 'exp-13', description: 'Audio/Visual Production Equipment', category: 'equipment', amount: 35000, date: 'Jan 12, 2026', vendor: 'PRG Lighting', status: 'paid', series: '2819 Church Championship' },
  ...
  { id: 'exp-16', description: 'Print & Signage — 3SSB Invitational', category: 'marketing', amount: 12500, date: 'Jan 28, 2026', vendor: 'FedEx Office', status: 'paid', series: '3SSB Invitational' },
  { id: 'exp-17', description: 'Championship Trophies & Awards', category: 'equipment', amount: 8500, date: 'Jan 5, 2026', vendor: 'Crown Trophy', status: 'paid', series: '2819 Church Championship' },
  { id: 'exp-18', description: 'Overdue Invoice — Broadcast Equipment Rental', category: 'equipment', amount: 22000, date: 'Dec 15, 2025', vendor: 'NEP Group', status: 'overdue', series: '2819 Church Championship' },
];

const PRIZE_ALLOCATIONS: PrizeAllocation[] = [
  { id: 'prz-1', series: '2819 Church Championship', position: '1st Place', entrant: '3SSB Rattlers', amount: 100000, status: 'paid', date: 'Jan 22, 2026' },
  { id: 'prz-2', series: '2819 Church Championship', position: '2nd Place', entrant: 'Howard Bison', amount: 50000, status: 'paid', date: 'Jan 22, 2026' },
  { id: 'prz-3', series: '2819 Church Championship', position: '3rd Place', entrant: 'Hampton Pirates', amount: 25000, status: 'paid', date: 'Jan 23, 2026' },
  { id: 'prz-4', series: '2819 Church Championship', position: 'MVP Award', entrant: 'Alex Morgan', amount: 10000, status: 'paid', date: 'Jan 22, 2026' },
  { id: 'prz-5', series: '3SSB Invitational', position: '1st Place', entrant: 'Duke Blue Devils', amount: 75000, status: 'paid', date: 'Feb 8, 2026' },
  { id: 'prz-6', series: '3SSB Invitational', position: '2nd Place', entrant: 'Kentucky Wildcats', amount: 40000, status: 'paid', date: 'Feb 8, 2026' },
  { id: 'prz-7', series: '3SSB Invitational', position: '3rd Place', entrant: 'Gonzaga Bulldogs', amount: 20000, status: 'paid', date: 'Feb 9, 2026' },
  { id: 'prz-8', series: '3SSB Invitational', position: 'MVP Award', entrant: 'Jaylen Carter', amount: 5000, status: 'paid', date: 'Feb 8, 2026' },
...
const SPONSORSHIP_ITEMS: SponsorshipRevenue[] = [
  { id: 'spon-1', sponsor: 'adidas', package: 'Title Sponsor', amount: 250000, period: '2026 Season', status: 'active', paymentSchedule: 'Quarterly ($62.5K)' },
  ...
  { id: 'spon-5', sponsor: 'Beats by Dre', package: 'Audio Partner', amount: 45000, period: '3SSB Invitational', status: 'active', paymentSchedule: 'One-time' },
  ...
  { id: 'spon-9', sponsor: 'Coca-Cola', package: 'Beverage Partner', amount: 30000, period: '2819 Church Championship', status: 'active', paymentSchedule: 'One-time' },
...
const TICKETING_RECORDS: TicketingRecord[] = [
  { id: 'tix-1', event: '2819 Church Championship — Final', venue: 'Barclays Center', ticketsSold: 14800, capacity: 17732, revenue: 118000, avgPrice: 79.73, date: 'Jan 18, 2026' },
  { id: 'tix-2', event: '2819 Church Championship — Semifinal 1', venue: 'Barclays Center', ticketsSold: 11200, capacity: 17732, revenue: 67200, avgPrice: 60.00, date: 'Jan 17, 2026' },
  { id: 'tix-3', event: '2819 Church Championship — Semifinal 2', venue: 'Barclays Center', ticketsSold: 10500, capacity: 17732, revenue: 63000, avgPrice: 60.00, date: 'Jan 17, 2026' },
  { id: 'tix-4', event: '3SSB Invitational — Championship', venue: 'Madison Square Garden', ticketsSold: 18200, capacity: 19812, revenue: 164000, avgPrice: 90.11, date: 'Feb 7, 2026' },
  { id: 'tix-5', event: '3SSB Invitational — Semifinal 1', venue: 'Madison Square Garden', ticketsSold: 15400, capacity: 19812, revenue: 108000, avgPrice: 70.13, date: 'Feb 6, 2026' },
  { id: 'tix-6', event: '3SSB Invitational — Semifinal 2', venue: 'Madison Square Garden', ticketsSold: 14900, capacity: 19812, revenue: 104000, avgPrice: 69.80, date: 'Feb 6, 2026' },
  { id: 'tix-7', event: '3SSB Invitational — Quarterfinals', venue: 'Madison Square Garden', ticketsSold: 12000, capacity: 19812, revenue: 72000, avgPrice: 60.00, date: 'Feb 5, 2026' },
  { id: 'tix-8', event: '2819 Church VIP Experience', venue: 'Barclays Center — Club Level', ticketsSold: 320, capacity: 500, revenue: 52000, avgPrice: 162.50, date: 'Jan 18, 2026' },
...
const BUDGET_ITEMS: Budget[] = [
  { id: 'bgt-1', name: '2819 Church Championship — Total', series: '2819 Church Championship', allocated: 450000, spent: 420700, remaining: 29300, status: 'on-track', category: 'Event' },
  { id: 'bgt-2', name: '3SSB Invitational — Total', series: '3SSB Invitational', allocated: 380000, spent: 298200, remaining: 81800, status: 'on-track', category: 'Event' },
...
const PAYOUT_RECORDS: PayoutRecord[] = [
  { id: 'pay-1', recipient: '3SSB Rattlers', amount: 100000, type: 'prize', status: 'completed', date: 'Jan 22, 2026', reference: 'PRZ-2026-001' },
...
const REPORT_ITEMS: FinanceReport[] = [
  { id: 'rpt-1', name: '2819 Church Championship — P&L Summary', type: 'Profit & Loss', period: 'Jan 2026', format: 'PDF', generatedDate: 'Jan 25, 2026' },
  { id: 'rpt-2', name: '3SSB Invitational — P&L Summary', type: 'Profit & Loss', period: 'Feb 2026', format: 'PDF', generatedDate: 'Feb 12, 2026' },
