 ...
 * Quick preview with "Ask Nexus about this coach" CTA.
 */
    ...
    <BottomSheet visible={visible} onClose={onClose} useModal>
      <View style={styles.container}>
        ...
        <Pressable
          ...
          onPress={() => {
            onClose();
            openAskNexus({ screen: '/nexus', mode: 'sports', prefill: `Tell me about Coach ${data.name}` });
          }}
        >
          <IconSymbol name="sparkles" size={16} color="#fff" />
          <Text style={styles.askNexusText}>Ask Nexus about this coach</Text>
        </Pressable>
      </View>
    </BottomSheet>
  );
