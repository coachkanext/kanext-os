/**
 * Education Agenda Side Panel — President vs Student.
 * President: Calendar · Reminders · Tasks · Availability
 * Student:   Calendar · Reminders · Tasks · Availability
...
export function EducationAgendaPanel() {
  const C = useColors();
  ...
  const navItems = isPresident ? OWNER_NAV_ITEMS : MEMBER_NAV_ITEMS;
