...
export const SCHOOLS_FOR_YOU: SchoolCard[] = [
  { id: 'sfy-1', name: 'Florida Memorial University', initials: 'FMU', location: 'Miami Gardens, FL', type: 'HBCU', badges: ['NAIA', 'Faith-Based'], thumbnailColor: '#1B4F8A' },
  { id: 'sfy-2', name: 'San Diego Christian College', initials: 'SDCC', location: 'Santee, CA', type: 'Faith-Based', badges: ['NAIA', 'Christian'], thumbnailColor: '#6AA9FF' },
...
export const TRENDING_NOW: TrendingItem[] = [
  { id: 'tn-1', title: 'FMU Aviation Program Expands', subtitle: 'New fleet of training aircraft arrives at Opa-Locka Airport', type: 'announcement', thumbnailColor: '#06B6D4' },
  ...
  { id: 'tn-5', title: 'FMU Nursing Cohort Graduates', subtitle: '95% NCLEX pass rate for the Class of 2026', type: 'spotlight', thumbnailColor: '#1B4F8A' },
...
export const UPCOMING_EVENTS: EducationEvent[] = [
  { id: 'ue-1', title: 'FMU Spring Open House', date: 'Mar 8', location: 'Miami Gardens, FL', type: 'open-house', thumbnailColor: '#1B4F8A' },
  { id: 'ue-2', title: 'HBCU College Fair', date: 'Mar 15', location: 'Atlanta, GA', type: 'fair', thumbnailColor: '#7A5CFF' },
  ...
  { id: 'ue-6', title: 'FMU Admitted Students Day', date: 'Apr 19', location: 'Miami Gardens, FL', type: 'open-house', thumbnailColor: '#1B4F8A' },
];
...
export const CAMPUS_LIFE: CampusCard[] = [
  { id: 'cl-1', title: 'Homecoming Weekend Highlights', schoolName: 'Florida Memorial', category: 'Traditions', thumbnailColor: '#1B4F8A' },
...
export const ADMISSIONS_SPOTLIGHT: AdmissionsSpotlight[] = [
  { id: 'adm-1', schoolName: 'Florida Memorial University', initials: 'FMU', location: 'Miami Gardens, FL', acceptanceRate: '45%', avgAid: '$18,500', thumbnailColor: '#1B4F8A', ctas: ['Visit', 'Apply', 'Request Info'] },
  { id: 'adm-2', schoolName: 'San Diego Christian College', initials: 'SDCC', location: 'Santee, CA', acceptanceRate: '62%', avgAid: '$15,200', thumbnailColor: '#6AA9FF', ctas: ['Visit', 'Apply', 'Request Info'] },
