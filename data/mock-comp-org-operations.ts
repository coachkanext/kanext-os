 ...
 *
 * KaNeXT Church events at KaNeXT Arena, KaNeXT Invitational at KaNeXT Center, etc.
 */
...
const MOCK_EVENTS: CompEvent[] = [
  ...
  { id: 'evt-3', name: 'KaNeXT Invitational — Quarterfinals', series: 'KaNeXT Invitational', date: 'Mar 8, 2026', venue: 'KaNeXT Center', status: 'setup', type: 'match', attendees: 2400, staff: 60 },
  { id: 'evt-4', name: 'KaNeXT Invitational — Semifinals', series: 'KaNeXT Invitational', date: 'Mar 9, 2026', venue: 'KaNeXT Center', status: 'scheduled', type: 'match', attendees: 3100, staff: 65 },
  { id: 'evt-5', name: 'KaNeXT Invitational — Championship', series: 'KaNeXT Invitational', date: 'Mar 10, 2026', venue: 'KaNeXT Center', status: 'scheduled', type: 'match', attendees: 3500, staff: 72 },
  ...
  { id: 'evt-7', name: 'Opening Ceremony — KaNeXT Invitational', series: 'KaNeXT Invitational', date: 'Mar 7, 2026', venue: 'KaNeXT Center', status: 'completed', type: 'ceremony', attendees: 2800, staff: 55 },
  ...
  { id: 'evt-10', name: 'KaNeXT Invitational — First Round', series: 'KaNeXT Invitational', date: 'Mar 7, 2026', venue: 'KaNeXT Center', status: 'completed', type: 'match', attendees: 1900, staff: 58 },
  ...
  { id: 'evt-12', name: 'KaNeXT Invitational — Media Availability', series: 'KaNeXT Invitational', date: 'Mar 6, 2026', venue: 'KaNeXT Center', status: 'completed', type: 'media-day', attendees: 200, staff: 25 },
  ...
  { id: 'evt-14', name: 'All-Star Exhibition', series: 'KaNeXT Invitational', date: 'Mar 11, 2026', venue: 'KaNeXT Center', status: 'live', type: 'match', attendees: 2600, staff: 50 },
...
const MOCK_LOGISTICS: LogisticsItem[] = [
  ...
  { id: 'log-2', name: 'Catering — KaNeXT Quarterfinals', category: 'catering', status: 'confirmed', event: 'KaNeXT Invitational — QF', vendor: 'Blue Flame Catering', cost: 8200, dueDate: 'Mar 8, 2026' },
  ...
  { id: 'log-6', name: 'Broadcast Equipment Van', category: 'equipment', status: 'in-transit', event: 'KaNeXT Invitational — SF', vendor: 'ESPN Production Services', cost: 5800, dueDate: 'Mar 8, 2026' },
  { id: 'log-7', name: 'Team Meals — KaNeXT Championship', category: 'catering', status: 'pending', event: 'KaNeXT Invitational — Final', vendor: 'Blue Flame Catering', cost: 6500, dueDate: 'Mar 10, 2026' },
  ...
  { id: 'log-10', name: 'Portable Metal Detectors', category: 'security', status: 'delivered', event: 'KaNeXT Invitational', vendor: 'Sentinel Security Group', cost: 2200, dueDate: 'Mar 6, 2026' },
  { id: 'log-11', name: 'Hotel Block — KaNeXT Officials', category: 'accommodation', status: 'confirmed', event: 'KaNeXT Invitational', vendor: 'Hilton Garden Inn', cost: 15800, dueDate: 'Mar 6, 2026' },
  ...
  { id: 'log-13', name: 'Emergency Medical Kit Restock', category: 'equipment', status: 'issue', event: 'KaNeXT Invitational', vendor: 'MedSupply Direct', cost: 980, dueDate: 'Mar 7, 2026' },
...
const MOCK_EQUIPMENT: Equipment[] = [
  ...
  { id: 'eq-6', name: 'ESPN Broadcast Camera Kit (8x)', category: 'broadcast', quantity: 8, condition: 'good', assignedTo: 'KaNeXT Invitational', lastInspected: 'Mar 2, 2026' },
...
const MOCK_SCHEDULE: ScheduleBlock[] = [
  { id: 'sch-1', date: 'Mar 6, 2026', timeStart: '10:00 AM', timeEnd: '12:00 PM', event: 'KaNeXT Invitational — Media Availability', venue: 'KaNeXT Center', type: 'media-day', notes: 'Press only; credential check at 9:30 AM' },
  { id: 'sch-2', date: 'Mar 7, 2026', timeStart: '6:00 PM', timeEnd: '7:30 PM', event: 'Opening Ceremony — KaNeXT Invitational', venue: 'KaNeXT Center', type: 'ceremony', notes: 'Light show rehearsal at 4:00 PM' },
  { id: 'sch-3', date: 'Mar 7, 2026', timeStart: '8:00 PM', timeEnd: '10:30 PM', event: 'KaNeXT Invitational — First Round', venue: 'KaNeXT Center', type: 'match', notes: 'Games 1-4 back to back' },
  { id: 'sch-4', date: 'Mar 8, 2026', timeStart: '12:00 PM', timeEnd: '10:00 PM', event: 'KaNeXT Invitational — Quarterfinals', venue: 'KaNeXT Center', type: 'match', notes: '4 games; 45-min breaks between' },
  { id: 'sch-5', date: 'Mar 9, 2026', timeStart: '2:00 PM', timeEnd: '8:00 PM', event: 'KaNeXT Invitational — Semifinals', venue: 'KaNeXT Center', type: 'match', notes: '2 games; 1-hour break between' },
  { id: 'sch-6', date: 'Mar 10, 2026', timeStart: '7:00 PM', timeEnd: '10:00 PM', event: 'KaNeXT Invitational — Championship', venue: 'KaNeXT Center', type: 'match', notes: 'Trophy presentation post-game' },
...
const MOCK_INCIDENTS: Incident[] = [
  { id: 'inc-1', date: 'Mar 7, 2026', event: 'KaNeXT Invitational — First Round', type: 'injury', severity: 'medium', description: 'Player twisted ankle during warm-ups; cleared by medical after evaluation', status: 'resolved', assignee: 'Dr. Patel' },
  ...
  { id: 'inc-3', date: 'Mar 8, 2026', event: 'KaNeXT Invitational — QF', type: 'security', severity: 'high', description: 'Unauthorized individuals attempted court-level access with fake credentials', status: 'investigating', assignee: 'Sentinel Security' },
  { id: 'inc-4', date: 'Mar 8, 2026', event: 'KaNeXT Invitational — QF', type: 'equipment', severity: 'critical', description: 'Replay server crashed mid-game; manual officiating invoked until restart', status: 'open', assignee: 'Tech Ops' },
  { id: 'inc-5', date: 'Mar 6, 2026', event: 'KaNeXT Media Availability', type: 'other', severity: 'low', description: 'WiFi congestion in media room causing upload delays; bandwidth reallocated', status: 'resolved', assignee: 'IT Support' },
  { id: 'inc-6', date: 'Mar 9, 2026', event: 'KaNeXT Invitational — SF', type: 'weather', severity: 'medium', description: 'Severe thunderstorm advisory; outdoor overflow parking lot closed temporarily', status: 'resolved', assignee: 'Facility Ops' },
  { id: 'inc-7', date: 'Mar 7, 2026', event: 'KaNeXT Invitational — First Round', type: 'injury', severity: 'high', description: 'Spectator in Section 112 required EMT assistance; transported to hospital', status: 'resolved', assignee: 'EMS Team' },
  { id: 'inc-8', date: 'Mar 10, 2026', event: 'KaNeXT Invitational — Championship', type: 'protest', severity: 'medium', description: 'Small group of demonstrators at east entrance; peacefully dispersed', status: 'closed', assignee: 'Sentinel Security' },
  ...
  { id: 'inc-10', date: 'Mar 8, 2026', event: 'KaNeXT Invitational — QF', type: 'injury', severity: 'low', description: 'Minor cut on player\'s hand from loose floor bolt; floor crew checked area', status: 'closed', assignee: 'Medical Staff' },
  { id: 'inc-11', date: 'Mar 9, 2026', event: 'KaNeXT Invitational — SF', type: 'security', severity: 'medium', description: 'Altercation between fan groups in concourse level; separated by security', status: 'resolved', assignee: 'Sentinel Security' },
...
const MOCK_TASKS: OpsTask[] = [
  ...
  { id: 'tsk-4', title: 'Finalize KaNeXT Championship trophy engraving', assignee: 'Carlos Mendez', dueDate: 'Mar 9, 2026', priority: 'urgent', status: 'todo', event: 'KaNeXT Invitational' },
  ...
  { id: 'tsk-13', title: 'Replace replay server at KaNeXT Center', assignee: 'Tech Ops', dueDate: 'Mar 9, 2026', priority: 'urgent', status: 'in-progress', event: 'KaNeXT Invitational' },
...
const MOCK_REPORTS: OpsReport[] = [
  { id: 'rpt-1', name: 'KaNeXT Invitational — Post-Event Summary', type: 'Event Report', date: 'Mar 11, 2026', format: 'PDF' },
  { id: 'rpt-2', name: 'Venue Utilization Report — Q1 2026', type: 'Utilization', date: 'Mar 1, 2026', format: 'XLSX' },
  { id: 'rpt-3', name: 'Incident Log — KaNeXT Invitational', type: 'Incident Report', date: 'Mar 11, 2026', format: 'PDF' },
  ...
  { id: 'rpt-7', name: 'Attendance & Revenue — KaNeXT First Round', type: 'Financial', date: 'Mar 8, 2026', format: 'CSV' },
  ...
  { id: 'rpt-10', name: 'Media Coverage Recap — KaNeXT Invitational', type: 'Media', date: 'Mar 11, 2026', format: 'PDF' },
...
const MOCK_ACTIVITY_FEED: ActivityFeedItem[] = [
  ...
  { id: 'af-5', description: 'KaNeXT Invitational Opening Ceremony marked complete', timestamp: '3h ago', icon: 'calendar.badge.clock', color: '#22C55E' },
