 ...
 * across the 2819 Church education portfolio.
 */
...
const INITIATIVES: OpsInitiative[] = [
  {
    ...
    institution: 'Howard',
    owner: 'VP Enrollment',
    description: 'Aggressive campaign to close the 22% deposit gap for Fall 2026 at Howard.',
  ...
  },
  {
    ...
    description: 'Upgrade Howard residence-hall amenities and digital check-in system.',
...
const TASKS: OpsTask[] = [
  {
    id: 'ot-1',
    title: 'Review Howard yield-day event plan',
    domain: 'admissions',
    status: 'in_progress',
    priority: 'critical',
    institution: 'Howard',
  ...
  {
    id: 'ot-5',
    title: 'Howard housing Phase 2 walk-through',
    domain: 'campus',
    status: 'pending',
    priority: 'normal',
    institution: 'Howard',
  ...
  {
    id: 'ot-8',
    title: 'Send Howard retention check-in emails',
    domain: 'academics',
    status: 'pending',
    priority: 'normal',
    institution: 'Howard',
  ...
  {
    id: 'ot-13',
    title: 'Resolve Howard housing maintenance backlog',
    domain: 'campus',
    status: 'in_progress',
    priority: 'normal',
    institution: 'Howard',
    ...
    dueDate: '2026-02-21',
    description: 'Address 15 open maintenance tickets in Howard residential halls.',
  },
  {
    id: 'ot-15',
    ...
    dueDate: '2026-03-01',
    linkedInitiative: 'oi-title-ix-review',
    description: 'Schedule mandatory Title IX training sessions for all staff across Howard.',
  },
];
...
const GATES: DecisionGate[] = [
  {
    id: 'og-1',
    title: 'Approve Howard yield-day budget increase',
    domain: 'admissions',
    status: 'pending',
    requiredBy: '2026-02-20',
    requestor: 'Dir. Admissions',
    approvers: ['VP Enrollment', 'CFO – Howard'],
    institution: 'Howard',
    linkedInitiative: 'oi-fall-enrollment',
