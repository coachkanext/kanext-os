...
export function getCompSeriesData(_scope: string) {
  ...
  const recentActivity = [
    { id: 'ra-1', text: '3SSB Blazers defeated Tom\u2019s Team (PBD) 3\u20131 in 3SSB Invitational Round 3', time: '2h ago' },
    { id: 'ra-2', text: '2819 Church League standings updated \u2014 Blazers move to 2nd place', time: '3h ago' },
    ...
    { id: 'ra-5', text: '3SSB Invitational MVP voting opened for Round 3', time: '10h ago' },
    { id: 'ra-6', text: 'Venue confirmed: Meridian Arena for PBD Cup semifinals', time: '12h ago' },
    { id: 'ra-7', text: '2819 Church League Round 8 schedule published', time: '1d ago' },
    { id: 'ra-8', text: '3SSB Blazers clinched playoff berth in 2819 Church League', time: '1d ago' },
    ...
    { id: 'ra-13', text: '3SSB Invitational broadcast partnership confirmed with StreamLive', time: '4d ago' },
  ...
  const activeSeries: ActiveSeries[] = [
    { id: 'as-1', name: '2819 Church Premier League', shortName: '2819 Church', format: 'Round Robin', status: 'live', startDate: 'Sep 2025', endDate: 'May 2026', entrantCount: 16, matchCount: 120, currentRound: 'Matchday 22 of 30', prize: '$150,000' },
    { id: 'as-2', name: '3SSB Invitational', shortName: '3SSB', format: 'Single Elimination', status: 'live', startDate: 'Jan 2026', endDate: 'Mar 2026', entrantCount: 32, matchCount: 31, currentRound: 'Round of 16', prize: '$75,000' },
    ...
    { id: 'as-5', name: '2819 Church Super Cup', shortName: 'ISC', format: 'Single Elimination', status: 'upcoming', startDate: 'Jun 2026', endDate: 'Jun 2026', entrantCount: 4, matchCount: 3, currentRound: 'Semifinal draw pending', prize: '$50,000' },
    ...
    { id: 'as-15', name: '2819 Church Reserve League', shortName: 'IRL', format: 'Round Robin', status: 'live', startDate: 'Sep 2025', endDate: 'May 2026', entrantCount: 16, matchCount: 120, currentRound: 'Matchday 20 of 30', prize: '$20,000' },
  ...
  const formats: SeriesFormat[] = [
    { id: 'fmt-1', name: '2819 Church Round Robin', type: 'round-robin', description: 'Each team plays every other team twice (home and away). Points awarded: 3 for win, 1 for draw, 0 for loss. Full season league format with relegation.', maxEntrants: 20, tiebreakers: ['Goal Difference', 'Goals Scored', 'Head-to-Head Record', 'Fair Play Points'] },
    { id: 'fmt-2', name: '3SSB Knockout', type: 'single-elim', description: 'Single-game elimination bracket. Higher seed hosts. Extra time and penalty shootout for drawn matches. No replays.', maxEntrants: 64, tiebreakers: ['Extra Time', 'Penalty Shootout'] },
  ...
  const entrants: SeriesEntrant[] = [
    { id: 'ent-1', name: '3SSB Blazers', shortName: '3SSB', logo: 'flame', seed: 1, wins: 14, losses: 3, draws: 5, points: 47, gd: 22, status: 'active' },
    ...
    { id: 'ent-6', name: 'Providence SC', shortName: 'LSC', logo: 'drop', seed: 6, wins: 10, losses: 7, draws: 5, points: 35, gd: 7, status: 'active' },
    ...
    { id: 'ent-13', name: 'UM Western United', shortName: 'BSU', logo: 'sun', seed: 13, wins: 5, losses: 11, draws: 6, points: 21, gd: -11, status: 'eliminated' },
  ...
  const calendar: CalendarEvent[] = [
    { id: 'cal-1', date: '2026-02-17', title: '3SSB Blazers vs Northridge United', type: 'match', series: '2819 Church Premier League', venue: '3SSB Arena' },
    { id: 'cal-2', date: '2026-02-17', title: 'Tom\u2019s Team vs Metro FC', type: 'match', series: '2819 Church Premier League', venue: 'PBD Sports Complex' },
    { id: 'cal-3', date: '2026-02-18', title: '3SSB Invitational R16 \u2014 Match 1', type: 'match', series: '3SSB Invitational', venue: 'Meridian Arena' },
    { id: 'cal-4', date: '2026-02-18', title: '3SSB Invitational R16 \u2014 Match 2', type: 'match', series: '3SSB Invitational', venue: 'Meridian Arena' },
    { id: 'cal-5', date: '2026-02-19', title: 'Transfer Deadline \u2014 2819 Church League', type: 'deadline', series: '2819 Church Premier League', venue: '\u2014' },
    { id: 'cal-6', date: '2026-02-19', title: 'PBD Cup QF Draw Ceremony', type: 'ceremony', series: 'PBD Cup', venue: '2819 Church Headquarters' },
    { id: 'cal-7', date: '2026-02-20', title: 'Rest Day \u2014 3SSB Invitational', type: 'rest-day', series: '3SSB Invitational', venue: '\u2014' },
    { id: 'cal-8', date: '2026-02-20', title: 'Pre-match Press Conference', type: 'media', series: 'PBD Cup', venue: 'Media Center' },
    { id: 'cal-9', date: '2026-02-21', title: 'PBD Cup QF \u2014 3SSB vs Eastside', type: 'match', series: 'PBD Cup', venue: '3SSB Arena' },
    { id: 'cal-10', date: '2026-02-21', title: 'PBD Cup QF \u2014 PBD vs Providence', type: 'match', series: 'PBD Cup', venue: 'PBD Sports Complex' },
    { id: 'cal-11', date: '2026-02-22', title: 'Eastside vs Central City', type: 'match', series: '2819 Church Premier League', venue: 'Eastside Stadium' },
    { id: 'cal-12', date: '2026-02-22', title: '3SSB Invitational R16 \u2014 Match 3', type: 'match', series: '3SSB Invitational', venue: 'Valley Arena' },
    { id: 'cal-13', date: '2026-02-23', title: 'Award Voting Deadline \u2014 February', type: 'deadline', series: '2819 Church Premier League', venue: '\u2014' },
    { id: 'cal-14', date: '2026-02-24', title: '3SSB Blazers vs Harbor Town', type: 'match', series: '2819 Church Premier League', venue: '3SSB Arena' },
    { id: 'cal-15', date: '2026-02-24', title: 'Post-Round Media Day', type: 'media', series: '3SSB Invitational', venue: 'Press Room' },
    ...
    { id: 'cal-19', date: '2026-02-27', title: 'Valley Rangers vs Hilltop Dynamo', type: 'match', series: '2819 Church Premier League', venue: 'Valley Arena' },
    { id: 'cal-20', date: '2026-02-28', title: 'Monthly Board Meeting', type: 'ceremony', series: 'All Series', venue: '2819 Church Headquarters' },
    ...
    { id: 'cal-23', date: '2026-03-03', title: '3SSB Invitational Quarterfinals Day 1', type: 'match', series: '3SSB Invitational', venue: 'Meridian Arena' },
    { id: 'cal-24', date: '2026-03-04', title: '2819 Church League Matchday 23', type: 'match', series: '2819 Church Premier League', venue: 'Various' },
    { id: 'cal-25', date: '2026-03-05', title: 'Broadcast Rights Review Meeting', type: 'media', series: 'All Series', venue: '2819 Church Headquarters' },
  ];

  // ── Awards ──
  const awards: Award[] = [
    { id: 'aw-1', name: 'League MVP', recipient: 'Marcus Cole (3SSB Blazers)', series: '2819 Church Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-2', name: 'Golden Boot', recipient: 'Jalen Torres (Tom\u2019s Team PBD)', series: '2819 Church Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-3', name: 'Best XI', recipient: '3SSB Blazers (7 players selected)', series: '2819 Church Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    { id: 'aw-4', name: '3SSB Invitational MVP', recipient: 'Dante Williams (Metro FC)', series: '3SSB Invitational', season: '2024\u201325', category: 'individual', date: 'Mar 2025' },
    { id: 'aw-5', name: 'PBD Cup Champion', recipient: 'Northridge United', series: 'PBD Cup', season: '2024\u201325', category: 'team', date: 'Apr 2025' },
    { id: 'aw-6', name: 'Fair Play Award', recipient: 'Providence SC', series: '2819 Church Premier League', season: '2024\u201325', category: 'special', date: 'Jun 2025' },
    ...
    { id: 'aw-8', name: 'Coach of the Year', recipient: 'Alex Morgan (3SSB Blazers)', series: 'All Series', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    { id: 'aw-9', name: 'Best Defense', recipient: '3SSB Blazers (18 goals conceded)', series: '2819 Church Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    ...
    { id: 'aw-13', name: 'Goalkeeper of the Year', recipient: 'Andre Marshall (Northridge United)', series: '2819 Church Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    ...
    { id: 'aw-16', name: 'Preseason Challenge Winner', recipient: '3SSB Blazers', series: 'Preseason Challenge', season: '2025\u201326', category: 'team', date: 'Aug 2025' },
    { id: 'aw-17', name: 'Top Assist Provider', recipient: 'Derek Moyo (Tom\u2019s Team PBD)', series: '2819 Church Premier League', season: '2024\u201325', category: 'individual', date: 'Jun 2025' },
    ...
    { id: 'aw-19', name: 'Most Improved Team', recipient: 'Hilltop Dynamo', series: '2819 Church Premier League', season: '2024\u201325', category: 'team', date: 'Jun 2025' },
    { id: 'aw-20', name: 'Winter Classic Champion', recipient: '3SSB Blazers', series: 'Winter Classic', season: '2025\u201326', category: 'team', date: 'Dec 2025' },
  ];

  // ── History ──
  const history: HistoryRecord[] = [
    { id: 'hist-1', season: '2024\u201325', champion: '3SSB Blazers', runnerUp: 'Tom\u2019s Team (PBD)', mvp: 'Marcus Cole', totalMatches: 284, totalGoals: 712 },
    { id: 'hist-2', season: '2023\u201324', champion: 'Northridge United', runnerUp: '3SSB Blazers', mvp: 'Liam Chen', totalMatches: 248, totalGoals: 638 },
    { id: 'hist-3', season: '2022\u201323', champion: 'Metro FC', runnerUp: 'Northridge United', mvp: 'Jordan Blake', totalMatches: 210, totalGoals: 571 },
    { id: 'hist-4', season: '2021\u201322', champion: '3SSB Blazers', runnerUp: 'Metro FC', mvp: 'Deon Harper', totalMatches: 126, totalGoals: 342 },
    { id: 'hist-5', season: '2025\u201326 (in progress)', champion: 'TBD', runnerUp: 'TBD', mvp: 'TBD', totalMatches: 187, totalGoals: 498 },
    { id: 'hist-6', season: '2024 Summer', champion: 'Eastside Athletic', runnerUp: 'Providence SC', mvp: 'Tyrese Hammond', totalMatches: 48, totalGoals: 134 },
    ...
    { id: 'hist-10', season: '2025 Holiday', champion: '3SSB Blazers', runnerUp: 'Hilltop Dynamo', mvp: 'Marcus Cole', totalMatches: 30, totalGoals: 86 },
    ...
    { id: 'hist-12', season: '2025 Preseason', champion: '3SSB Blazers', runnerUp: 'Providence SC', mvp: 'Marcus Cole', totalMatches: 28, totalGoals: 76 },
    ...
    { id: 'hist-14', season: '2025 Winter Classic', champion: '3SSB Blazers', runnerUp: 'Tom\u2019s Team (PBD)', mvp: 'Isaiah Brooks', totalMatches: 12, totalGoals: 31 },
    { id: 'hist-15', season: '2026 3SSB (in progress)', champion: 'TBD', runnerUp: 'TBD', mvp: 'TBD', totalMatches: 16, totalGoals: 42 },
  ];
