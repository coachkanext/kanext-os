...
export const ORG_PROGRAMS: OrgProgram[] = [
  ...
  { id: 'prog-msoc', sport: 'Soccer', name: "Men's Soccer", shortName: 'MSOC', headCoach: 'Carlos Hernandez', headCoachInitials: 'CH', record: null, rosterCount: 24, staffCount: 4, status: 'offseason', availabilityAlerts: 0, recruitingHotCount: 7, opsBlockers: 0, complianceFlags: 'clear', complianceFlagCount: 0, nextEvent: 'Spring Training', nextEventDate: 'Mar 10', budgetUtilization: 30, avatarColor: '#B8943E', gender: 'M' },
...
export const CROSS_PROGRAM_ALERTS: CrossProgramAlert[] = [
  ...
  { id: 'cpa-2', programId: 'prog-mtf', programName: "Men's Track & Field", type: 'attention', title: "Men's T&F: 4 Availability Alerts", description: '2 sprinters with hamstring issues, 1 jumper out with knee sprain, 1 thrower pending medical clearance ahead of SIAC Indoors.', severity: 'high', icon: 'bandage.fill', color: '#B8943E' },
  { id: 'cpa-3', programId: 'prog-wsoc', programName: "Women's Soccer", type: 'compliance', title: "Women's Soccer: Missing Training Certifications", description: 'Assistant coach CPR/AED certification expired Jan 31. Must renew before spring training begins Mar 10.', severity: 'medium', icon: 'checkmark.shield.fill', color: '#B8943E' },
  { id: 'cpa-4', programId: 'prog-mbb', programName: "Men's Basketball", type: 'facility', title: 'Gym Scheduling Conflict: MBB vs WBB', description: 'Both programs requesting Lou Walker Activity Center for Feb 22 practice (2-4 PM). Only 1 court available.', severity: 'medium', icon: 'building.2.fill', color: '#1A1714' },
  { id: 'cpa-5', programId: 'prog-soft', programName: 'Softball', type: 'staffing', title: 'Softball: No Dedicated AT Coverage', description: 'Athletic Trainer coverage shared with Baseball. Softball has 3 weekend doubleheaders in next 2 weeks with no AT assigned.', severity: 'medium', icon: 'person.badge.minus', color: '#B8943E' },
];
