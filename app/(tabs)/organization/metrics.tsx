...
import { INSTITUTIONAL_METRICS, SDCC_ORGANIZATION } from '@/data/mock-education';
      ...
      {trend && (
        <View style={styles.trendRow}>
          <IconSymbol
            ...
            size={12}
            color={trendPositive ? '#34C759' : '#FF3B30'}
          />
          <ThemedText
            style={[
              styles.trendText,
  ...
  return (
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={[styles.detailCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <MetricRow label="Founded" value={SDCC_ORGANIZATION.founded || 'N/A'} colors={colors} />
          <View style={[styles.divider, { backgroundColor: colors.divider }]} />
          <MetricRow label="Type" value={SDCC_ORGANIZATION.institutionType} colors={colors} />
          <View style={[styles.divider, { backgroundColor: colors.divider }]} />
          <MetricRow
            label="Accreditation"
            value={SDCC_ORGANIZATION.accreditation || 'N/A'}
            colors={colors}
          />
          <View style={[styles.divider, { backgroundColor: colors.divider }]} />
          <MetricRow
            label="Program Formats"
            value={SDCC_ORGANIZATION.programFormats?.join(', ') || 'N/A'}
            colors={colors}
          />
        </View>
      </ScrollView>
