...
const MOCK_INITIATIVES: OpsInitiative[] = [
  ...
  {
    id: 'init-4',
    name: 'Valuetainment OS Platform Build',
    description: 'End-to-end development of the Valuetainment OS cross-platform application including Nexus AI, mode switching, RBAC, business dashboard, and competition management.',
    status: 'active',
    progress: 74,
    projectCount: 3,
    owner: 'Marcus Chen',
...
const MOCK_PROJECTS: OpsProject[] = [
  ...
  },
  {
    ...
    initiativeId: 'init-4',
    initiativeName: 'Valuetainment OS Platform Build',
    status: 'active',
    taskCompletion: 81,
    owner: 'Marcus Chen',
    entityName: SEEDED_ENTITY_NAMES[KANEXT_IP],
...
const MOCK_BLOCKERS: OpsBlocker[] = [
  {
    ...
    description: 'The Maltese Registrar of Companies returned the UBO (Ultimate Beneficial Owner) declaration citing incomplete chain-of-ownership documentation for Valuetainment HoldCo. Legal team is preparing amended filings.',
    severity: 'critical',
    initiativeId: 'init-3',
    initiativeName: 'International Expansion (Malta)',
    owner: 'Derek Novak',
...
const MOCK_OPS_FEED: OpsFeedEvent[] = [
  ...
  },
  {
    id: 'feed-7',
    type: 'initiative_moved',
    title: 'Valuetainment OS Platform Build reached 74% progress',
    actor: 'Marcus Chen',
