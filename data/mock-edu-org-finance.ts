...
const TERM_SNAPSHOTS: TermSnapshot[] = [
  ...
  },
  {
    ...
    term: 'spring_2026',
    enrollment: 3200,
    tuitionRevenue: 14100000,
    aidDisbursed: 9800000,
    housingRevenue: 3800000,
    auxiliaryRevenue: 1200000,
    operatingExpenses: 11400000,
    netPosition: 7700000,
  },
];
...
const DEPARTMENT_BUDGETS: DepartmentBudget[] = [
  ...
  },
  {
    ...
    period: 'Annual FY 2025-2026',
    lineItems: [
      { id: 'db-002-li-01', name: 'Faculty Travel', category: 'Travel', budgeted: 60000, spent: 28000, committed: 8000, hardCap: false },
      { id: 'db-002-li-02', name: 'Technology Licenses', category: 'Technology', budgeted: 120000, spent: 68000, committed: 15000, hardCap: true },
      { id: 'db-002-li-03', name: 'Guest Speakers', category: 'Programming', budgeted: 35000, spent: 12000, committed: 5000, hardCap: false },
      { id: 'db-002-li-04', name: 'Accreditation Prep', category: 'Compliance', budgeted: 80000, spent: 45000, committed: 12000, hardCap: true },
    ],
    totalBudgeted: 950000,
    totalSpent: 420000,
    totalCommitted: 95000,
    forecastBurn: 78,
    varianceNote: 'Accreditation preparation spend on track. Technology license renewal due Q3.',
  },
  {
    id: 'db-003',
  ...
  },
  {
    ...
    period: 'Annual FY 2025-2026',
    lineItems: [
      { id: 'db-004-li-01', name: 'Programming', category: 'Programming', budgeted: 180000, spent: 82000, committed: 18000, hardCap: false },
      { id: 'db-004-li-02', name: 'Orientation', category: 'Events', budgeted: 95000, spent: 48000, committed: 0, hardCap: true },
      { id: 'db-004-li-03', name: 'Housing Ops', category: 'Operations', budgeted: 220000, spent: 98000, committed: 32000, hardCap: true },
      { id: 'db-004-li-04', name: 'Campus Safety', category: 'Safety', budgeted: 85000, spent: 42000, committed: 8000, hardCap: true },
    ],
    totalBudgeted: 680000,
    totalSpent: 290000,
    totalCommitted: 65000,
    forecastBurn: 75,
    varianceNote: 'Student programming under budget due to delayed spring concert booking.',
  },
];
...
const LEDGER_POSTINGS: LedgerPosting[] = [
  ...
  },
  {
    id: 'lp-002',
    date: '2026-02-05',
    description: 'Financial Aid Disbursement — Pell Grant Spring 2026',
    fundType: 'financial_aid',
    debitAccount: '5200 — Financial Aid Expense',
    creditAccount: '1100 — Student Accounts Receivable',
    amount: 82400,
    state: 'posted',
    explainChain: [
      'Federal Pell Grant funds received from DOE',
      'Disbursement applied to student accounts per award letters',
      'Excess refunds queued for direct deposit',
    ],
  ...
  },
  {
    id: 'lp-004',
    date: '2026-02-10',
    description: 'Housing Deposit Refund Batch — Spring Cancellations',
    fundType: 'housing_revenue',
    debitAccount: '2100 — Housing Deposits Liability',
    creditAccount: '1000 — Operating Cash',
    amount: 12800,
    state: 'pending',
    explainChain: [
      '8 students cancelled spring housing before census date',
      'Refund amounts calculated per housing contract cancellation policy',
      'Pending Bursar approval for batch release',
    ],
    postedBy: 'Housing Office',
    institution: 'Bethune-Cookman University',
  },
  {
    id: 'lp-005',
  ...
  },
  {
    id: 'lp-007',
    date: '2026-02-14',
    description: 'Title III Grant Expenditure Adjustment — Q1 Reclass',
    fundType: 'restricted_grants',
    debitAccount: '5500 — Grant Program Expenses',
    creditAccount: '5100 — Operating Supplies Expense',
    amount: 15000,
    state: 'adjusting',
    explainChain: [
      'Q1 supplies originally coded to operating fund',
      'Grant compliance review identified allowable Title III charges',
      'Reclassification to restricted grant fund per federal guidelines',
    ],
    postedBy: 'Grants Accountant',
    institution: 'Bethune-Cookman University',
  },
  {
    id: 'lp-008',
    date: '2026-02-06',
    description: 'Reversed Duplicate Posting — Pearson Textbook Invoice',
    fundType: 'operating',
    debitAccount: '2000 — Accounts Payable',
    creditAccount: '6100 — Textbook & Course Materials',
    amount: 3200,
    state: 'reversed',
    explainChain: [
      'Invoice #PRS-44821 posted twice on Feb 4 and Feb 5',
      'Duplicate identified during daily reconciliation',
      'Second posting reversed — original entry stands',
    ],
    postedBy: 'Accounts Payable',
    institution: 'Bethune-Cookman University',
  },
...
const RECEIVABLES: Receivable[] = [
  ...
  {
    id: 'rcv-004',
    studentName: 'DeAndre Williams',
    studentId: 'BCU-2024-1452',
    type: 'meal_plan',
    amount: 2100,
    dueDate: '2026-02-15',
    status: 'outstanding',
  ...
  },
  {
    ...
    term: 'spring_2026',
    holdFlag: true,
    holdReason: 'Financial hold — outstanding balance from fall 2025 term',
  },
  {
    id: 'rcv-006',
    studentName: 'Tyler Davis',
    studentId: 'FMU-2024-0773',
    type: 'lab_fees',
    amount: 450,
    dueDate: '2026-01-25',
    status: 'paid',
  ...
  {
    id: 'rcv-007',
    studentName: 'Brianna Carter',
    studentId: 'BCU-2025-0148',
    type: 'deposit',
    amount: 500,
    dueDate: '2026-01-10',
    status: 'paid',
...
const PAYABLES: Payable[] = [
  {
    ...
    docsRequired: 5,
    approvalChain: [
      { name: 'Athletic Director', status: 'approved' },
      { name: 'VP Finance', status: 'approved' },
      { name: 'Procurement Officer', status: 'approved' },
  ...
  },
  {
    ...
    docsRequired: 5,
    approvalChain: [
      { name: 'Facilities Director', status: 'approved' },
      { name: 'Procurement Officer', status: 'approved' },
      { name: 'VP Finance', status: 'escalated' },
    ],
  },
  {
    id: 'pay-004',
  ...
  },
  {
    ...
    docsRequired: 5,
    approvalChain: [
      { name: 'Provost Office', status: 'approved' },
      { name: 'Procurement Officer', status: 'pending' },
      { name: 'VP Finance', status: 'pending' },
    ],
  },
  {
    id: 'pay-006',
...
const AID_AWARDS: AidAward[] = [
  ...
  },
  {
    ...
    term: 'spring_2026',
    institution: 'Bethune-Cookman University',
    eligibilityRules: ['EFC <= 6206', 'FAFSA on file', 'Enrollment >= half-time'],
    disbursementDate: '2026-01-20',
    disbursed: true,
    complianceTags: ['Title IV compliant', 'COD reported', 'EFC verified'],
  },
  {
    id: 'aid-003',
    studentName: 'DeAndre Williams',
    ...
    term: 'spring_2026',
    institution: 'Bethune-Cookman University',
    eligibilityRules: ['NCAA eligibility', 'Full-time enrollment', 'Academic progress', 'Team roster active'],
    disbursementDate: '2026-02-01',
    disbursed: false,
    complianceTags: ['NCAA compliant', 'Equivalency limit checked', 'Pending enrollment verification'],
  },
  {
    id: 'aid-004',
    studentName: 'Keisha Brown',
    ...
    term: 'spring_2026',
    institution: 'Bethune-Cookman University',
    eligibilityRules: ['Florida resident', 'FAFSA on file', 'Enrollment >= half-time', 'SAP maintained'],
    disbursementDate: '2026-01-18',
    disbursed: true,
    complianceTags: ['State grant compliant', 'Residency verified', 'FAFSA verified'],
  },
  {
    id: 'aid-005',
    studentName: 'Tyler Davis',
...
const AUDIT_RECORDS: AuditRecord[] = [
  ...
  {
    id: 'aud-002',
    entityType: 'aid_award',
    entityId: 'aid-002',
    action: 'Pell Grant Disbursed',
    performedBy: 'Financial Aid Office',
    timestamp: '2026-01-20T14:15:00Z',
    details: 'Pell Grant of $3,448 disbursed to Marcus Thompson. COD reported to DOE.',
    evidenceStatus: 'complete',
    policyException: false,
  },
  {
    ...
    performedBy: 'VP Finance',
    timestamp: '2026-02-11T16:45:00Z',
    details: 'Johnson Controls HVAC invoice held — amount exceeds contract terms by 15%. Procurement review required.',
  ...
  },
  {
    ...
    entityId: 'rcv-005',
    action: 'Financial Hold Applied',
    performedBy: 'Bursar Office',
    timestamp: '2026-02-02T08:00:00Z',
    details: 'Financial hold placed on Keisha Brown (BCU-2023-0612). Outstanding fall 2025 balance of $14,800.',
    evidenceStatus: 'complete',
    policyException: false,
  },
  {
...
const EXCEPTION_RISKS: ExceptionRiskItem[] = [
  ...
  },
  {
    ...
    severity: 'warning',
    category: 'Budget',
    description: 'FMU Athletics at 92% forecast burn with only 67% of fiscal year elapsed. Team travel costs driving variance. Conference schedule changes contributing factor.',
