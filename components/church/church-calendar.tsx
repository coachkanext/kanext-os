...
const NEXT_WEEK_AGENDA: AgendaEvent[] = [
  ...
  { id: 'ca-n4', time: '9:00 AM', endTime: '3:00 PM', title: 'Leadership Retreat (Staff)', type: 'class', location: 'Conference Center', assignedTo: 'Pastor Kalejaiye', notes: 'Next Saturday', staffOnly: true },
];
