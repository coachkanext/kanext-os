...
export const COMMUNITY_MEMBERS: CommunityMember[] = [
  // Leadership
  {
    id: 'm1', name: 'Dr. Dipo Kalejaiye', handle: 'pastor.dipo', initials: 'DK', hue: 220,
    role: 'admin', departments: ['Vineyard Voices', 'Fresh Fire', 'Hospitality', 'Amazing Grace Outreach', 'Life Transformation Groups'],
    groups: ['Men Wondered At'],
    joinDate: '2015-01-15', lastAttended: '2026-03-22', status: 'active',
    phone: '(310) 555-0101', email: 'pastor.dipo@iccla.com', givingThisYear: 12000,
    pastoralNote: 'Senior Pastor and Co-Founder. ICCLA began as a prayer meeting in the Kalejaiye home. Vision-driven, pastoral heart.',
    communicationCount: 145,
  },
  {
    id: 'm2', name: 'Pastor Nony Kalejaiye', handle: 'pastor.nony', initials: 'NK', hue: 280,
    role: 'staff', departments: ['Vineyard Voices', 'Amazing Grace Outreach'],
    groups: ['Virtuous Women\u2019s Fellowship'],
    joinDate: '2015-01-15', lastAttended: '2026-03-22', status: 'active',
    phone: '(310) 555-0202', email: 'pastor.nony@iccla.com', givingThisYear: 12000,
    pastoralNote: 'Co-Founding Pastor. Oversees women\u2019s ministry and pastoral care.',
    communicationCount: 89,
  },
  {
    id: 'm3', name: 'Dr. Kunle Pinmiloye', handle: 'ksticks', initials: 'KP', hue: 150,
    role: 'leader', departments: ['Vineyard Voices'],
    groups: ['Vineyard Voices'],
    joinDate: '2016-09-11', lastAttended: '2026-03-22', status: 'active',
    phone: '(310) 555-0303', email: 'kunle@iccla.com', givingThisYear: 4200,
    pastoralNote: 'Music Ministry Director (Vineyard Voices). Leads praise and worship across all services and special events.',
    communicationCount: 67,
  },
  {
    id: 'm4', name: 'David Eze', handle: 'david.eze', initials: 'DE', hue: 40,
    role: 'leader', departments: ['Fresh Fire'],
    groups: ['T.O.R.C.H. Nation'],
    joinDate: '2018-06-03', lastAttended: '2026-03-22', status: 'active',
    phone: '(310) 738-8298', email: 'david.eze@iccla.com', givingThisYear: 1800,
    pastoralNote: 'T.O.R.C.H. Nation Young Adults Ministry leader.',
    communicationCount: 34,
  },
  {
    id: 'm5', name: 'Angela Brown', handle: 'sis.angela', initials: 'AB', hue: 260,
    role: 'leader', departments: ['Life Transformation Groups'],
    groups: ['Virtuous Women\u2019s Fellowship', 'Rooted'],
    joinDate: '2017-02-19', lastAttended: '2026-03-22', status: 'active',
    phone: '(323) 555-0505', email: 'a.brown@iccla.com', givingThisYear: 3600,
    pastoralNote: 'Life Groups leader. Facilitates Rooted and women\u2019s discipleship.',
    communicationCount: 52,
  },
  {
    id: 'm6', name: 'Shirley Washington', handle: 'deaconess.shirley', initials: 'SW', hue: 350,
    role: 'staff', departments: ['Sheepfold & Hospitality'],
    groups: ['Virtuous Women\u2019s Fellowship'],
    joinDate: '2015-08-22', lastAttended: '2026-03-22', status: 'active',
    phone: '(323) 555-0606', email: 's.washington@iccla.com', givingThisYear: 6000,
  ...
  },
  {
    ...
    role: 'leader', departments: ['Amazing Grace Outreach'],
    groups: ['Men Wondered At', 'Hotline to Heaven'],
    joinDate: '2016-11-07', lastAttended: '2026-03-15', status: 'active',
    phone: '(323) 555-0707', email: 'r.davis@iccla.com', givingThisYear: 2800,
...
export const ATTENDANCE_EVENTS: AttendanceEvent[] = [
  {
    id: 'e1', name: 'Celebration Service', date: '2026-03-22',
    attendeeCount: 94,
    checkedInIds: [...ACTIVE_IDS, 'm26', 'm27', 'm28', 'm29'],
  },
  {
    id: 'e2', name: 'Celebration Service', date: '2026-03-15',
    attendeeCount: 87,
    checkedInIds: [...ACTIVE_IDS.slice(0, 17), 'm26'],
  },
  {
    id: 'e3', name: 'Celebration Service', date: '2026-03-08',
    attendeeCount: 102,
    checkedInIds: ACTIVE_IDS,
  },
  {
    id: 'e4', name: 'Celebration Service', date: '2026-03-01',
    attendeeCount: 89,
    checkedInIds: [...ACTIVE_IDS.slice(0, 16), 'm22', 'm24'],
  },
  {
    id: 'e5', name: 'Celebration Service', date: '2026-02-22',
    attendeeCount: 95,
    checkedInIds: [...ACTIVE_IDS, 'm22', 'm23'],
  },
  {
    id: 'e6', name: 'Celebration Service', date: '2026-02-15',
    attendeeCount: 78,
    checkedInIds: ACTIVE_IDS.slice(0, 14),
  },
  {
    id: 'e7', name: 'Celebration Service', date: '2026-02-08',
    attendeeCount: 91,
    checkedInIds: ACTIVE_IDS,
  },
  {
    id: 'e8', name: 'Celebration Service', date: '2026-02-01',
    attendeeCount: 85,
...
export const MY_ATTENDANCE_HISTORY: { date: string; event: string }[] = [
  { date: '2026-03-22', event: 'Celebration Service' },
  { date: '2026-03-15', event: 'Celebration Service' },
  { date: '2026-03-08', event: 'Celebration Service' },
  { date: '2026-03-01', event: 'Celebration Service' },
  { date: '2026-02-22', event: 'Celebration Service' },
  { date: '2026-02-08', event: 'Celebration Service' },
  { date: '2026-02-01', event: 'Celebration Service' },
];
