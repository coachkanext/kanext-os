...
const MODE_OPTIONS: ModeOption[] = [
  { key: 'sports',    label: 'Sports',    subtitle: 'Team, program, or league',        icon: 'trophy.fill',        color: '#990000' },
  { key: 'business',  label: 'Business',  subtitle: 'Company, startup, or agency',     icon: 'briefcase.fill',     color: '#1D9BF0' },
  { key: 'education', label: 'Education', subtitle: 'School, university, or program',  icon: 'graduationcap.fill', color: '#003A63' },
  { key: 'community', label: 'Community', subtitle: 'Church, nonprofit, or organization', icon: 'person.3.fill',  color: '#7B68A0' },
];
