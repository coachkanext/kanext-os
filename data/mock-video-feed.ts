...
const CHURCH_STORY_CIRCLES: StoryCircle[] = [
  ...
  { id: 'cs-8', name: 'KaNeXT Church Live', initials: 'IC', hasNew: true, ringColor: '#1D9BF0' },
];
...
const BUSINESS_FEED_POSTS: VideoFeedPost[] = [
  {
    ...
    media: { type: 'clip', title: 'KaNeXT V2 — Full Demo', thumbnailColor: '#0B0F14', duration: '14:32', views: 1240 },
    likes: 67,
    comments: 12,
  },
  {
  ...
  },
  {
    ...
    media: { type: 'clip', title: 'Customer Story — KaNeXT', thumbnailColor: '#0B0F14', duration: '4:48', views: 2340 },
    likes: 112,
    comments: 19,
    saved: true,
  },
  {
    ...
    media: { type: 'reel', title: 'HBCU Tech Summit — KaNeXT Booth', thumbnailColor: '#0B0F14', duration: '0:58', views: 4560 },
    likes: 189,
    comments: 33,
  },
  {
