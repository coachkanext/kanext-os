 ...
 * Owner:    Inquiries · Archive + Dipson / Settings / Help
 * Follower: Collaborate · Submissions + Dipson / Settings / Help
 */
...
const OWNER_NAV: NavItem[] = [
  { icon: 'tray.and.arrow.down.fill', label: 'Inquiries',  route: '/(tabs)/(main)/personal-inquiries' },
  { icon: 'person.wave.2.fill',       label: 'Collaborate', route: '/(tabs)/(main)/personal-inquiries/collaborate' },
  { icon: 'archivebox.fill',          label: 'Archive',    route: '/(tabs)/(main)/personal-inquiries/archive' },
];

const FOLLOWER_NAV: NavItem[] = [
  { icon: 'person.wave.2.fill',       label: 'Collaborate', route: '/(tabs)/(main)/personal-inquiries/collaborate' },
  { icon: 'doc.text.fill',            label: 'Submissions', route: '/(tabs)/(main)/personal-inquiries/submissions' },
];
...
const makeStyles = (C: ComponentColors) => StyleSheet.create({
  ...
  avatarInitials: { fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
