...
const PHYSICAL_ASSETS: PhysicalAsset[] = [
  { id: 'pa-1', name: '2819 Church Championship Trophy', category: 'trophy', location: 'Commissioner\'s Office', condition: 'excellent', value: 28000, acquiredDate: 'Sep 2019', assignedTo: 'Executive Office' },
  ...
  { id: 'pa-4', name: 'Commissioner\'s Podium', category: 'podium', location: '3SSB Arena — Press Room', condition: 'excellent', value: 8500, acquiredDate: 'Jan 2021', assignedTo: 'Communications' },
  { id: 'pa-5', name: 'Main Lobby Entrance Signage', category: 'signage', location: '3SSB Arena Entrance', condition: 'good', value: 15000, acquiredDate: 'Mar 2020', assignedTo: 'Facilities' },
  { id: 'pa-6', name: 'Conference Banner Set (16)', category: 'display', location: '3SSB Arena — Rafters', condition: 'good', value: 22000, acquiredDate: 'Nov 2021', assignedTo: 'Operations' },
  ...
  { id: 'pa-8', name: 'VIP Lounge Furniture Set', category: 'furniture', location: '3SSB Arena — VIP Suite', condition: 'good', value: 18500, acquiredDate: 'Jul 2021', assignedTo: 'Hospitality' },
  ...
  { id: 'pa-12', name: 'Hall of Champions Display Cases', category: 'display', location: '3SSB Arena — Main Concourse', condition: 'excellent', value: 14000, acquiredDate: 'Oct 2021', assignedTo: 'Operations' },
  ...
  { id: 'pa-15', name: 'Retired Championship Banners (6)', category: 'display', location: '3SSB Arena — Rafters', condition: 'retired', value: 3600, acquiredDate: 'Feb 2018', assignedTo: 'Arizona Christian' },
];
...
const EQUIPMENT_ASSETS: EquipmentAsset[] = [
  { id: 'eq-1', name: '3SSB Timing System (Swiss Timing)', category: 'timing', serialNumber: 'ST-2024-00482', condition: 'excellent', location: '3SSB Arena — Control Room', lastServiced: 'Jan 8, 2026', nextService: 'Jul 8, 2026' },
  { id: 'eq-2', name: '3SSB Arena LED Scoreboard', category: 'scoring', serialNumber: 'DAK-2022-11947', condition: 'excellent', location: '3SSB Arena — Center Court', lastServiced: 'Dec 15, 2025', nextService: 'Jun 15, 2026' },
  { id: 'eq-3', name: 'Daktronics Shot Clock System (4)', category: 'scoring', serialNumber: 'DAK-SC-0042', condition: 'good', location: '3SSB Arena — Court Level', lastServiced: 'Nov 20, 2025', nextService: 'May 20, 2026' },
  ...
  { id: 'eq-5', name: 'PTZ Camera System (6-cam)', category: 'broadcast', serialNumber: 'PTZ-CAM-0061', condition: 'good', location: '3SSB Arena — Camera Bays', lastServiced: 'Jan 22, 2026', nextService: 'Jul 22, 2026' },
  ...
  { id: 'eq-9', name: 'Wireless Microphone System (Shure)', category: 'av', serialNumber: 'SHURE-ULX-4421', condition: 'excellent', location: '3SSB Arena — Press Room', lastServiced: 'Jan 15, 2026', nextService: 'Jul 15, 2026' },
  ...
  { id: 'eq-11', name: 'LED Court Projection System', category: 'av', serialNumber: 'PROJ-EPSON-7720', condition: 'needs-repair', location: '3SSB Arena — Catwalk', lastServiced: 'Aug 20, 2025', nextService: 'OVERDUE' },
  { id: 'eq-12', name: 'Instant Replay System (Hawk-Eye)', category: 'scoring', serialNumber: 'HE-REPLAY-0012', condition: 'excellent', location: '3SSB Arena — Replay Booth', lastServiced: 'Feb 5, 2026', nextService: 'Aug 5, 2026' },
...
const VENUE_ASSETS: VenueAsset[] = [
  { id: 've-1', name: '3SSB Arena', type: 'arena', capacity: 8500, address: '10501 FGCU Blvd, Fort Myers, FL 33965', ownedOrLeased: 'partnership', leaseExpiry: 'Jun 30, 2032', annualCost: 420000 },
  ...
  { id: 've-3', name: '2819 Church Championship Court', type: 'court', capacity: 4200, address: '2000 Main St, Sarasota, FL 34236', ownedOrLeased: 'leased', leaseExpiry: 'Mar 31, 2027', annualCost: 165000 },
  ...
  { id: 've-7', name: '2819 Church Indoor Training Center', type: 'training-facility', capacity: 300, address: '10501 FGCU Blvd, Fort Myers, FL 33965', ownedOrLeased: 'owned', leaseExpiry: 'N/A', annualCost: 145000 },
...
const MAINTENANCE_RECORDS: MaintenanceRecord[] = [
  { id: 'mt-1', assetId: 'eq-1', assetName: '3SSB Timing System (Swiss Timing)', type: 'scheduled', date: 'Jan 8, 2026', cost: 2800, status: 'completed', technician: 'Swiss Timing Service' },
  { id: 'mt-2', assetId: 'eq-2', assetName: '3SSB Arena LED Scoreboard', type: 'inspection', date: 'Dec 15, 2025', cost: 450, status: 'completed', technician: 'Daktronics Certified Tech' },
  ...
  { id: 'mt-6', assetId: 've-1', assetName: '3SSB Arena', type: 'inspection', date: 'Feb 28, 2026', cost: 5500, status: 'scheduled', technician: 'Arena Services Group' },
  ...
  { id: 'mt-9', assetId: 've-3', assetName: '2819 Church Championship Court', type: 'upgrade', date: 'Mar 1, 2026', cost: 45000, status: 'scheduled', technician: 'CourtTech Pro' },
...
const INSURANCE_POLICIES: InsurancePolicy[] = [
  { id: 'ip-1', name: 'General Liability — All Venues', provider: 'Hartford Financial', coverage: 5000000, premium: 48000, startDate: 'Jul 1, 2025', endDate: 'Jun 30, 2026', status: 'active', assets: ['3SSB Arena', 'Eagles Field Stadium', '2819 Church Championship Court'] },
  { id: 'ip-2', name: 'Equipment Floater — Electronics', provider: 'Chubb Insurance', coverage: 2000000, premium: 18000, startDate: 'Jan 1, 2026', endDate: 'Dec 31, 2026', status: 'active', assets: ['3SSB Timing System', 'LED Scoreboard', 'Hawk-Eye Replay', 'PTZ Camera System'] },
  ...
  { id: 'ip-5', name: 'Property Insurance — Owned Assets', provider: 'Hartford Financial', coverage: 4500000, premium: 36000, startDate: 'Jul 1, 2025', endDate: 'Jun 30, 2026', status: 'expiring-soon', assets: ['Gulf Coast Athletic Complex', '2819 Church Indoor Training Center', 'Trophies', 'Display Cases'] },
  ...
  { id: 'ip-12', name: 'Trophy & Awards Coverage', provider: 'Lloyd\'s of London', coverage: 250000, premium: 4200, startDate: 'Sep 1, 2025', endDate: 'Aug 31, 2026', status: 'active', assets: ['2819 Church Championship Trophy', 'All Award Items'] },
];
