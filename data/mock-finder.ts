...
export const MOCK_FINDER_INDEX: FinderResult[] = [
  ...
  // Games
  { id: 'f-7', label: 'Carroll vs Coastal Carolina', subtitle: 'Final · W 81-74', type: 'game', icon: 'sportscourt.fill', route: '/(tabs)/index' },
  { id: 'f-8', label: 'Carroll vs Campbell', subtitle: 'Upcoming · Feb 15', type: 'game', icon: 'sportscourt.fill', route: '/(tabs)/index' },
  { id: 'f-9', label: 'Carroll vs UNC Asheville', subtitle: 'Final · L 69-72', type: 'game', icon: 'sportscourt.fill', route: '/(tabs)/index' },
  // Clips
