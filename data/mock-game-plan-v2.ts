...
// =============================================================================
// GAME PLAN 2: St. Thomas University (ARCHIVED — FMU Won 72-65)
// =============================================================================
...
export const GAME_PLAN_HEADER_STT: GamePlanHeader = {
  ...
  location: 'FMU Wellness Center (Home)',
  status: 'archived',
  version: 5,
  lastEditedBy: 'Coach Kalejaiye',
  lastEditedAt: 'Feb 16, 2026 · 10:30 AM',
  lockedBy: 'Coach Kalejaiye',
...
export const OFFENSIVE_PLAN_STT: OffensiveSystemPlan = {
  ...
  emphasisPlays: [
    ...
    { id: 'ep-stt-2', name: 'Post Feed to Kalejaiye', priority: 'primary', notes: 'STT undersized at the 5 — Kalejaiye deep seal was automatic' },
    { id: 'ep-stt-3', name: 'Corner Pin-Down (Plantey)', priority: 'secondary', notes: 'Plantey hit 3 corner 3s off pin-downs in the 1st half' },
    { id: 'ep-stt-4', name: 'Transition Push', priority: 'primary', notes: 'STT slow getting back — 14 fast break points for FMU' },
    { id: 'ep-stt-5', name: 'ATO Lob (Kalejaiye)', priority: 'situational', notes: 'Used twice in 4Q — Kalejaiye lob finish sealed the game' },
  ],
  adjustments: [
    'POSTGAME: Horns PnR generated 1.22 PPP — keep as primary action vs switching teams',
    'POSTGAME: Post feed to Kalejaiye worked early but STT started fronting in 3Q — need counter',
...
export const KEY_MATCHUPS_STT: KeyMatchup[] = [
  ...
  { id: 'km-stt-2', ourPlayer: 'L. Kalejaiye', theirPlayer: 'M. Contreras', matchupType: 'primary', notes: 'Kalejaiye dominated inside — 18 pts, 11 reb, 3 blk. Contreras had no answer.', advantageRating: 2 },
  ...
  { id: 'km-stt-5', ourPlayer: 'N. Chtelan', theirPlayer: 'L. Baptiste', matchupType: 'primary', notes: 'Chtelan controlled Baptiste on both ends. 8 pts, 4 reb, 2 stl for Chtelan.', advantageRating: 1 },
];

export const ROTATION_PLAN_STT: RotationSlot[] = [
  { period: '1H', startMin: 0, endMin: 6, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Starting five — established early post presence' },
  { period: '1H', startMin: 6, endMin: 10, lineup: ['Williams', 'Collins', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Collins in for shooting — hit 2 catch-and-shoot 3s' },
  { period: '1H', startMin: 10, endMin: 14, lineup: ['Blake', 'Collins', 'Hernandez', 'Moore', 'Kalejaiye'], notes: 'Bench unit — held lead at +6' },
  { period: '1H', startMin: 14, endMin: 20, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Moore'], notes: 'Closed half up 35-30' },
  { period: '2H', startMin: 0, endMin: 5, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Starters opened 2H — 8-0 run' },
  { period: '2H', startMin: 5, endMin: 10, lineup: ['Williams', 'Plantey', 'Hernandez', 'Diomande', 'Kalejaiye'], notes: 'Hernandez in for defensive stops' },
  { period: '2H', startMin: 10, endMin: 14, lineup: ['Blake', 'Collins', 'Hernandez', 'Moore', 'Kalejaiye'], notes: 'Bench stretch — STT cut it to 5' },
  { period: '2H', startMin: 14, endMin: 20, lineup: ['Williams', 'Plantey', 'Hernandez', 'Diomande', 'Kalejaiye'], notes: 'Closing lineup — Hernandez for Chtelan (defense). Closed it out 72-65' },
];
...
export const SCOUT_NOTES_STT: ScoutNote[] = [
  ...
  { id: 'sn-stt-3', category: 'weakness', title: 'Interior Defense', detail: 'STT allows 42.6 pts in the paint. Kalejaiye feasted — 18 pts inside. Repeat this approach.', source: 'KaNeXT Analytics', confidence: 'high' },
  { id: 'sn-stt-4', category: 'weakness', title: 'Transition Defense', detail: 'STT ranks bottom-10 in Sun Conference in transition D. FMU scored 14 fast break points.', source: 'KaNeXT Analytics', confidence: 'high' },
...
export const STAFF_ASSIGNMENTS_STT: StaffAssignment[] = [
  { id: 'sa-stt-1', staffName: 'Coach Kalejaiye', role: 'HC', responsibility: 'Overall game plan execution, postgame film breakdown', pregameTask: 'Final scout review', inGameTask: 'Bench management — key 4Q timeout at 62-60 led to ATO lob' },
...
export const OFFENSIVE_PLAN_SEU: OffensiveSystemPlan = {
  ...
  emphasisPlays: [
    ...
    { id: 'ep-seu-5', name: 'Back Screen Lob (Kalejaiye)', priority: 'secondary', notes: 'SEU bigs ball-watch on back screens — Kalejaiye slips for lob' },
    { id: 'ep-seu-6', name: 'ATO Flex Action', priority: 'situational', notes: 'After timeouts — flex screen for Chtelan mid-range or Kalejaiye post-up' },
  ],
  adjustments: [
    'If SEU goes zone → high-low with Diomande/Kalejaiye, 3PT shooters in corners',
    'If Williams gets trapped on PnR → Blake enters, same sets but slower pace',
    'If SEU press → Plantey and Chtelan on ball-side, attack with numbers in frontcourt',
    'If leading by 8+ → motion only, burn clock, post-ups for Kalejaiye/Diomande',
  ],
};
...
export const DEFENSIVE_PLAN_SEU: DefensiveSystemPlan = {
  ...
  adjustments: [
    ...
    'If foul trouble on Kalejaiye → Moore at 5, zone for 2 possessions to slow them down',
  ],
};
...
export const KEY_MATCHUPS_SEU: KeyMatchup[] = [
  ...
  { id: 'km-seu-3', ourPlayer: 'L. Kalejaiye', theirPlayer: 'M. Jefferson', matchupType: 'primary', notes: 'Jefferson is physical but limited offensively. Kalejaiye should dominate inside. Foul discipline is key.', advantageRating: 1 },
  { id: 'km-seu-4', ourPlayer: 'N. Chtelan', theirPlayer: 'K. Anderson', matchupType: 'primary', notes: 'Anderson crashes boards hard. Chtelan must box out and limit second-chance points.', advantageRating: 0 },
...
export const ROTATION_PLAN_SEU: RotationSlot[] = [
  { period: '1H', startMin: 0, endMin: 6, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Starting five — set the tone early, establish post presence' },
  { period: '1H', startMin: 6, endMin: 10, lineup: ['Williams', 'Collins', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Collins in for extra shooting — attack zone if they switch' },
  { period: '1H', startMin: 10, endMin: 14, lineup: ['Blake', 'Collins', 'Hernandez', 'Moore', 'Kalejaiye'], notes: 'Bench unit — energy and defense, maintain lead' },
  { period: '1H', startMin: 14, endMin: 20, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Moore'], notes: 'Close half — Moore stays for rebounding vs Anderson' },
  { period: '2H', startMin: 0, endMin: 5, lineup: ['Williams', 'Plantey', 'Chtelan', 'Diomande', 'Kalejaiye'], notes: 'Open with starters — fast start to 2nd half' },
  { period: '2H', startMin: 5, endMin: 10, lineup: ['Williams', 'Plantey', 'Hernandez', 'Diomande', 'Kalejaiye'], notes: 'Hernandez for defensive possessions — lock down Robinson' },
  { period: '2H', startMin: 10, endMin: 14, lineup: ['Blake', 'Collins', 'Hernandez', 'Moore', 'Kalejaiye'], notes: 'Bench run — protect lead with defense-first unit' },
  { period: '2H', startMin: 14, endMin: 20, lineup: ['Williams', 'Plantey', 'Hernandez', 'Diomande', 'Kalejaiye'], notes: 'Closing five — Hernandez over Chtelan if Robinson is hot' },
];
...
export const SCOUT_NOTES_SEU: ScoutNote[] = [
  ...
  { id: 'sn-seu-4', category: 'weakness', title: 'Transition Defense', detail: 'SEU ranks 9th in Sun Conference in transition defense. They give up 13.4 fast break PPG. Attackable if we push pace.', source: 'KaNeXT Analytics', confidence: 'medium' },
  ...
  { id: 'sn-seu-6', category: 'weakness', title: 'Interior Defense', detail: 'SEU allows 40.8 pts in paint. Jefferson is their only rim protector. When he sits, paint is open. Feed Kalejaiye/Diomande.', source: 'KaNeXT Analytics', confidence: 'high' },
...
export const STAFF_ASSIGNMENTS_SEU: StaffAssignment[] = [
  { id: 'sa-seu-1', staffName: 'Coach Kalejaiye', role: 'HC', responsibility: 'Overall game plan execution, Robinson containment strategy', pregameTask: 'Final scout review with team — emphasize corner 3 closeouts', inGameTask: 'Bench management, timeout strategy, Hernandez rotation timing' },
