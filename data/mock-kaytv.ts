...
export interface KayTVFeedItem {
  ...
  thumbHue: number;
  thumbEmoji: string;
  thumbUri?: string;          // real thumbnail image (overrides hsl gradient)
...
const _GAME_PEPPER  = { ..._LB, title: 'Lincoln @ Pepperdine — Laolu 12 Three-Pointers',       thumbHue: 215, thumbUri: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=640&h=360&fit=crop&q=80', duration: '4:12', viewCount: 24800, likeCount: 1840, commentCount: 312, description: 'Laolu drops 12 three-pointers in a dominant road win at Pepperdine.',          videoUri: A_PEPPER  };
const _GAME_LB      = { ..._LB, title: 'Lincoln @ Long Beach State — Laolu 6 Three-Pointers',  thumbHue:  45, thumbUri: 'https://images.unsplash.com/photo-1504450758481-7338eba7524a?w=640&h=360&fit=crop&q=80', duration: '3:48', viewCount: 18400, likeCount: 1340, commentCount: 224, description: 'Six threes in a statement road win at Long Beach State.',                       videoUri: A_LB      };
const _GAME_WEBER   = { ..._LB, title: 'Lincoln @ Weber State — Laolu 4 Three-Pointers',       thumbHue: 270, thumbUri: 'https://images.unsplash.com/photo-1519861531473-9200262188bf?w=640&h=360&fit=crop&q=80', duration: '3:22', viewCount: 14200, likeCount:  980, commentCount: 156, description: 'Laolu catches fire from three in a big road win at Weber State.',              videoUri: A_WEBER   };
const _GAME_IRVINE  = { ..._LB, title: 'Lincoln @ UC Irvine — Laolu 4 Three-Pointers',         thumbHue: 210, thumbUri: 'https://images.unsplash.com/photo-1475403614135-5f1aa0eb5015?w=640&h=360&fit=crop&q=80', duration: '2:58', viewCount: 12600, likeCount:  890, commentCount: 143, description: 'Four threes and a complete team effort in Irvine.',                            videoUri: A_IRVINE  };
const _GAME_LMU     = { ..._LB, title: 'Lincoln @ LMU — Laolu 2 Three-Pointers',               thumbHue:   0, thumbUri: 'https://images.unsplash.com/photo-1577416412292-747c6607f055?w=640&h=360&fit=crop&q=80', duration: '2:34', viewCount:  9800, likeCount:  720, commentCount: 118, description: 'Two big threes help Lincoln pull away at LMU.',                                videoUri: A_LMU     };
const _GAME_SIMPSON = { ..._LB, title: 'Lincoln @ Simpson — Laolu 8 Three-Pointers',           thumbHue:  10, thumbUri: 'https://images.unsplash.com/photo-1566577739112-5180d4bf9390?w=640&h=360&fit=crop&q=80', duration: '4:05', viewCount: 16200, likeCount: 1120, commentCount: 189, description: 'Career-high eight three-pointers — Laolu goes off at Simpson.',                videoUri: A_SIMPSON };
const _GAME_MAR_W   = { ..._LB, title: 'Lincoln vs Cal Maritime (W) — Laolu 6 Three-Pointers', thumbHue: 205, thumbUri: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=640&h=360&fit=crop&q=80', duration: '3:30', viewCount: 11400, likeCount:  810, commentCount: 134, description: 'Six threes in a convincing home win over Cal Maritime.',                       videoUri: A_MAR_W   };
const _GAME_MAR_L   = { ..._LB, title: 'Lincoln @ Cal Maritime (L) — Laolu 6 Three-Pointers',  thumbHue: 205, thumbUri: 'https://images.unsplash.com/photo-1627627256672-027a4613d028?w=640&h=360&fit=crop&q=80', duration: '3:15', viewCount: 10200, likeCount:  740, commentCount: 122, description: 'Laolu hit six threes but Lincoln fell short in a tough road game at Maritime.', videoUri: A_MAR_L   };
