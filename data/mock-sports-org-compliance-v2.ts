 ...
 * FMU Men's Basketball program compliance: eligibility, travel docs,
...
const exceptions: ComplianceException[] = [
  {
    ...
    requiredApprovers: ['Sammy Kalejaiye'],
    status: 'approved',
  ...
  },
  {
    ...
    requiredApprovers: ['NAIA Eligibility Center', 'Sammy Kalejaiye'],
    status: 'pending',
