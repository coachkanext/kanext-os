...
const SCHEDULE_DAYS: ScheduleDay[] = [
  {
    ...
    assignments: [
      ...
      { id: 'sa-14', personName: 'Sarah Mitchell', team: 'Worship Team', role: 'Vocalist', serviceTime: '8:00 AM & 10:30 AM', campus: 'Downtown', status: 'confirmed' },
  ...
  },
  {
    ...
    assignments: [
      ...
      { id: 'sa-40', personName: 'Sarah Mitchell', team: 'Worship Team', role: 'Vocalist', serviceTime: '8:00 AM & 10:30 AM', campus: 'Downtown', status: 'confirmed' },
...
const VOLUNTEERS: Volunteer[] = [
  ...
  { id: 'v-12', name: 'Sarah Mitchell', teams: ['Worship Team'], roles: ['Vocalist'], joinedDate: 'Nov 2022', totalHours: 480, availability: 'Every Sunday', lastServed: 'Feb 16, 2026', reliabilityScore: 94, status: 'active', attendanceRate: 93 },
      ...
      <View style={s.moduleContainer}>
        ...
        <Card colors={colors}>
          {filtered.map((vol, idx) => {
            ...
            const reliabilityColor = vol.reliabilityScore >= 90 ? '#22C55E' : vol.reliabilityScore >= 70 ? '#F59E0B' : vol.reliabilityScore > 0 ? '#EF4444' : '#8F8F8F';
