/**
 * Business Mode RBAC Registry — Constitutional 4D Role Definitions
 *
...
export const BUSINESS_ROLES: Record<BusinessRoleLens, UniversalRoleDefinition> = {
  B0:  { id: 'B0',  label: 'System Owner',                authority: Authority.Institutional, scope: 'global',   visibility: Vis.Institutional, decision: Decision.Institutional },
  B1:  { id: 'B1',  label: 'Founder / CEO',               authority: Authority.Institutional, scope: 'global',   visibility: Vis.Institutional, decision: Decision.Institutional },
  B2:  { id: 'B2',  label: 'Co-Founder / C-Suite',        authority: Authority.DomainGov,     scope: 'domain',   visibility: Vis.Strategic,     decision: Decision.Strategic },
  B3:  { id: 'B3',  label: 'Department Head / VP',        authority: Authority.ProgramGov,    scope: 'program',  visibility: Vis.Competitive,   decision: Decision.Tactical },
  B4:  { id: 'B4',  label: 'Team Lead / Manager',         authority: Authority.Execution,     scope: 'program',  visibility: Vis.Tactical,      decision: Decision.Operational },
  B5:  { id: 'B5',  label: 'Employee / Contributor',      authority: Authority.Personal,      scope: 'personal', visibility: Vis.Community,      decision: Decision.Self },
  B6:  { id: 'B6',  label: 'Strategic Investor',          authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None, isExternal: true, domainLane: 'finance' },
  B7:  { id: 'B7',  label: 'Retail / Minority Investor',  authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None, isExternal: true, domainLane: 'finance' },
  B8:  { id: 'B8',  label: 'Advisor',                     authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None, isExternal: true },
  B9:  { id: 'B9',  label: 'Board Member',                authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None, isExternal: true },
  B10: { id: 'B10', label: 'Acquirer / Strategic Partner', authority: Authority.Observer,     scope: 'personal', visibility: Vis.Public,         decision: Decision.None, isExternal: true },
  B11: { id: 'B11', label: 'Subscriber / Customer',       authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None },
  B12: { id: 'B12', label: 'Public',                      authority: Authority.Observer,      scope: 'personal', visibility: Vis.Public,         decision: Decision.None },
  B13: { id: 'B13', label: 'Holding Company',             authority: Authority.Institutional, scope: 'global',   visibility: Vis.Institutional, decision: Decision.Institutional },
};
...
/** Constitutional: authority >= Institutional (B0, B1, B13). */
export function isFounder(role: BusinessRoleLens): boolean {
  return BUSINESS_ROLES[role].authority >= Authority.Institutional;
}

/** Constitutional: isExternal OR authority >= DomainGov (B0-B2, B6, B8, B9, B13). */
export function isBoardLevel(role: BusinessRoleLens): boolean {
  const def = BUSINESS_ROLES[role];
  return !!def.isExternal || def.authority >= Authority.DomainGov;
}

/** Exact match — only the two investor roles. */
