...
const SERVICE_PLANS: ServicePlan[] = [
  {
    ...
    elements: [
      ...
      { id: 'el-6', label: 'Sermon', timeAllocation: '35 min', assignedPerson: 'Pastor Carter', notes: '"Walking in Purpose" - Series Part 3', status: 'confirmed' },
      { id: 'el-7', label: 'Altar Call', timeAllocation: '10 min', assignedPerson: 'Pastor Carter', notes: 'Invitation to accept Christ', status: 'confirmed' },
      ...
      { id: 'el-11', label: 'Benediction', timeAllocation: '2 min', assignedPerson: 'Pastor Carter', notes: 'Closing blessing', status: 'confirmed' },
  ...
  },
  {
    ...
    elements: [
      ...
      { id: 'el-26', label: 'Sermon', timeAllocation: '35 min', assignedPerson: 'Pastor Carter', notes: '"Walking in Purpose" - Series Part 4', status: 'confirmed' },
      { id: 'el-27', label: 'Altar Call', timeAllocation: '10 min', assignedPerson: 'Pastor Carter', notes: '', status: 'confirmed' },
      ...
      { id: 'el-31', label: 'Benediction', timeAllocation: '2 min', assignedPerson: 'Pastor Carter', notes: '', status: 'confirmed' },
...
const VOLUNTEER_EVENTS: VolunteerEvent[] = [
  {
    ...
    slots: [
      ...
      { id: 'vs-7', role: 'Media / ProPresenter', person: 'Lisa Grant', shiftTime: '8:30 AM - 12:30 PM' },
...
const RECENT_CHECKINS: RecentCheckIn[] = [
  ...
  { id: 'rc-2', name: 'Lisa Grant', time: '9:41 AM', location: 'Main Entrance', type: 'member' },
  ...
  return (
    <View>
      ...
      <Pressable
        ...
        onPress={() => Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
      >
        <View style={[s.featuredCatBadge, { backgroundColor: `${ACCENT}40` }]}>
            ...
            <Pressable key={event.id} onPress={() => Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}>
              <Card colors={colors}>
                ...
                <View style={s.browseBottomRow}>
                  ...
                  <Pressable
                    style={[s.rsvpButton, { backgroundColor: canRsvp ? ACCENT : colors.backgroundTertiary }]}
              ...
              {isExpanded && (
                <View style={s.ministryExpanded}>
                  {ministry.events.map((event, idx) => (
                    ...
                    >
                      <View style={[s.catDot, { backgroundColor: ACCENT }]} />
                      <View style={{ flex: 1 }}>
            ...
            <Card colors={colors}>
              ...
              {plan.worshipSetLink && (
                <Pressable
                  ...
                  onPress={() => Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
                >
                  <IconSymbol name="music.note.list" size={12} color={ACCENT} />
    ...
    <View>
      ...
      <Card colors={colors}>
        ...
        <View style={[s.statsRow, { marginTop: Spacing.sm }]}>
          <StatBox label="Checked In" value={String(totalCheckedIn)} colors={colors} valueColor={ACCENT} />
        ...
        <>
          ...
          <Card colors={colors}>
            ...
            >
              ...
              <ThemedText style={[s.quickAddText, { color: ACCENT }]}>Add New Attendee</ThemedText>
            </Pressable>
          ...
          {WEEKLY_ATTENDANCE.map((week, idx) => {
            ...
            return (
              <View key={idx} style={s.chartBarWrap}>
                ...
                <View style={[s.chartBar, { height: barHeight, backgroundColor: ACCENT }]} />
...
const s = StyleSheet.create({
  ...
  worshipSetLinkText: { flex: 1, fontSize: 12, fontWeight: '500', color: ACCENT },
