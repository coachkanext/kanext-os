 ...
 * Head Coach: Calendar · Reminders · Tasks · Availability
 * Player:     Calendar · Reminders · Tasks · Availability
...
export function SportsAgendaPanel() {
  ...
  const navItems = isHeadCoach ? OWNER_NAV_ITEMS : MEMBER_NAV_ITEMS;
