...
export const AGENDA_ITEMS: AgendaItem[] = [
  ...
  { id: 'ag-7', date: '2026-02-19', dayLabel: 'Wed', time: '5:00 PM', title: 'Bus Departure', type: 'Travel', location: 'KaNeXT Campus', notes: 'Away game at Keiser' },
  ...
  // Recruiting visits
  { id: 'ag-21', date: '2026-02-28', dayLabel: 'Sat', time: '10:00 AM', title: 'Campus Visit \u2014 Terrell Washington', type: 'Recruiting', location: 'KaNeXT Campus', attendees: 'Coach Davis, Coach Williams', notes: 'SF portal transfer from Webber. Official visit \u2014 full itinerary: campus tour, practice, dinner with team. Top priority recruit.' },
  ...
  // Travel itinerary
  { id: 'ag-24', date: '2026-03-04', dayLabel: 'Wed', time: '12:00 PM', title: 'Bus Departure \u2014 Ave Maria Away', type: 'Travel', location: 'KaNeXT Campus', attendees: 'Travel Roster', notes: 'Away game at Ave Maria University. ~2hr drive to Ave Maria, FL. Pre-game meal at 4:00 PM. Tipoff 7:00 PM.' },
...
export const NEWS_POSTS: NewsPost[] = [
  ...
  { id: 'news-2', title: 'KaNeXT Conference Standings Update', source: 'Conference', timestamp: '4h ago', badge: 'info', summary: 'KaNeXT moves to 2nd in KaNeXT Conference after Webber win.', category: 'Recap' },
...
export const KaNeXT_NATIONAL_POSITION: RankingRow = {
  rank: 42, team: 'KaNeXT Sports', record: '18-8', kr: 74, isUs: true, level: 'NAIA',
};
