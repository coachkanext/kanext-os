...
const DASHBOARD_BLOCKS: RoomsDashboardBlock[] = [
  { id: 'db-1', label: 'Total Rooms', value: '24', delta: '+3 this week', icon: 'rectangle.stack.fill', color: '#1A1714' },
  { id: 'db-2', label: 'Active Now', value: '11', delta: '46% utilization', icon: 'bolt.fill', color: '#5A8A6E' },
  { id: 'db-3', label: 'Broadcast Live', value: '4', delta: '12.8K viewers', icon: 'antenna.radiowaves.left.and.right', color: '#B85C5C' },
  { id: 'db-4', label: 'Occupancy Rate', value: '72%', delta: '+8% vs last event', icon: 'person.3.fill', color: '#B8943E' },
  { id: 'db-5', label: 'Pending Rulings', value: '6', delta: '3 urgent', icon: 'exclamationmark.triangle.fill', color: '#1A1714' },
...
const ACTIVITY_FEED: RoomActivityItem[] = [
  { id: 'af-1', roomName: '2819 Church War Room', action: 'Strategy session started', actor: 'Alex Morgan', timestampMs: Date.now() - 180000, color: '#5A8A6E' },
  { id: 'af-2', roomName: '3SSB Broadcast Center', action: 'Stream went live — Match 7', actor: 'Jordan Ellis', timestampMs: Date.now() - 420000, color: '#B85C5C' },
  { id: 'af-3', roomName: 'Match Officials Room A', action: 'Ruling submitted — Foul review', actor: 'Ref. Williams', timestampMs: Date.now() - 900000, color: '#1A1714' },
  { id: 'af-4', roomName: 'Press Room — Main Arena', action: 'Post-match presser opened', actor: 'Media Ops', timestampMs: Date.now() - 1500000, color: '#B8943E' },
  { id: 'af-5', roomName: 'VIP Lounge — Commissioner', action: 'Guest access granted', actor: 'Security Team', timestampMs: Date.now() - 2100000, color: '#1A1714' },
  { id: 'af-6', roomName: 'Ops Command Center', action: 'Task #14 completed — Venue setup', actor: 'Chris Rivera', timestampMs: Date.now() - 3600000, color: '#5A8A6E' },
  { id: 'af-7', roomName: '2819 Church War Room', action: 'Document shared — Scouting Report', actor: 'Mike Torres', timestampMs: Date.now() - 5400000, color: '#1A1714' },
  { id: 'af-8', roomName: '3SSB Broadcast Center', action: 'Camera 3 audio sync fixed', actor: 'Jordan Ellis', timestampMs: Date.now() - 7200000, color: '#B8943E' },
  { id: 'af-9', roomName: 'Match Officials Room B', action: 'Pre-match briefing completed', actor: 'Ref. Garcia', timestampMs: Date.now() - 9000000, color: '#9C9790' },
  { id: 'af-10', roomName: 'VIP Lounge — Sponsors', action: 'Catering delivered', actor: 'Event Services', timestampMs: Date.now() - 10800000, color: '#5A8A6E' },
];
...
const WAR_ROOMS: CompRoom[] = [
  { id: 'wr-1', name: '2819 Church War Room', type: 'war-room', status: 'active', capacity: 20, currentOccupancy: 14, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '2m ago' },
  ...
  { id: 'wr-3', name: 'Draft Strategy Room', type: 'war-room', status: 'idle', capacity: 12, currentOccupancy: 0, series: '3SSB Draft 2026', accessLevel: 'restricted', createdDate: 'Dec 18, 2025', lastActive: '2h ago' },
  { id: 'wr-4', name: 'Playoff Scouting Room', type: 'war-room', status: 'active', capacity: 10, currentOccupancy: 7, series: '2819 Church Playoffs', accessLevel: 'staff', createdDate: 'Feb 1, 2026', lastActive: '15m ago' },
  { id: 'wr-5', name: '3SSB Grand Prix Ops', type: 'war-room', status: 'locked', capacity: 8, currentOccupancy: 0, series: '3SSB Grand Prix', accessLevel: 'restricted', createdDate: 'Nov 22, 2025', lastActive: '3d ago' },
  ...
  { id: 'wr-8', name: 'Combine Analysis Room', type: 'war-room', status: 'idle', capacity: 10, currentOccupancy: 0, series: '3SSB Combine', accessLevel: 'staff', createdDate: 'Feb 3, 2026', lastActive: '6h ago' },
  ...
  { id: 'wr-11', name: 'Tournament Bracket Room', type: 'war-room', status: 'active', capacity: 16, currentOccupancy: 11, series: '2819 Church Tournament', accessLevel: 'restricted', createdDate: 'Feb 12, 2026', lastActive: '3m ago' },
...
const BROADCAST_ROOMS: BroadcastRoom[] = [
  { id: 'br-1', name: '3SSB Broadcast Center', type: 'broadcast', status: 'active', capacity: 30, currentOccupancy: 22, series: '3SSB Grand Prix', accessLevel: 'staff', createdDate: 'Nov 10, 2025', lastActive: '1m ago', streamUrl: 'rtmp://stream.kanext.io/k1-main', viewers: 4820, isLive: true, producer: 'Jordan Ellis' },
  { id: 'br-2', name: '2819 Church Main Stream', type: 'broadcast', status: 'active', capacity: 24, currentOccupancy: 18, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '3m ago', streamUrl: 'rtmp://stream.kanext.io/iccla-1', viewers: 3150, isLive: true, producer: 'Lisa Grant' },
  { id: 'br-3', name: 'Secondary Court Feed', type: 'broadcast', status: 'active', capacity: 12, currentOccupancy: 8, series: '2819 Church Division Games', accessLevel: 'staff', createdDate: 'Feb 2, 2026', lastActive: '10m ago', streamUrl: 'rtmp://stream.kanext.io/iccla-2', viewers: 1480, isLive: true, producer: 'Derek Washington' },
  { id: 'br-4', name: 'Post-Game Studio', type: 'broadcast', status: 'idle', capacity: 8, currentOccupancy: 2, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 15, 2026', lastActive: '35m ago', streamUrl: 'rtmp://stream.kanext.io/postgame', viewers: 0, isLive: false, producer: 'Alicia Monroe' },
  ...
  { id: 'br-6', name: 'Draft Night Studio', type: 'broadcast', status: 'idle', capacity: 20, currentOccupancy: 0, series: '3SSB Draft 2026', accessLevel: 'staff', createdDate: 'Dec 20, 2025', lastActive: '8h ago', streamUrl: 'rtmp://stream.kanext.io/draft', viewers: 0, isLive: false, producer: 'Ryan Patel' },
  ...
  { id: 'br-8', name: 'Arena Jumbotron Control', type: 'broadcast', status: 'active', capacity: 8, currentOccupancy: 6, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Feb 5, 2026', lastActive: '2m ago', streamUrl: 'rtmp://stream.kanext.io/jumbotron', viewers: 0, isLive: true, producer: 'Chris Garcia' },
  ...
  { id: 'br-10', name: 'Combine Broadcast Room', type: 'broadcast', status: 'idle', capacity: 10, currentOccupancy: 0, series: '3SSB Combine', accessLevel: 'staff', createdDate: 'Feb 3, 2026', lastActive: '4h ago', streamUrl: 'rtmp://stream.kanext.io/combine', viewers: 0, isLive: false, producer: 'Ryan Patel' },
];
...
const OFFICIAL_ROOMS: OfficialRoom[] = [
  { id: 'or-1', name: 'Match Officials Room A', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 6, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '4m ago', matchId: '2819 Church-2026-047', officials: ['Ref. Williams', 'Ref. Thompson', 'Ref. Martinez', 'Ref. Nkosi'], rulingsPending: 2 },
  { id: 'or-2', name: 'Match Officials Room B', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 5, series: '2819 Church Division Games', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '12m ago', matchId: '2819 Church-2026-048', officials: ['Ref. Garcia', 'Ref. Li', 'Ref. Okafor'], rulingsPending: 1 },
  { id: 'or-3', name: 'Replay Review Center', type: 'officials', status: 'active', capacity: 12, currentOccupancy: 8, series: 'All 2819 Church', accessLevel: 'restricted', createdDate: 'Nov 1, 2025', lastActive: '1m ago', matchId: 'MULTI', officials: ['Lead Reviewer Davis', 'Reviewer Cho', 'Reviewer Patel', 'Reviewer Brown', 'Reviewer Kim'], rulingsPending: 3 },
  { id: 'or-4', name: '3SSB Judges Panel Room', type: 'officials', status: 'active', capacity: 6, currentOccupancy: 5, series: '3SSB Grand Prix', accessLevel: 'restricted', createdDate: 'Nov 15, 2025', lastActive: '6m ago', matchId: 'K1-GP-2026-012', officials: ['Judge Tanaka', 'Judge Morales', 'Judge Fischer'], rulingsPending: 0 },
  { id: 'or-5', name: 'Disciplinary Hearing Room', type: 'officials', status: 'idle', capacity: 10, currentOccupancy: 0, series: '2819 Church Compliance', accessLevel: 'restricted', createdDate: 'Dec 1, 2025', lastActive: '1d ago', matchId: 'DISC-2026-003', officials: ['Commissioner Park', 'VP Integrity Johnson'], rulingsPending: 0 },
  ...
  { id: 'or-8', name: 'Scorekeeper Operations', type: 'officials', status: 'active', capacity: 6, currentOccupancy: 4, series: 'All 2819 Church', accessLevel: 'staff', createdDate: 'Oct 1, 2025', lastActive: '2m ago', matchId: 'MULTI', officials: ['Scorekeeper Hall', 'Scorekeeper Reyes', 'Scorekeeper Kim'], rulingsPending: 0 },
  ...
  { id: 'or-10', name: 'VAR / Tech Review Suite', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 6, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '1m ago', matchId: '2819 Church-2026-047', officials: ['Tech Lead Rivera', 'VAR Operator Shah', 'VAR Operator Burke'], rulingsPending: 2 },
];
...
const MEDIA_ROOMS: MediaRoom[] = [
  { id: 'mr-1', name: 'Press Room — Main Arena', type: 'media', status: 'active', capacity: 60, currentOccupancy: 42, series: '2819 Church Championship', accessLevel: 'public', createdDate: 'Jan 5, 2026', lastActive: '5m ago', pressMembers: 42, deadlineTime: '11:30 PM ET', contentType: 'Post-Match Presser' },
  { id: 'mr-2', name: 'Photo Pool — Courtside', type: 'media', status: 'active', capacity: 20, currentOccupancy: 16, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 5, 2026', lastActive: '1m ago', pressMembers: 16, deadlineTime: '10:00 PM ET', contentType: 'Photography' },
  { id: 'mr-3', name: '3SSB Media Center', type: 'media', status: 'active', capacity: 40, currentOccupancy: 28, series: '3SSB Grand Prix', accessLevel: 'public', createdDate: 'Nov 12, 2025', lastActive: '8m ago', pressMembers: 28, deadlineTime: '12:00 AM ET', contentType: 'Mixed Media' },
  { id: 'mr-4', name: 'Interview Room — A', type: 'media', status: 'active', capacity: 15, currentOccupancy: 8, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '20m ago', pressMembers: 8, deadlineTime: '11:00 PM ET', contentType: 'One-on-One Interview' },
  { id: 'mr-5', name: 'Interview Room — B', type: 'media', status: 'idle', capacity: 15, currentOccupancy: 0, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '1h ago', pressMembers: 0, deadlineTime: '—', contentType: 'One-on-One Interview' },
  ...
  { id: 'mr-8', name: 'Writers Workroom — East', type: 'media', status: 'active', capacity: 30, currentOccupancy: 18, series: '2819 Church Championship', accessLevel: 'public', createdDate: 'Jan 10, 2026', lastActive: '15m ago', pressMembers: 18, deadlineTime: '11:45 PM ET', contentType: 'Written / Editorial' },
  ...
  { id: 'mr-10', name: 'Documentary Crew Room', type: 'media', status: 'active', capacity: 8, currentOccupancy: 5, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Feb 1, 2026', lastActive: '30m ago', pressMembers: 5, deadlineTime: 'Post-Season', contentType: 'Documentary / Film' },
...
const VIP_ROOMS: VIPRoom[] = [
  { id: 'vr-1', name: 'VIP Lounge — Commissioner', type: 'vip', status: 'active', capacity: 20, currentOccupancy: 12, series: '2819 Church Championship', accessLevel: 'vip', createdDate: 'Jan 3, 2026', lastActive: '10m ago', currentGuests: ['Commissioner Park', 'VP Integrity Johnson', 'Board Chair Thompson', 'Owner — MSU-Northern Crest'], seriesAffiliation: '2819 Church Championship' },
  { id: 'vr-2', name: 'VIP Lounge — Sponsors', type: 'vip', status: 'active', capacity: 30, currentOccupancy: 22, series: '2819 Church Championship', accessLevel: 'vip', createdDate: 'Jan 3, 2026', lastActive: '5m ago', currentGuests: ['Nike VP Sports Marketing', 'Gatorade Regional Dir.', 'Apple Sports Lead', 'ESPN Exec Producer'], seriesAffiliation: '2819 Church Championship' },
  { id: 'vr-3', name: 'Owner Suite — Court A', type: 'vip', status: 'active', capacity: 12, currentOccupancy: 8, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '2m ago', currentGuests: ['Alex Morgan', '3SSB Front Office', 'Guest — Mark Cuban'], seriesAffiliation: '2819 Church Championship' },
  { id: 'vr-4', name: 'Player Family Lounge', type: 'vip', status: 'active', capacity: 40, currentOccupancy: 28, series: '2819 Church Championship', accessLevel: 'vip', createdDate: 'Jan 5, 2026', lastActive: '15m ago', currentGuests: ['Player families (28 guests)'], seriesAffiliation: '2819 Church Championship' },
  { id: 'vr-5', name: '3SSB Hospitality Suite', type: 'vip', status: 'active', capacity: 16, currentOccupancy: 10, series: '3SSB Grand Prix', accessLevel: 'vip', createdDate: 'Nov 10, 2025', lastActive: '20m ago', currentGuests: ['3SSB President Takeda', 'Fighter Management Teams', 'Sponsor Delegates'], seriesAffiliation: '3SSB Grand Prix' },
  { id: 'vr-6', name: 'Alumni Legacy Room', type: 'vip', status: 'idle', capacity: 20, currentOccupancy: 3, series: 'All 2819 Church', accessLevel: 'vip', createdDate: 'Dec 1, 2025', lastActive: '1h ago', currentGuests: ['Alumni Association President', 'Hall of Fame Rep.'], seriesAffiliation: 'All 2819 Church Events' },
  ...
  { id: 'vr-8', name: 'Draft Night VIP', type: 'vip', status: 'locked', capacity: 30, currentOccupancy: 0, series: '3SSB Draft 2026', accessLevel: 'vip', createdDate: 'Dec 20, 2025', lastActive: '10d ago', currentGuests: [], seriesAffiliation: '3SSB Draft 2026' },
  ...
  { id: 'vr-10', name: 'Luxury Box — Section 100', type: 'vip', status: 'active', capacity: 16, currentOccupancy: 14, series: '2819 Church Championship', accessLevel: 'vip', createdDate: 'Jan 5, 2026', lastActive: '8m ago', currentGuests: ['Corporate Group A (14)'], seriesAffiliation: '2819 Church Championship' },
];
...
const OPS_ROOMS: OpsRoom[] = [
  ...
  { id: 'opr-2', name: 'Venue Security Hub', type: 'operations', status: 'active', capacity: 10, currentOccupancy: 8, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '3m ago', activeTasks: 8, personnelCount: 8, priority: 'high' },
  ...
  { id: 'opr-4', name: 'Medical / Training Room Ops', type: 'operations', status: 'active', capacity: 8, currentOccupancy: 5, series: '2819 Church Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '5m ago', activeTasks: 4, personnelCount: 5, priority: 'high' },
  ...
  { id: 'opr-7', name: 'Ticketing Operations', type: 'operations', status: 'active', capacity: 6, currentOccupancy: 4, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 3, 2026', lastActive: '15m ago', activeTasks: 3, personnelCount: 4, priority: 'normal' },
  ...
  { id: 'opr-9', name: 'Event Setup / Teardown', type: 'operations', status: 'idle', capacity: 10, currentOccupancy: 0, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Jan 10, 2026', lastActive: '6h ago', activeTasks: 5, personnelCount: 0, priority: 'normal' },
  ...
  { id: 'opr-11', name: 'Volunteer Coordination', type: 'operations', status: 'active', capacity: 8, currentOccupancy: 3, series: '2819 Church Championship', accessLevel: 'staff', createdDate: 'Feb 1, 2026', lastActive: '30m ago', activeTasks: 7, personnelCount: 3, priority: 'normal' },
...
const ARCHIVED_ROOMS: ArchivedRoom[] = [
  ...
  { id: 'ar-2', name: 'Draft Combine Broadcast', type: 'broadcast', status: 'archived', capacity: 12, currentOccupancy: 0, series: '3SSB Combine 2025', accessLevel: 'staff', createdDate: 'Sep 5, 2025', lastActive: '60d ago', totalMessages: 189, totalFiles: 45, archivedDate: 'Oct 20, 2025' },
...
const ANALYTICS_STATS: AnalyticsStatCard[] = [
  { id: 'as-1', label: 'Avg. Daily Active Rooms', value: '14.2', change: '+2.1', changeDirection: 'up', icon: 'rectangle.stack.fill', color: '#1A1714' },
  { id: 'as-2', label: 'Peak Concurrent Users', value: '189', change: '+34', changeDirection: 'up', icon: 'person.3.fill', color: '#5A8A6E' },
  { id: 'as-3', label: 'Avg. Session Duration', value: '2h 14m', change: '+18m', changeDirection: 'up', icon: 'clock.fill', color: '#B8943E' },
  { id: 'as-4', label: 'Total Broadcast Hours', value: '126.5', change: '+12.3', changeDirection: 'up', icon: 'antenna.radiowaves.left.and.right', color: '#B85C5C' },
  ...
  { id: 'as-6', label: 'Files Shared', value: '347', change: '-12', changeDirection: 'down', icon: 'doc.fill', color: '#1A1714' },
  { id: 'as-7', label: 'Avg. Occupancy Rate', value: '68%', change: '+5%', changeDirection: 'up', icon: 'chart.bar.fill', color: '#5A8A6E' },
  { id: 'as-8', label: 'Rooms Archived (30d)', value: '6', change: '-2', changeDirection: 'down', icon: 'archivebox.fill', color: '#9C9790' },
];
...
export function getOccupancyColor(percent: number): string {
  if (percent >= 80) return '#B85C5C';
  if (percent >= 60) return '#B8943E';
  return '#5A8A6E';
}
