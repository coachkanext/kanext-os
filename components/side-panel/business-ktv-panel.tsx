/**
 * Business KTV Side Panel — CEO/Client role-aware.
 * CEO:    Channel · Upload · Analytics · Library + Dipson/Settings/Help
 * Client: Channel · Library + Dipson/Settings/Help
 */
...
export function BusinessKtvPanel() {
  const C = useColors();
  ...
  const navItems = isCEO ? OWNER_NAV : MEMBER_NAV;
