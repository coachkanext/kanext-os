...
const REVENUE_ITEMS: RevenueItem[] = [
  ...
  { id: 'rev-3', source: 'ESPN+ Broadcast Rights — KaNeXT Invitational', category: 'broadcast', amount: 120000, date: 'Feb 5, 2026', series: 'KaNeXT Invitational', status: 'received' },
  ...
  { id: 'rev-6', source: 'Team Entry Fees — KaNeXT Invitational', category: 'entry-fees', amount: 48000, date: 'Dec 20, 2025', series: 'KaNeXT Invitational', status: 'received' },
  ...
  { id: 'rev-16', source: 'KaNeXT Invitational VIP Packages', category: 'ticketing', amount: 52000, date: 'Feb 6, 2026', series: 'KaNeXT Invitational', status: 'received' },
...
const EXPENSE_ITEMS: ExpenseItem[] = [
  ...
  { id: 'exp-3', description: 'Referee & Official Fees — KaNeXT Invitational', category: 'officials', amount: 24000, date: 'Feb 4, 2026', vendor: 'IAABO Officials Bureau', status: 'paid', series: 'KaNeXT Invitational' },
  ...
  { id: 'exp-5', description: 'Team Travel Subsidies — KaNeXT Invitational', category: 'travel', amount: 62000, date: 'Feb 1, 2026', vendor: 'Multiple Teams', status: 'paid', series: 'KaNeXT Invitational' },
  ...
  { id: 'exp-12', description: 'Medical Staff & Athletic Trainers', category: 'staff', amount: 22000, date: 'Feb 3, 2026', vendor: 'Select Medical', status: 'paid', series: 'KaNeXT Invitational' },
  ...
  { id: 'exp-16', description: 'Print & Signage — KaNeXT Invitational', category: 'marketing', amount: 12500, date: 'Jan 28, 2026', vendor: 'FedEx Office', status: 'paid', series: 'KaNeXT Invitational' },
...
const PRIZE_ALLOCATIONS: PrizeAllocation[] = [
  ...
  { id: 'prz-5', series: 'KaNeXT Invitational', position: '1st Place', entrant: 'Duke Blue Devils', amount: 75000, status: 'paid', date: 'Feb 8, 2026' },
  { id: 'prz-6', series: 'KaNeXT Invitational', position: '2nd Place', entrant: 'Kentucky Wildcats', amount: 40000, status: 'paid', date: 'Feb 8, 2026' },
  { id: 'prz-7', series: 'KaNeXT Invitational', position: '3rd Place', entrant: 'Gonzaga Bulldogs', amount: 20000, status: 'paid', date: 'Feb 9, 2026' },
  { id: 'prz-8', series: 'KaNeXT Invitational', position: 'MVP Award', entrant: 'Jaylen Carter', amount: 5000, status: 'paid', date: 'Feb 8, 2026' },
...
const SPONSORSHIP_ITEMS: SponsorshipRevenue[] = [
  ...
  { id: 'spon-5', sponsor: 'Beats by Dre', package: 'Audio Partner', amount: 45000, period: 'KaNeXT Invitational', status: 'active', paymentSchedule: 'One-time' },
...
const TICKETING_RECORDS: TicketingRecord[] = [
  ...
  { id: 'tix-4', event: 'KaNeXT Invitational — Championship', venue: 'Madison Square Garden', ticketsSold: 18200, capacity: 19812, revenue: 164000, avgPrice: 90.11, date: 'Feb 7, 2026' },
  { id: 'tix-5', event: 'KaNeXT Invitational — Semifinal 1', venue: 'Madison Square Garden', ticketsSold: 15400, capacity: 19812, revenue: 108000, avgPrice: 70.13, date: 'Feb 6, 2026' },
  { id: 'tix-6', event: 'KaNeXT Invitational — Semifinal 2', venue: 'Madison Square Garden', ticketsSold: 14900, capacity: 19812, revenue: 104000, avgPrice: 69.80, date: 'Feb 6, 2026' },
  { id: 'tix-7', event: 'KaNeXT Invitational — Quarterfinals', venue: 'Madison Square Garden', ticketsSold: 12000, capacity: 19812, revenue: 72000, avgPrice: 60.00, date: 'Feb 5, 2026' },
...
const BUDGET_ITEMS: Budget[] = [
  ...
  { id: 'bgt-2', name: 'KaNeXT Invitational — Total', series: 'KaNeXT Invitational', allocated: 380000, spent: 298200, remaining: 81800, status: 'on-track', category: 'Event' },
...
const REPORT_ITEMS: FinanceReport[] = [
  ...
  { id: 'rpt-2', name: 'KaNeXT Invitational — P&L Summary', type: 'Profit & Loss', period: 'Feb 2026', format: 'PDF', generatedDate: 'Feb 12, 2026' },
