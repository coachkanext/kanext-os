/**
 * Portfolio Help — tile-level help for the Portfolio tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    rows: [
      { icon: 'briefcase.fill',         title: 'Adding and editing projects',    keywords: 'add edit project portfolio'           },
      { icon: 'newspaper.fill',         title: 'Managing press coverage',        keywords: 'press coverage media feature'          },
      { icon: 'quote.bubble.fill',      title: 'Getting client testimonials',    keywords: 'testimonial client review'             },
      { icon: 'doc.text.fill',          title: 'Archive and articles',           keywords: 'archive article essay newsletter'      },
      { icon: 'checkmark.seal.fill',    title: 'Showcasing credentials',         keywords: 'credentials cert degree issuer'        },
    ],
  },
  {
    header: 'VISIBILITY & SHARING',
    rows: [
      { icon: 'globe',                  title: 'Making your portfolio public',   keywords: 'public share link visibility'          },
      { icon: 'link',                   title: 'Your portfolio URL',             keywords: 'url link slug handle'                  },
      { icon: 'doc.richtext.fill',      title: 'Generating a media kit',         keywords: 'media kit press pdf'                   },
    ],
  },
  {
    header: 'ANALYTICS',
    rows: [
      { icon: 'chart.bar.fill',         title: 'Portfolio views and traffic',    keywords: 'views analytics stats traffic'         },
      { icon: 'arrow.up.right.circle',  title: 'Profile visit trends',          keywords: 'trends visitors clicks'                },
    ],
  },
  {
    header: 'CONTACT',
    rows: [
      { icon: 'envelope.fill',          title: 'Enabling the contact form',      keywords: 'contact form enable disable'           },
      { icon: 'dollarsign.circle',      title: 'Displaying your rate card',      keywords: 'rate card pricing visible'             },
    ],
  },
];
...
export default function PortfolioHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>Portfolio Help</Text>
            </View>
          </View>
      ...
      >
        ...
        <View style={[s.searchWrap, { backgroundColor: C.surface, borderColor: C.separator }]}>
          ...
          <TextInput
            ...
            placeholder="Search portfolio help..."
