...
const CHURCH_REELS: Reel[] = [
  { id: 'creel-1', title: 'Walking in Faith — Sermon Clip', caption: 'This word hit different. Faith Forward series continues.', duration: 58, thumbnailColor: '#1B2044', teamTag: 'KaNeXT Church', tags: ['Sermon', 'Faith'], source: 'Live Stream', likes: 345, saves: 78, createdAt: '2026-02-15' },
  { id: 'creel-2', title: 'Worship Highlights — Feb 15', caption: '"Great Is Thy Faithfulness" — the presence was tangible.', duration: 42, thumbnailColor: '#2D1044', teamTag: 'KaNeXT Church', tags: ['Worship', 'Praise'], source: 'Live Stream', likes: 456, saves: 112, createdAt: '2026-02-15' },
  { id: 'creel-3', title: 'Youth Retreat Moments', caption: '3 days of fellowship and growth. These kids are on fire.', duration: 35, thumbnailColor: '#0A2A1A', teamTag: 'KaNeXT Church Youth', tags: ['Youth', 'Retreat'], source: 'YouTube', likes: 287, saves: 65, createdAt: '2026-02-08' },
  { id: 'creel-4', title: 'Baptism Sunday — 7 New Believers', caption: 'Heaven is rejoicing. Welcome to the family of faith.', duration: 50, thumbnailColor: '#0A1A2A', teamTag: 'KaNeXT Church', tags: ['Baptism', 'Celebration'], source: 'Live Stream', likes: 523, saves: 134, createdAt: '2026-02-01' },
  { id: 'creel-5', title: 'Outreach Saturday Recap', caption: '200+ families served. This is what the church is for.', duration: 28, thumbnailColor: '#1A2A1A', teamTag: 'KaNeXT Church', tags: ['Outreach', 'Community'], source: 'YouTube', likes: 198, saves: 45, createdAt: '2026-02-14' },
  { id: 'creel-6', title: 'Pastor Dipo — "Don\'t Quit"', caption: 'One minute that might change your week. Keep going.', duration: 60, thumbnailColor: '#2A0A1A', teamTag: 'KaNeXT Church', tags: ['Encouragement', 'Sermon'], source: 'Live Stream', likes: 612, saves: 189, createdAt: '2026-01-25' },
  { id: 'creel-7', title: 'Choir Rehearsal BTS', caption: 'Easter prep is underway. Something special is coming.', duration: 22, thumbnailColor: '#2A1A2A', teamTag: 'KaNeXT Church', tags: ['BTS', 'Choir'], source: 'Recording', likes: 145, saves: 32, createdAt: '2026-02-12' },
  { id: 'creel-8', title: 'Prayer Night Atmosphere', caption: 'When the saints pray, things shift. Join us next Thursday.', duration: 30, thumbnailColor: '#1A0A2A', teamTag: 'KaNeXT Church', tags: ['Prayer', 'Worship'], source: 'Live Stream', likes: 234, saves: 56, createdAt: '2026-01-22' },
];
...
const EDUCATION_REELS: Reel[] = [
  { id: 'ereel-1', title: 'Solo Flight Day', caption: 'HBCU aviation excellence. Our cadets took to the sky today.', duration: 45, thumbnailColor: '#1A2A3A', teamTag: 'KaNeXT Aviation', tags: ['Aviation', 'Achievement'], source: 'YouTube', likes: 1240, saves: 312, createdAt: '2026-02-07' },
  { id: 'ereel-2', title: 'Homecoming 2026 — Best Moments', caption: 'What a week. KaNeXT showed out. Every single moment.', duration: 55, thumbnailColor: '#2A2A0A', teamTag: 'KaNeXT', tags: ['Homecoming', 'Culture'], source: 'YouTube', likes: 2340, saves: 567, createdAt: '2026-02-10' },
  { id: 'ereel-3', title: 'Lions Basketball Highlights', caption: '16-8 and counting. KaNeXT Conference contenders.', duration: 38, thumbnailColor: '#1A1A2A', teamTag: 'KaNeXT Athletics', tags: ['Athletics', 'Basketball'], source: 'YouTube', likes: 890, saves: 198, createdAt: '2026-02-13' },
  { id: 'ereel-4', title: 'Dean\'s List Walk', caption: '142 students honored. Academic excellence on display.', duration: 30, thumbnailColor: '#0A1A2A', teamTag: 'KaNeXT', tags: ['Academic', 'Ceremony'], source: 'Recording', likes: 456, saves: 89, createdAt: '2026-02-03' },
  { id: 'ereel-5', title: 'New Science Building Tour', caption: 'State-of-the-art labs. The future is being built here.', duration: 42, thumbnailColor: '#0A2A2A', teamTag: 'KaNeXT Campus', tags: ['Facilities', 'Tour'], source: 'YouTube', likes: 678, saves: 145, createdAt: '2026-01-28' },
  { id: 'ereel-6', title: 'Student Talent Show Highlights', caption: 'The talent on this campus is UNREAL.', duration: 50, thumbnailColor: '#2A1A2A', teamTag: 'KaNeXT', tags: ['Culture', 'Talent'], source: 'YouTube', likes: 1560, saves: 378, createdAt: '2026-01-24' },
  { id: 'ereel-7', title: 'Research Spotlight — AI Lab', caption: 'Student research making real-world impact.', duration: 35, thumbnailColor: '#1A0A2A', teamTag: 'KaNeXT Research', tags: ['Research', 'STEM'], source: 'Recording', likes: 345, saves: 78, createdAt: '2026-02-05' },
  { id: 'ereel-8', title: 'Campus Life — Day in the Life', caption: 'What a day at KaNeXT looks like. Miami Gardens, baby.', duration: 48, thumbnailColor: '#2A0A1A', teamTag: 'KaNeXT', tags: ['Campus', 'Culture'], source: 'YouTube', likes: 980, saves: 234, createdAt: '2026-01-20' },
];
...
const BUSINESS_VIDEO_CLIPS: VideoClip[] = [
  ...
  { id: 'bvc-4', title: 'KaNeXT Customer Testimonial', type: 'highlight', duration: 300, source: 'Recording', tags: ['Customer', 'Testimonial'], thumbnailColor: '#2A0A1A' },
...
const BUSINESS_REELS: Reel[] = [
  ...
  { id: 'breel-6', title: 'Customer Love — KaNeXT Testimonial', caption: '"This changed how we operate as a program." — Coach K', duration: 38, thumbnailColor: '#2A0A1A', teamTag: 'KaNeXT', tags: ['Customer', 'Testimonial'], source: 'Recording', likes: 456, saves: 98, createdAt: '2026-02-12' },
...
const BUSINESS_WATCH_HISTORY: WatchHistoryItem[] = [
  ...
  { id: 'bwh-5', contentId: 'bvc-4', contentType: 'clip', title: 'KaNeXT Testimonial', thumbnailColor: '#2A0A1A', duration: 300, watchedAt: '2026-02-12', progress: 100 },
...
export const TRENDING_BY_MODE: Record<Mode, TrendingItem[]> = {
  ...
  church: [
    ...
    { id: 'ct-3', title: 'Worship Night Highlights', subtitle: 'KaNeXT Church Worship Team', thumbnailColor: '#2D1044', viewCount: 650, badge: 'trending', duration: '6:18' },
  ],
  education: [
    { id: 'et-1', title: 'Solo Flight Day — 6 Cadets Soar', subtitle: 'KaNeXT Aviation Program', thumbnailColor: '#1A2A3A', viewCount: 3400, badge: 'featured', duration: '8:45' },
    { id: 'et-2', title: 'Homecoming 2026 — Best Moments', subtitle: 'Campus Life · KaNeXT', thumbnailColor: '#2A2A0A', viewCount: 5600, badge: 'trending', duration: '4:30' },
  ...
  business: [
    ...
    { id: 'bt-3', title: 'Founder Diary #12 — On Focus', subtitle: 'Alex Morgan', thumbnailColor: '#0A1A3A', viewCount: 950, badge: 'featured', duration: '3:22' },
  ],
  competition: [
