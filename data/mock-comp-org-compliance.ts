 ...
 * ICCLA rules, FMU compliance records, K-1 equipment standards.
 */
...
const rules: CompRule[] = [
  { id: 'r-1', code: 'ICCLA 4.2', title: 'Player Eligibility Age Requirements', category: 'eligibility', description: 'All participants must be between 18 and 35 years of age at the start of competition.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-08-15' },
  { id: 'r-2', code: 'ICCLA 5.1', title: 'Anti-Doping Protocol', category: 'conduct', description: 'Mandatory drug testing for all athletes in sanctioned series events.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2025-01-10' },
  { id: 'r-3', code: 'ICCLA 3.7', title: 'Gameplay Clock Regulations', category: 'gameplay', description: 'Regulation periods shall consist of four 12-minute quarters with a 20-minute halftime.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-06-01' },
  { id: 'r-4', code: 'ICCLA 6.3', title: 'Equipment Certification Standards', category: 'equipment', description: 'All competition equipment must be certified by an ICCLA-approved laboratory.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2025-02-01' },
  { id: 'r-5', code: 'ICCLA 7.1', title: 'Venue Safety Requirements', category: 'venue', description: 'Competition venues must meet minimum capacity, safety, and medical facility standards.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-11-20' },
  { id: 'r-6', code: 'ICCLA 8.2', title: 'Media Credential Policy', category: 'media', description: 'All media personnel must obtain official ICCLA credentials before accessing competition areas.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-09-01' },
  { id: 'r-7', code: 'ICCLA 4.5', title: 'Transfer Eligibility Window', category: 'eligibility', description: 'Athletes transferring between entrants must observe a 90-day cooling-off period.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2025-01-05' },
  { id: 'r-8', code: 'ICCLA 9.1', title: 'Unsportsmanlike Conduct Penalties', category: 'conduct', description: 'Graduated penalty scale for unsportsmanlike conduct: warning, technical foul, ejection, suspension.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-12-15' },
  { id: 'r-9', code: 'ICCLA 3.12', title: 'Instant Replay Review Protocol', category: 'gameplay', description: 'Proposed expansion of reviewable calls to include charge/block decisions.', effectiveDate: '2026-01-01', status: 'proposed', lastAmended: '2025-11-01' },
  { id: 'r-10', code: 'ICCLA 6.8', title: 'Shoe Sole Thickness Limit', category: 'equipment', description: 'Maximum sole thickness of 3.5 cm for competition footwear.', effectiveDate: '2025-01-01', status: 'active', lastAmended: '2025-03-01' },
  { id: 'r-11', code: 'ICCLA 10.3', title: 'Salary Cap Disclosure', category: 'conduct', description: 'All entrants must submit roster compensation reports by the registration deadline.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2024-07-22' },
  { id: 'r-12', code: 'ICCLA 2.4', title: 'Pre-Season Physical Clearance', category: 'eligibility', description: 'Athletes must pass an ICCLA-approved physical examination within 6 months of competition start.', effectiveDate: '2024-01-01', status: 'active', lastAmended: '2025-01-15' },
  { id: 'r-13', code: 'ICCLA 7.6', title: 'Temporary Venue Exemption', category: 'venue', description: 'Temporarily suspended pending review of portable court surface safety data.', effectiveDate: '2024-06-01', status: 'suspended', lastAmended: '2025-09-10' },
  { id: 'r-14', code: 'ICCLA 11.1', title: 'Legacy Broadcast Rights (2019)', category: 'media', description: 'Superseded by ICCLA 8.2 media credential policy.', effectiveDate: '2019-01-01', status: 'archived', lastAmended: '2024-01-01' },
  { id: 'r-15', code: 'ICCLA 5.4', title: 'Therapeutic Use Exemption Process', category: 'conduct', description: 'Proposed streamlined TUE application process with 14-day review timeline.', effectiveDate: '2026-07-01', status: 'proposed', lastAmended: '2025-12-01' },
];

const eligibilityRecords: EligibilityRecord[] = [
  { id: 'e-1', entrant: 'FMU Lions', player: 'Marcus Johnson', status: 'eligible', reason: 'All requirements met — physical, age, transfer window clear', reviewDate: '2025-12-01', series: 'K-1 Championship Series' },
  { id: 'e-2', entrant: 'FMU Lions', player: 'Darius Williams', status: 'eligible', reason: 'Physical cleared 2025-10-15, age verified', reviewDate: '2025-12-01', series: 'K-1 Championship Series' },
  { id: 'e-3', entrant: 'FMU Lions', player: 'Terrence Banks', status: 'under-review', reason: 'Transfer cooling-off period ends 2026-02-28', reviewDate: '2026-02-15', series: 'K-1 Championship Series' },
  { id: 'e-4', entrant: 'Coastal FC', player: 'Jamal Carter', status: 'ineligible', reason: 'Failed pre-season physical — cardiac screening flagged', reviewDate: '2025-11-20', series: 'K-1 Championship Series' },
  { id: 'e-5', entrant: 'Metro United', player: 'Devon Brooks', status: 'eligible', reason: 'All requirements met', reviewDate: '2025-12-05', series: 'K-1 Championship Series' },
  { id: 'e-6', entrant: 'Metro United', player: 'Andre Mitchell', status: 'waived', reason: 'Age requirement waived — special dispensation granted by ICCLA board', reviewDate: '2025-11-10', series: 'K-1 Championship Series' },
  ...
  { id: 'e-9', entrant: 'Capital City SC', player: 'Rashad Lewis', status: 'ineligible', reason: 'Exceeded age limit (36 years)', reviewDate: '2025-11-25', series: 'K-1 Championship Series' },
  { id: 'e-10', entrant: 'FMU Lions', player: 'Tyler Davis', status: 'eligible', reason: 'All requirements met — returning player', reviewDate: '2025-12-01', series: 'K-1 Championship Series' },
  ...
  { id: 'e-12', entrant: 'Harbor SC', player: 'Jason Rivera', status: 'under-review', reason: 'Pending TUE approval for prescribed medication', reviewDate: '2026-01-20', series: 'K-1 Championship Series' },
];

const drugTests: DrugTest[] = [
  { id: 'dt-1', date: '2026-02-10', athlete: 'Marcus Johnson', series: 'K-1 Championship', result: 'negative', testType: 'random', lab: 'ICCLA Certified Lab — Miami' },
  { id: 'dt-2', date: '2026-02-10', athlete: 'Darius Williams', series: 'K-1 Championship', result: 'negative', testType: 'random', lab: 'ICCLA Certified Lab — Miami' },
  { id: 'dt-3', date: '2026-02-08', athlete: 'Jamal Carter', series: 'K-1 Championship', result: 'pending', testType: 'targeted', lab: 'ICCLA Certified Lab — Atlanta' },
  { id: 'dt-4', date: '2026-02-05', athlete: 'Devon Brooks', series: 'K-1 Championship', result: 'negative', testType: 'scheduled', lab: 'ICCLA Certified Lab — Atlanta' },
  { id: 'dt-5', date: '2026-02-01', athlete: 'Andre Mitchell', series: 'K-1 Championship', result: 'negative', testType: 'random', lab: 'ICCLA Certified Lab — Miami' },
  { id: 'dt-6', date: '2026-01-28', athlete: 'Chris Thompson', series: 'K-1 Invitational', result: 'negative', testType: 'scheduled', lab: 'ICCLA Certified Lab — Houston' },
  { id: 'dt-7', date: '2026-01-25', athlete: 'Rashad Lewis', series: 'K-1 Championship', result: 'positive', testType: 'random', lab: 'ICCLA Certified Lab — Miami' },
  { id: 'dt-8', date: '2026-01-20', athlete: 'Tyler Davis', series: 'K-1 Championship', result: 'negative', testType: 'random', lab: 'ICCLA Certified Lab — Atlanta' },
  { id: 'dt-9', date: '2026-01-18', athlete: 'Brandon Hall', series: 'K-1 Invitational', result: 'inconclusive', testType: 'scheduled', lab: 'ICCLA Certified Lab — Houston' },
  { id: 'dt-10', date: '2026-01-15', athlete: 'Jason Rivera', series: 'K-1 Championship', result: 'pending', testType: 'targeted', lab: 'ICCLA Certified Lab — Miami' },
  { id: 'dt-11', date: '2026-01-12', athlete: 'Kyle Foster', series: 'K-1 Invitational', result: 'negative', testType: 'random', lab: 'ICCLA Certified Lab — Houston' },
  { id: 'dt-12', date: '2026-01-10', athlete: 'Terrence Banks', series: 'K-1 Championship', result: 'negative', testType: 'scheduled', lab: 'ICCLA Certified Lab — Atlanta' },
];

const equipmentStandards: EquipmentStandard[] = [
  { id: 'eq-1', name: 'Competition Basketball', category: 'Ball', specification: 'ICCLA-approved size 7, 29.5" circumference, leather composite', maxAllowed: 'N/A', status: 'compliant', lastInspected: '2026-02-01' },
  { id: 'eq-2', name: 'Shoe Sole Thickness', category: 'Footwear', specification: 'Maximum 3.5 cm sole thickness per ICCLA 6.8', maxAllowed: '3.5 cm', status: 'compliant', lastInspected: '2026-01-28' },
  ...
  { id: 'eq-10', name: 'Court Surface Friction', category: 'Venue Equipment', specification: 'Minimum coefficient of friction 0.50 per ICCLA 7.1 venue standards', maxAllowed: 'Min 0.50 CoF', status: 'compliant', lastInspected: '2026-02-03' },
...
const incidents: ComplianceIncident[] = [
  ...
  { id: 'inc-2', date: '2026-02-10', type: 'equipment', severity: 'minor', description: 'FMU Lions — two players detected wearing performance tracking wristbands during warm-ups that were not removed before tip-off.', status: 'resolved', party: 'FMU Lions', penalty: 'Written warning — first offense' },
  ...
  { id: 'inc-5', date: '2026-01-30', type: 'rule-violation', severity: 'minor', description: 'Harbor SC bench exceeded maximum coaching staff limit by one during K-1 Championship Series match.', status: 'resolved', party: 'Harbor SC', penalty: '$2,500 fine' },
  ...
  { id: 'inc-9', date: '2026-01-15', type: 'rule-violation', severity: 'minor', description: 'FMU Lions timeout called after allotment exhausted in Q4 — delay of game.', status: 'resolved', party: 'FMU Lions', penalty: 'Technical foul assessed in-game' },
...
const appeals: Appeal[] = [
  ...
  { id: 'ap-2', date: '2026-02-06', incident: 'Fielding ineligible player', appellant: 'Valley Athletics', grounds: 'Birth certificate verification was received 2 hours before match but not processed by ICCLA office.', status: 'hearing-scheduled', hearingDate: '2026-02-20' },
  ...
  { id: 'ap-8', date: '2026-01-12', incident: 'Delay of game technical', appellant: 'FMU Lions', grounds: 'Scorers table error in timeout count; replay shows timeout was available.', status: 'overturned', hearingDate: '2026-01-19' },
  { id: 'ap-9', date: '2026-02-09', incident: 'Wristband equipment violation', appellant: 'FMU Lions', grounds: 'Players removed devices before tip-off; warm-up period use should not constitute violation.', status: 'hearing-scheduled', hearingDate: '2026-02-22' },
...
const certifications: Certification[] = [
  ...
  { id: 'cert-4', name: 'Competition Venue Safety', holder: 'FMU Athletic Complex', type: 'venue', expiryDate: '2026-08-01', status: 'valid' },
  ...
  { id: 'cert-7', name: 'Ball Certification — ICCLA Approved', holder: 'Spalding K-1 Pro', type: 'equipment', expiryDate: '2027-01-01', status: 'valid' },
  ...
  { id: 'cert-15', name: 'AED Equipment Certification', holder: 'FMU Athletic Complex AED Units (x4)', type: 'medical', expiryDate: '2026-05-15', status: 'valid' },
];
...
const reports: ComplianceReport[] = [
  ...
  { id: 'rpt-3', name: 'Eligibility Roster — K-1 Championship', type: 'Eligibility Report', date: '2026-02-10', format: 'CSV' },
