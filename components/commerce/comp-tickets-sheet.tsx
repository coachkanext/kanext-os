...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 14, textAlign: 'center', paddingVertical: Spacing.xl, letterSpacing: 0.2 },

  raceCard: { borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, padding: Spacing.md },
  raceName: { fontSize: 15, fontWeight: '800', letterSpacing: -0.5 },
  raceMeta: { fontSize: 12, fontWeight: '500', marginTop: 4, letterSpacing: 0.2 },
