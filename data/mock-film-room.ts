...
export const GAME_FILMS: GameFilm[] = [
  // ── Carroll College — Feb 2026 Frontier Conference games ─────────────────────────
  {
    id: 'gf-1',
    title: 'vs MSU-Northern',
  ...
  {
    id: 'gf-4',
    title: 'vs Dakota State University',
    opponent: 'Dakota State University',
    date: '2026-02-04',
    duration: 6300,
    thumbnailColor: '#1A1714',
    category: 'conference',
...
export const PRACTICE_SESSIONS: PracticeSession[] = [
  {
    id: 'ps-1',
    title: 'Pre-Game Shootaround — MSU-Northern',
    date: '2026-02-15',
    duration: 2700,
...
export const BREAKDOWN_CLIPS: BreakdownClip[] = [
  {
    id: 'bc-1',
    title: 'Press Break Execution — MSU-Northern',
    date: '2026-02-16',
    duration: 180,
    thumbnailColor: '#1A1714',
    category: 'offense',
    ...
    gameRef: 'vs MSU-Northern',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-2',
    title: 'Fast Break Buckets — Bellevue',
    date: '2026-02-12',
    duration: 145,
    thumbnailColor: '#B85C5C',
    category: 'offense',
  ...
  {
    id: 'bc-3',
    title: 'Help Side Breakdowns — UM Western',
    date: '2026-02-09',
    duration: 210,
    thumbnailColor: '#1A1714',
    category: 'defense',
    ...
    gameRef: 'vs UM Western',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-4',
    title: 'Pick & Roll Coverage — Dakota State',
    date: '2026-02-05',
    duration: 165,
    thumbnailColor: '#1A1714',
    category: 'offense',
    ...
    gameRef: 'vs Dakota State University',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-5',
    title: 'Zone Attack Sequences — Montana Tech',
    date: '2026-01-29',
    duration: 195,
    thumbnailColor: '#1A1714',
    category: 'offense',
    ...
    gameRef: 'vs Montana Tech',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-6',
    title: 'Turnover Sequences — UM Western',
    date: '2026-02-09',
    duration: 130,
    thumbnailColor: '#0B0F14',
    category: 'transition',
  ...
  {
    id: 'bc-7',
    title: 'End-of-Half Execution — MSU-Northern',
    date: '2026-02-16',
    duration: 90,
    thumbnailColor: '#0B0F14',
    category: 'special',
  ...
  {
    id: 'bc-8',
    title: 'Post Defense Reel — Bellevue',
    date: '2026-02-12',
    duration: 155,
    thumbnailColor: '#0B0F14',
    category: 'defense',
...
export const VIDEO_FEED_POSTS: VideoFeedPost[] = [
  {
    id: 'vfp-1',
    title: 'Fighting Saints Win! Carroll 81, MSU-Northern 73',
    caption: 'Highlights from tonight\'s conference win at Lehman Center. The Fighting Saints forced 22 turnovers and shot 48% from the field. #KXUFighting Saints #SunConference',
    date: '2026-02-15',
    duration: 145,
    thumbnailColor: '#1A1714',
    category: 'highlight',
    author: 'Carroll Athletics',
    viewCount: 1240,
    likeCount: 187,
    data_source: 'demo_seed',
  },
  {
    ...
    caption: 'The Fighting Saints are locked in. Coach Carter running the squad through defensive rotations ahead of the tournament push. #WorkHard #KXUBasketball',
    date: '2026-02-13',
    duration: 92,
    thumbnailColor: '#0B0F14',
    category: 'practice',
    author: 'Carroll Basketball',
    viewCount: 680,
    likeCount: 94,
    data_source: 'demo_seed',
  },
  {
    ...
    caption: 'Carroll MBB team dinner in Helena before the homestretch. These moments matter as much as the game reps. #FightingSaints #CarrollCollege',
    date: '2026-02-10',
    duration: 65,
...
export const TEACHING_SESSIONS: TeachingSession[] = [
  ...
  },
  {
    ...
    facilitator: 'Pastor Philip Anthony Mitchell',
    date: '2025-01-22',
    duration: 2400,
    thumbnailColor: '#5A8A6E',
    category: 'leadership',
...
export function getStatusColor(status: FilmStatus): string {
  switch (status) {
    ...
    case 'in-progress': return '#B8943E';
    case 'watched': return '#5A8A6E';
  }
}
