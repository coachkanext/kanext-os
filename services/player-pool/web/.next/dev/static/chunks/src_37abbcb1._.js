...
function TeamsPage() {
    ...
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TeamsPage.useCallback[fetchData]": ()=>{
            setLoading(true);
            const params = new URLSearchParams();
            if (level) params.set("level", level);
            if (search) params.set("search", search);
            fetch(`/api/teams?${params}`).then({
                "TeamsPage.useCallback[fetchData]": (r)=>r.json()
            }["TeamsPage.useCallback[fetchData]"]).then({
                "TeamsPage.useCallback[fetchData]": (rows)=>{
                    setData(rows);
                    setLoading(false);
                }
            }["TeamsPage.useCallback[fetchData]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamsPage.useEffect": ()=>{
            ...
            return ({
                "TeamsPage.useEffect": ()=>clearTimeout(timeout)
            })["TeamsPage.useEffect"];
        }
    }["TeamsPage.useEffect"], [
        fetchData,
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TeamsPage.useMemo[columns]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["teamCoverageColumns"])()
...
_s(TeamsPage, "Fn+akXlhlCwB8YYgwreePPXGJBw=", false, function() {
    return [
...
//# sourceMappingURL=src_37abbcb1._.js.map