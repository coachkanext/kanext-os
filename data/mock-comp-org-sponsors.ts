...
export function getCompSponsorsData(_scope: string) {
  ...
  const recentActivity = [
    ...
    { id: 'ra-5', text: 'Daktronics scoreboard integration confirmed for FMU Arena', time: '10h ago' },
    ...
    { id: 'ra-9', text: 'Gatorade halftime activation plan finalized for ICCLA League matches', time: '2d ago' },
  ...
  const sponsors: CompSponsor[] = [
    ...
    },
    {
      ...
      contactName: 'Sarah Mitchell', contactEmail: 's.mitchell@nike.com',
  ...
  const activations: Activation[] = [
    ...
    { id: 'act-2', name: 'Nike Court Branding', sponsor: 'Nike', type: 'signage', status: 'active', startDate: 'Jan 2026', endDate: 'Jun 2026', impressions: '850K', series: 'ICCLA Premier League' },
    ...
    { id: 'act-5', name: 'Daktronics Scoreboard Integration', sponsor: 'Daktronics', type: 'digital', status: 'active', startDate: 'Nov 2025', endDate: 'Oct 2026', impressions: '1.2M', series: 'ICCLA Premier League' },
    ...
    { id: 'act-7', name: 'KaNeXT Halftime Show', sponsor: 'KaNeXT', type: 'event', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '340K', series: 'ICCLA Premier League' },
    { id: 'act-8', name: 'Gatorade Player of the Match', sponsor: 'Gatorade', type: 'media', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '290K', series: 'ICCLA Premier League' },
    ...
    { id: 'act-12', name: 'Local Print Co Programs', sponsor: 'Local Print Co', type: 'product', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '45K', series: 'ICCLA Premier League' },
  ...
  const fulfillment: FulfillmentItem[] = [
    ...
    { id: 'ff-2', obligation: 'KaNeXT center-court decal at FMU Arena', sponsor: 'KaNeXT', status: 'completed', dueDate: 'Sep 2025', category: 'Signage', notes: 'Installed before season opener.' },
    { id: 'ff-3', obligation: 'Nike courtside LED panels — ICCLA League', sponsor: 'Nike', status: 'completed', dueDate: 'Jan 2026', category: 'Signage', notes: 'Panels active for all home matches.' },
    { id: 'ff-4', obligation: 'Gatorade product delivery — Q1 2026', sponsor: 'Gatorade', status: 'completed', dueDate: 'Jan 2026', category: 'Product', notes: '500 units delivered to FMU Arena.' },
