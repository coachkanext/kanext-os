...
const SEATS: EduSeat[] = [
  ...
  },
  {
    ...
    assignedName: 'Dr. Marcus Thompson',
...
const PEOPLE: EduPerson[] = [
  {
    ...
    status: 'active',
    accessTier: 'founder',
    institutions: [{ id: 'inst-001', name: 'Frederick Memorial University', shortName: 'FMU' }],
    seats: [SEATS[0]],
  ...
  },
  {
    ...
    email: 'kasante@bcu.edu',
    phone: '(704) 555-0201',
    status: 'active',
    accessTier: 'founder',
    institutions: [{ id: 'inst-002', name: 'Booker-Carver University', shortName: 'BCU' }],
    seats: [],
    domains: ['admissions', 'academics', 'finance'],
    canApprove: true,
    canReleaseFunds: true,
    sensitiveAccess: 'high',
    lastAction: 'Signed partnership MOU with FMU',
