/**
 * Education Hub — Help. President + Student.
 * FAQ sections, search bar, GET HELP actions.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'YOUR UNIVERSITY PROFILE',
    rows: [
      { icon: 'building.columns',          title: 'Setting up your institution profile',     keywords: 'setup institution profile university start'      },
      { icon: 'graduationcap.fill',        title: 'Adding programs and degrees',             keywords: 'programs degrees majors academic offerings'      },
      { icon: 'person.badge.plus',         title: 'Managing leadership and faculty listings', keywords: 'faculty leadership directory staff listings'    },
      { icon: 'square.and.arrow.up',       title: 'Sharing your university page',            keywords: 'share university page link url qr'               },
    ],
  },
  {
    header: 'ACADEMICS',
    rows: [
      { icon: 'book.fill',                 title: 'Managing courses and sections',           keywords: 'courses sections catalog class schedule'         },
      { icon: 'checkmark.seal.fill',       title: 'Submitting and updating grades',          keywords: 'grades submit update faculty gradebook'          },
      { icon: 'doc.text.magnifyingglass',  title: 'Running degree audits',                  keywords: 'degree audit graduation requirements progress'   },
      { icon: 'checkmark.shield.fill',     title: 'WSCUC and IACBE compliance',             keywords: 'wscuc iacbe accreditation compliance standards'  },
    ],
  },
  {
    header: 'ENROLLMENT & ADMISSIONS',
    rows: [
      { icon: 'tray.fill',                 title: 'Processing new applications',             keywords: 'applications admissions process review new'      },
      { icon: 'chart.bar.fill',            title: 'Managing the admissions funnel',          keywords: 'admissions funnel pipeline stages tracking'     },
      { icon: 'megaphone.fill',            title: 'Setting up recruitment campaigns',        keywords: 'recruitment campaigns outreach marketing'        },
      { icon: 'arrow.up.right.circle',     title: 'Yield tracking and follow-up',            keywords: 'yield tracking follow up admitted students'      },
    ],
  },
  {
    header: 'STUDENT SUPPORT',
    rows: [
      { icon: 'creditcard.fill',           title: 'Understanding financial aid',             keywords: 'financial aid fafsa loans grants scholarships'   },
      { icon: 'calendar.badge.plus',       title: 'Registration and schedule builder',       keywords: 'registration schedule builder classes enroll'    },
      { icon: 'exclamationmark.triangle.fill', title: 'At-risk student alerts',             keywords: 'at risk student alerts early warning intervention'},
      { icon: 'person.fill.questionmark',  title: 'Connecting with your advisor',            keywords: 'advisor connect meeting appointment guidance'    },
    ],
  },
];
...
export default function EduHelp() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>University Help</Text>
            </View>
          </View>
