...
const SPORTS_ACTIVITY: ActivityItem[] = [
  {
    ...
    type: 'game_final',
    title: 'Game Final',
    description: 'Lincoln 78 - Harris-Stowe 65',
    timestamp: new Date('2026-02-04T21:30:00'),
    sourceType: 'event',
    sourceId: 'game-harris-stowe',
    route: '/organization/events/game-harris-stowe',
  ...
  },
  {
    ...
    type: 'media_added',
    title: 'New Highlight',
    description: 'Johnson 25-point performance vs Culver-Stockton',
    timestamp: new Date('2026-02-03T10:15:00'),
    sourceType: 'media',
    sourceId: 'media-johnson-25',
    route: '/organization/media/media-johnson-25',
    organizationId: 'lincoln-basketball',
    mode: 'sports',
    visibility: ['head_coach', 'assistant_coach', 'gm', 'student_athlete', 'fan', 'media'],
  },
  {
    ...
    description: 'Central Methodist game moved to Feb 16',
  ...
  },
  {
    ...
    type: 'game_final',
    title: 'Game Final',
    description: 'Lincoln 82 - Culver-Stockton 71',
    timestamp: new Date('2026-02-01T21:00:00'),
    sourceType: 'event',
    sourceId: 'game-culver',
    route: '/organization/events/game-culver',
    organizationId: 'lincoln-basketball',
    mode: 'sports',
    visibility: ['head_coach', 'assistant_coach', 'gm', 'student_athlete', 'fan', 'media'],
  },
  {
    ...
    description: 'Added player stats for Culver-Stockton game',
  ...
  },
  {
    ...
    route: '/organization/media/media-practice-jan30',
    organizationId: 'lincoln-basketball',
    mode: 'sports',
    visibility: ['head_coach', 'assistant_coach', 'gm'],
  },
...
const ENTERPRISE_ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    ...
    route: '/organization/documents/doc-tech-arch',
    organizationId: 'kanext',
    mode: 'enterprise',
    visibility: ['founder', 'investor'],
  },
...
const CHURCH_ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    ...
    route: '/organization/events/event-youth-retreat',
    organizationId: 'icc',
    mode: 'church',
    visibility: ['member', 'staff', 'leadership'],
  },
...
const EDUCATION_ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    ...
    route: '/organization/events/event-add-drop',
    organizationId: 'sdcc',
    mode: 'education',
    visibility: ['faculty', 'student', 'staff'],
  },
  {
    ...
    route: '/organization/members/member-wilson',
    organizationId: 'sdcc',
    mode: 'education',
    visibility: ['faculty', 'student', 'staff'],
  },
