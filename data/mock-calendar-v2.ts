...
export const AGENDA_ITEMS: AgendaItem[] = [
  ...
  // Recruiting visits
  { id: 'ag-21', date: '2026-02-28', dayLabel: 'Sat', time: '10:00 AM', title: 'Campus Visit \u2014 Terrell Washington', type: 'Recruiting', location: 'FMU Campus', attendees: 'Coach Davis, Coach Williams', notes: 'SF portal transfer from Webber. Official visit \u2014 full itinerary: campus tour, practice, dinner with team. Top priority recruit.' },
  { id: 'ag-22', date: '2026-03-07', dayLabel: 'Sat', time: '11:00 AM', title: 'Campus Visit \u2014 Kendrick Brooks', type: 'Recruiting', location: 'FMU Campus', attendees: 'Coach Williams', notes: 'C from Chipola College. Unofficial visit \u2014 tour and film session. Bring academic support staff to meeting.' },
  ...
  // Travel itinerary
  { id: 'ag-24', date: '2026-03-04', dayLabel: 'Wed', time: '12:00 PM', title: 'Bus Departure \u2014 Ave Maria Away', type: 'Travel', location: 'FMU Campus', attendees: 'Travel Roster', notes: 'Away game at Ave Maria University. ~2hr drive to Ave Maria, FL. Pre-game meal at 4:00 PM. Tipoff 7:00 PM.' },
...
export const NEWS_POSTS: NewsPost[] = [
  ...
  { id: 'news-2', title: 'Sun Conference Standings Update', source: 'Conference', timestamp: '4h ago', badge: 'info', summary: 'FMU moves to 2nd in Sun Conference after Webber win.', category: 'Recap' },
  { id: 'news-3', title: 'Keiser Scouting Report Posted', source: 'Film Room', timestamp: '6h ago', badge: 'none', summary: 'Full scout report and film breakdown available in Film Room.', linkedObject: 'Film Room', category: 'Program' },
  { id: 'news-4', title: 'Travel Roster Needs Confirmation', source: 'Operations', timestamp: '1d ago', badge: 'action-required', summary: 'Away game at Keiser on Wed \u2014 travel roster not yet locked.', linkedObject: 'Operations', category: 'Program' },
  { id: 'news-5', title: 'D. Cole Named Sun Conference Player of the Week', source: 'Conference', timestamp: '2d ago', badge: 'info', summary: '22.5 PPG, 7.0 APG in 2 wins last week.', category: 'Recap' },
  ...
  { id: 'news-7', title: 'Recruiting: Marcus Thompson Visit Scheduled', source: 'Recruiting', timestamp: '3d ago', badge: 'none', summary: 'PG, 6-2, Class of 2026 \u2014 official visit Feb 28-Mar 1.', linkedObject: 'Recruiting', category: 'Recruiting' },
  ...
  { id: 'news-9', title: 'Pregame Media Request: Local TV Interview', source: 'Media', timestamp: '5d ago', badge: 'action-required', summary: 'Local ABC affiliate requesting Coach K interview before Keiser game.', category: 'Announcement' },
...
export const NAIA_TOP_25: RankingRow[] = [
  { rank: 1, team: 'Indiana Wesleyan', record: '26-2', kr: 89, isUs: false },
  ...
  { rank: 5, team: 'Southeastern', record: '23-4', kr: 84, isUs: false },
  { rank: 6, team: 'William Carey', record: '22-5', kr: 83, isUs: false },
  { rank: 7, team: "The Master's", record: '22-4', kr: 83, isUs: false },
  { rank: 8, team: 'College of Idaho', record: '21-5', kr: 82, isUs: false },
  { rank: 9, team: 'St. Thomas (FL)', record: '21-6', kr: 81, isUs: false },
  { rank: 10, team: 'Pikeville', record: '22-5', kr: 81, isUs: false },
  { rank: 11, team: 'Wayland Baptist', record: '21-6', kr: 80, isUs: false },
  { rank: 12, team: 'Dordt', record: '21-5', kr: 80, isUs: false },
  { rank: 13, team: 'Keiser', record: '20-7', kr: 79, isUs: false },
  ...
  { rank: 17, team: 'LSU Shreveport', record: '19-8', kr: 77, isUs: false },
  ...
  { rank: 25, team: 'Warner', record: '17-10', kr: 73, isUs: false },
];

/** FMU position in NAIA poll — outside top 25, shown with separator */
export const FMU_NAIA_POSITION: RankingRow = {
  rank: 37, team: 'Florida Memorial', record: '18-8', kr: 74, isUs: true,
};
...
export const KANEXT_NATIONAL_TOP_50: RankingRow[] = [
  { rank: 1, team: 'Indiana Wesleyan', record: '26-2', kr: 89, isUs: false, level: 'NAIA' },
  { rank: 2, team: 'Randolph-Macon', record: '25-1', kr: 88, isUs: false, level: 'D3' },
  { rank: 3, team: 'Northwest Florida St.', record: '27-2', kr: 88, isUs: false, level: 'NJCAA D1' },
  ...
  { rank: 10, team: 'Southeastern', record: '23-4', kr: 84, isUs: false, level: 'NAIA' },
  ...
  { rank: 13, team: "The Master's", record: '22-4', kr: 83, isUs: false, level: 'NAIA' },
  ...
  { rank: 16, team: 'St. Thomas (FL)', record: '21-6', kr: 81, isUs: false, level: 'NAIA' },
  { rank: 17, team: 'Pikeville', record: '22-5', kr: 81, isUs: false, level: 'NAIA' },
...
export const FMU_NATIONAL_POSITION: RankingRow = {
  rank: 42, team: 'Florida Memorial', record: '18-8', kr: 74, isUs: true, level: 'NAIA',
};
