...
export const ORG_PROGRAMS: OrgProgram[] = [
  ...
  { id: 'prog-msoc', sport: 'Soccer', name: "Men's Soccer", shortName: 'MSOC', headCoach: 'Carlos Hernandez', headCoachInitials: 'CH', record: null, rosterCount: 24, staffCount: 4, status: 'offseason', availabilityAlerts: 0, recruitingHotCount: 7, opsBlockers: 0, complianceFlags: 'clear', complianceFlagCount: 0, nextEvent: 'Spring Training', nextEventDate: 'Mar 10', budgetUtilization: 30, avatarColor: '#E67E22', gender: 'M' },
...
export const CROSS_PROGRAM_ALERTS: CrossProgramAlert[] = [
  { id: 'cpa-1', programId: 'prog-base', programName: 'Baseball', type: 'attention', title: 'Baseball: 2 Ops Blockers + Compliance Warning', description: 'Travel bus confirmation overdue for Ave Maria series. Roster eligibility form for 2 transfers pending NAIA clearinghouse.', severity: 'high', icon: 'exclamationmark.triangle.fill', color: '#EF4444' },
  ...
  { id: 'cpa-4', programId: 'prog-mbb', programName: "Men's Basketball", type: 'facility', title: 'Gym Scheduling Conflict: MBB vs WBB', description: 'Both programs requesting Lou Walker Activity Center for Feb 22 practice (2-4 PM). Only 1 court available.', severity: 'medium', icon: 'building.2.fill', color: '#6AA9FF' },
