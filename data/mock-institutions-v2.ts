...
export const INSTITUTIONS: InstitutionFull[] = [
  ...
  },
  {
    ...
    status: 'partner',
    description:
      'Bethune-Cookman University is a private historically Black university founded in 1904 by Dr. Mary McLeod Bethune. BCU offers more than 40 undergraduate and graduate degree programs and is accredited by SACSCOC.',
    admins: [
      {
        id: 'admin-bcu-1',
        name: 'Dr. Lawrence Drake II',
        initials: 'LD',
        title: 'President',
        avatarColor: '#8B0000',
      },
    ...
    accreditation: 'SACSCOC',
    avatarColor: '#8B0000',
    nextKeyDate: { label: 'Partnership review', date: 'Apr 15' },
    hasRooms: true,
    hasFilmRoom: false,
    hasLibrary: true,
    createdAt: '2025-03-10T14:00:00Z',
    lastActivityAt: '2026-02-12T09:45:00Z',
    lastActivityMs: 1739353500000,
  },
  {
    id: 'inst-sfat',
...
export const INSTITUTION_AUDIT: InstitutionAuditEntry[] = [
  ...
  },
  {
    ...
    description: 'Partnership agreement signed with Bethune-Cookman University.',
  },
  {
    id: 'audit-fmu-11',
    institutionId: 'inst-fmu',
