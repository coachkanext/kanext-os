...
export const SCHOOLS_FOR_YOU: SchoolCard[] = [
  { id: 'sfy-1', name: 'Howard University', initials: 'HU', location: 'Washington, DC', type: 'University', badges: ['NAIA', 'Faith-Based'], thumbnailColor: '#1D9BF0' },
  { id: 'sfy-2', name: 'Howard University', initials: 'Howard University', location: 'Santee, CA', type: 'Faith-Based', badges: ['NAIA', 'Christian'], thumbnailColor: '#1D9BF0' },
  { id: 'sfy-3', name: 'Arizona Christian', initials: 'TU', location: 'Washington, DC', type: 'University', badges: ['NAA D-II', 'STEM'], thumbnailColor: '#1D9BF0' },
  ...
  { id: 'sfy-6', name: 'Benedictine Mesa', initials: 'MC', location: 'Washington, DC', type: 'University', badges: ['NAA D-II', 'Liberal Arts'], thumbnailColor: '#F59E0B' },
  { id: 'sfy-7', name: 'Blue Mountain CC', initials: 'EWU', location: 'Jacksonville, FL', type: 'University', badges: ['NAIA', 'Faith-Based'], thumbnailColor: '#22C55E' },
  { id: 'sfy-8', name: 'Bellevue University', initials: 'WU', location: 'Lake Wales, FL', type: 'Faith-Based', badges: ['NAIA', 'Ministry'], thumbnailColor: '#F59E0B' },
];
...
export const TRENDING_NOW: TrendingItem[] = [
  { id: 'tn-1', title: 'Howard Engineering Program Expands', subtitle: 'New research lab opens in the College of Engineering & Architecture', type: 'announcement', thumbnailColor: '#1D9BF0' },
  ...
  { id: 'tn-5', title: 'Howard Nursing Cohort Graduates', subtitle: '95% NCLEX pass rate for the Class of 2026', type: 'spotlight', thumbnailColor: '#1D9BF0' },
...
export const UPCOMING_EVENTS: EducationEvent[] = [
  { id: 'ue-1', title: 'Howard Spring Open House', date: 'Mar 8', location: 'Washington, DC', type: 'open-house', thumbnailColor: '#1D9BF0' },
  { id: 'ue-2', title: 'HBCU College Fair', date: 'Mar 15', location: 'Washington, DC', type: 'fair', thumbnailColor: '#1D9BF0' },
  { id: 'ue-3', title: 'Financial Aid Webinar', date: 'Mar 22', location: 'Virtual', type: 'webinar', thumbnailColor: '#22C55E' },
  { id: 'ue-4', title: 'Campus Visit Day — Arizona Christian', date: 'Apr 5', location: 'Washington, DC', type: 'visit', thumbnailColor: '#1D9BF0' },
  { id: 'ue-5', title: 'NAIA Scholar-Athlete Summit', date: 'Apr 12', location: 'Kansas City, MO', type: 'fair', thumbnailColor: '#F59E0B' },
  { id: 'ue-6', title: 'Howard Admitted Students Day', date: 'Apr 19', location: 'Washington, DC', type: 'open-house', thumbnailColor: '#1D9BF0' },
];
...
export const CAMPUS_LIFE: CampusCard[] = [
  { id: 'cl-1', title: 'Homecoming Weekend Highlights', schoolName: 'Howard University', category: 'Traditions', thumbnailColor: '#1D9BF0' },
  ...
  { id: 'cl-4', title: 'Chapel Services', schoolName: 'Howard University', category: 'Faith', thumbnailColor: '#1D9BF0' },
  { id: 'cl-5', title: 'Athletics Game Day', schoolName: 'Arizona Christian', category: 'Athletics', thumbnailColor: '#1D9BF0' },
  { id: 'cl-6', title: 'Research Opportunities', schoolName: 'Benedictine Mesa', category: 'Academics', thumbnailColor: '#F59E0B' },
];
...
export const ADMISSIONS_SPOTLIGHT: AdmissionsSpotlight[] = [
  { id: 'adm-1', schoolName: 'Howard University', initials: 'HU', location: 'Washington, DC', acceptanceRate: '45%', avgAid: '$18,500', thumbnailColor: '#1D9BF0', ctas: ['Visit', 'Apply', 'Request Info'] },
  { id: 'adm-2', schoolName: 'Howard University', initials: 'Howard University', location: 'Santee, CA', acceptanceRate: '62%', avgAid: '$15,200', thumbnailColor: '#1D9BF0', ctas: ['Visit', 'Apply', 'Request Info'] },
  { id: 'adm-3', schoolName: 'Arizona Christian', initials: 'TU', location: 'Washington, DC', acceptanceRate: '38%', avgAid: '$22,000', thumbnailColor: '#1D9BF0', ctas: ['Visit', 'Apply', 'Request Info'] },
  { id: 'adm-4', schoolName: 'Bellevue University', initials: 'WU', location: 'Lake Wales, FL', acceptanceRate: '55%', avgAid: '$14,800', thumbnailColor: '#F59E0B', ctas: ['Visit', 'Apply', 'Request Info'] },
];
