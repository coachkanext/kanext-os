...
export const PLAYER_SEASONS: PlayerSeason[] = [
  ...
  { playerId: 'pp-06', season: '2025-26', school: 'NW Ridgemont State', level: 'JUCO', gp: 17, mpg: 31.2, ppg: 18.1, rpg: 9.2, apg: 1.5, spg: 0.9, bpg: 1.3, fgPct: 53.8, threePct: 33.0, ftPct: 74.2, kr: 86 },
  { playerId: 'pp-06', season: '2024-25', school: 'NW Ridgemont State', level: 'JUCO', gp: 26, mpg: 30.4, ppg: 16.3, rpg: 8.5, apg: 1.2, spg: 0.8, bpg: 1.1, fgPct: 52.1, threePct: 31.4, ftPct: 72.6, kr: 80 },
  { playerId: 'pp-06', season: '2023-24', school: 'NW Ridgemont State', level: 'JUCO', gp: 29, mpg: 24.8, ppg: 11.7, rpg: 6.9, apg: 0.9, spg: 0.6, bpg: 0.8, fgPct: 49.3, threePct: 28.9, ftPct: 69.1, kr: 73 },
  ...
  { playerId: 'pp-10', season: '2025-26', school: 'Ridgemont Memorial', level: 'NCAA D2', gp: 15, mpg: 34.1, ppg: 17.2, rpg: 3.4, apg: 7.5, spg: 2.1, bpg: 0.2, fgPct: 44.0, threePct: 36.3, ftPct: 81.4, kr: 79 },
  { playerId: 'pp-10', season: '2024-25', school: 'Ridgemont Memorial', level: 'NCAA D2', gp: 24, mpg: 33.0, ppg: 15.4, rpg: 3.1, apg: 6.8, spg: 1.9, bpg: 0.1, fgPct: 42.5, threePct: 34.1, ftPct: 79.8, kr: 73 },
  { playerId: 'pp-10', season: '2023-24', school: 'Ridgemont Memorial', level: 'NCAA D2', gp: 28, mpg: 29.3, ppg: 12.1, rpg: 2.8, apg: 5.4, spg: 1.6, bpg: 0.1, fgPct: 40.9, threePct: 32.7, ftPct: 76.3, kr: 65 },
