...
const ACTIVITY_FEED: RoomActivityItem[] = [
  { id: 'af-1', roomName: '2819 Church War Room', action: 'Strategy session started', actor: 'Alex Morgan', timestampMs: Date.now() - 180000, color: '#22C55E' },
  { id: 'af-2', roomName: '3SSB Broadcast Center', action: 'Stream went live — Match 7', actor: 'Jordan Ellis', timestampMs: Date.now() - 420000, color: '#EF4444' },
  ...
  { id: 'af-7', roomName: '2819 Church War Room', action: 'Document shared — Scouting Report', actor: 'Mike Torres', timestampMs: Date.now() - 5400000, color: '#1D9BF0' },
  { id: 'af-8', roomName: '3SSB Broadcast Center', action: 'Camera 3 audio sync fixed', actor: 'Jordan Ellis', timestampMs: Date.now() - 7200000, color: '#F59E0B' },
