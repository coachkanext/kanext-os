...
export const WORSHIP_HIGHLIGHTS: WorshipHighlight[] = [
  { id: 'wh-1', title: 'Sunday Morning Worship Set', date: 'Feb 16', duration: '18:30', thumbnailColor: '#7A5CFF', type: 'Live Worship' },
  ...
  { id: 'wh-4', title: 'Choir Anniversary Concert', date: 'Feb 2', duration: '45:00', thumbnailColor: '#1B4F8A', type: 'Concert' },
  { id: 'wh-5', title: '"How Great Is Our God"', date: 'Jan 26', duration: '5:50', thumbnailColor: '#EF4444', type: 'Single' },
  { id: 'wh-6', title: 'Acoustic Worship Session', date: 'Jan 19', duration: '22:10', thumbnailColor: '#6AA9FF', type: 'Live Worship' },
];
...
export const MINISTRY_SPOTLIGHTS: MinistrySpotlight[] = [
  { id: 'ms-1', name: 'Men\'s Fellowship', description: 'Weekly gatherings for brotherhood and growth', thumbnailColor: '#1B4F8A', memberCount: 45 },
  { id: 'ms-2', name: 'Women\'s Ministry', description: 'Empowering women through faith and community', thumbnailColor: '#C2185B', memberCount: 62 },
  { id: 'ms-3', name: 'Worship Team', description: 'Leading the congregation in praise', thumbnailColor: '#7A5CFF', memberCount: 18 },
  ...
  { id: 'ms-6', name: 'Media Ministry', description: 'Sharing the gospel through technology', thumbnailColor: '#6AA9FF', memberCount: 12 },
];
...
export const YOUTH_CONTENT: YouthContent[] = [
  ...
  { id: 'yc-2', title: 'Identity in Christ', type: 'Devotional', date: 'Feb 12', duration: '15:30', thumbnailColor: '#7A5CFF' },
  ...
  { id: 'yc-5', title: 'Young Leaders Panel', type: 'Discussion', date: 'Jan 25', duration: '35:10', thumbnailColor: '#6AA9FF' },
];
...
export const COMMUNITY_OUTREACH: CommunityOutreach[] = [
  ...
  { id: 'co-2', title: 'Neighborhood Cleanup Day', date: 'Jan 27', type: 'Event', thumbnailColor: '#6AA9FF' },
