...
const ACTIVITY_FEED: RoomActivityItem[] = [
  { id: 'af-1', roomName: 'ICCLA War Room', action: 'Strategy session started', actor: 'Sammy Kalejaiye', timestampMs: Date.now() - 180000, color: '#22C55E' },
  ...
  { id: 'af-7', roomName: 'ICCLA War Room', action: 'Document shared — Scouting Report', actor: 'Mike Torres', timestampMs: Date.now() - 5400000, color: '#6AA9FF' },
...
const WAR_ROOMS: CompRoom[] = [
  { id: 'wr-1', name: 'ICCLA War Room', type: 'war-room', status: 'active', capacity: 20, currentOccupancy: 14, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '2m ago' },
  ...
  { id: 'wr-3', name: 'Draft Strategy Room', type: 'war-room', status: 'idle', capacity: 12, currentOccupancy: 0, series: 'FMU Draft 2026', accessLevel: 'restricted', createdDate: 'Dec 18, 2025', lastActive: '2h ago' },
  { id: 'wr-4', name: 'Playoff Scouting Room', type: 'war-room', status: 'active', capacity: 10, currentOccupancy: 7, series: 'ICCLA Playoffs', accessLevel: 'staff', createdDate: 'Feb 1, 2026', lastActive: '15m ago' },
  ...
  { id: 'wr-8', name: 'Combine Analysis Room', type: 'war-room', status: 'idle', capacity: 10, currentOccupancy: 0, series: 'FMU Combine', accessLevel: 'staff', createdDate: 'Feb 3, 2026', lastActive: '6h ago' },
  ...
  { id: 'wr-11', name: 'Tournament Bracket Room', type: 'war-room', status: 'active', capacity: 16, currentOccupancy: 11, series: 'ICCLA Tournament', accessLevel: 'restricted', createdDate: 'Feb 12, 2026', lastActive: '3m ago' },
...
const BROADCAST_ROOMS: BroadcastRoom[] = [
  ...
  { id: 'br-2', name: 'ICCLA Main Stream', type: 'broadcast', status: 'active', capacity: 24, currentOccupancy: 18, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '3m ago', streamUrl: 'rtmp://stream.kanext.io/iccla-1', viewers: 3150, isLive: true, producer: 'Sarah Chen' },
  { id: 'br-3', name: 'Secondary Court Feed', type: 'broadcast', status: 'active', capacity: 12, currentOccupancy: 8, series: 'ICCLA Division Games', accessLevel: 'staff', createdDate: 'Feb 2, 2026', lastActive: '10m ago', streamUrl: 'rtmp://stream.kanext.io/iccla-2', viewers: 1480, isLive: true, producer: 'Derek Washington' },
  { id: 'br-4', name: 'Post-Game Studio', type: 'broadcast', status: 'idle', capacity: 8, currentOccupancy: 2, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 15, 2026', lastActive: '35m ago', streamUrl: 'rtmp://stream.kanext.io/postgame', viewers: 0, isLive: false, producer: 'Alicia Monroe' },
  ...
  { id: 'br-6', name: 'Draft Night Studio', type: 'broadcast', status: 'idle', capacity: 20, currentOccupancy: 0, series: 'FMU Draft 2026', accessLevel: 'staff', createdDate: 'Dec 20, 2025', lastActive: '8h ago', streamUrl: 'rtmp://stream.kanext.io/draft', viewers: 0, isLive: false, producer: 'Ryan Patel' },
  ...
  { id: 'br-8', name: 'Arena Jumbotron Control', type: 'broadcast', status: 'active', capacity: 8, currentOccupancy: 6, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Feb 5, 2026', lastActive: '2m ago', streamUrl: 'rtmp://stream.kanext.io/jumbotron', viewers: 0, isLive: true, producer: 'Chris Garcia' },
  ...
  { id: 'br-10', name: 'Combine Broadcast Room', type: 'broadcast', status: 'idle', capacity: 10, currentOccupancy: 0, series: 'FMU Combine', accessLevel: 'staff', createdDate: 'Feb 3, 2026', lastActive: '4h ago', streamUrl: 'rtmp://stream.kanext.io/combine', viewers: 0, isLive: false, producer: 'Ryan Patel' },
];
...
const OFFICIAL_ROOMS: OfficialRoom[] = [
  { id: 'or-1', name: 'Match Officials Room A', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 6, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '4m ago', matchId: 'ICCLA-2026-047', officials: ['Ref. Williams', 'Ref. Thompson', 'Ref. Martinez', 'Ref. Nkosi'], rulingsPending: 2 },
  { id: 'or-2', name: 'Match Officials Room B', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 5, series: 'ICCLA Division Games', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '12m ago', matchId: 'ICCLA-2026-048', officials: ['Ref. Garcia', 'Ref. Li', 'Ref. Okafor'], rulingsPending: 1 },
  { id: 'or-3', name: 'Replay Review Center', type: 'officials', status: 'active', capacity: 12, currentOccupancy: 8, series: 'All ICCLA', accessLevel: 'restricted', createdDate: 'Nov 1, 2025', lastActive: '1m ago', matchId: 'MULTI', officials: ['Lead Reviewer Davis', 'Reviewer Cho', 'Reviewer Patel', 'Reviewer Brown', 'Reviewer Kim'], rulingsPending: 3 },
  ...
  { id: 'or-5', name: 'Disciplinary Hearing Room', type: 'officials', status: 'idle', capacity: 10, currentOccupancy: 0, series: 'ICCLA Compliance', accessLevel: 'restricted', createdDate: 'Dec 1, 2025', lastActive: '1d ago', matchId: 'DISC-2026-003', officials: ['Commissioner Park', 'VP Integrity Johnson'], rulingsPending: 0 },
  ...
  { id: 'or-8', name: 'Scorekeeper Operations', type: 'officials', status: 'active', capacity: 6, currentOccupancy: 4, series: 'All ICCLA', accessLevel: 'staff', createdDate: 'Oct 1, 2025', lastActive: '2m ago', matchId: 'MULTI', officials: ['Scorekeeper Hall', 'Scorekeeper Reyes', 'Scorekeeper Kim'], rulingsPending: 0 },
  ...
  { id: 'or-10', name: 'VAR / Tech Review Suite', type: 'officials', status: 'active', capacity: 8, currentOccupancy: 6, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 10, 2026', lastActive: '1m ago', matchId: 'ICCLA-2026-047', officials: ['Tech Lead Rivera', 'VAR Operator Shah', 'VAR Operator Burke'], rulingsPending: 2 },
];
...
const MEDIA_ROOMS: MediaRoom[] = [
  { id: 'mr-1', name: 'Press Room — Main Arena', type: 'media', status: 'active', capacity: 60, currentOccupancy: 42, series: 'ICCLA Championship', accessLevel: 'public', createdDate: 'Jan 5, 2026', lastActive: '5m ago', pressMembers: 42, deadlineTime: '11:30 PM ET', contentType: 'Post-Match Presser' },
  { id: 'mr-2', name: 'Photo Pool — Courtside', type: 'media', status: 'active', capacity: 20, currentOccupancy: 16, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 5, 2026', lastActive: '1m ago', pressMembers: 16, deadlineTime: '10:00 PM ET', contentType: 'Photography' },
  ...
  { id: 'mr-4', name: 'Interview Room — A', type: 'media', status: 'active', capacity: 15, currentOccupancy: 8, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '20m ago', pressMembers: 8, deadlineTime: '11:00 PM ET', contentType: 'One-on-One Interview' },
  { id: 'mr-5', name: 'Interview Room — B', type: 'media', status: 'idle', capacity: 15, currentOccupancy: 0, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 8, 2026', lastActive: '1h ago', pressMembers: 0, deadlineTime: '—', contentType: 'One-on-One Interview' },
  ...
  { id: 'mr-8', name: 'Writers Workroom — East', type: 'media', status: 'active', capacity: 30, currentOccupancy: 18, series: 'ICCLA Championship', accessLevel: 'public', createdDate: 'Jan 10, 2026', lastActive: '15m ago', pressMembers: 18, deadlineTime: '11:45 PM ET', contentType: 'Written / Editorial' },
  ...
  { id: 'mr-10', name: 'Documentary Crew Room', type: 'media', status: 'active', capacity: 8, currentOccupancy: 5, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Feb 1, 2026', lastActive: '30m ago', pressMembers: 5, deadlineTime: 'Post-Season', contentType: 'Documentary / Film' },
...
const VIP_ROOMS: VIPRoom[] = [
  { id: 'vr-1', name: 'VIP Lounge — Commissioner', type: 'vip', status: 'active', capacity: 20, currentOccupancy: 12, series: 'ICCLA Championship', accessLevel: 'vip', createdDate: 'Jan 3, 2026', lastActive: '10m ago', currentGuests: ['Commissioner Park', 'VP Integrity Johnson', 'Board Chair Thompson', 'Owner — Lincoln Crest'], seriesAffiliation: 'ICCLA Championship' },
  { id: 'vr-2', name: 'VIP Lounge — Sponsors', type: 'vip', status: 'active', capacity: 30, currentOccupancy: 22, series: 'ICCLA Championship', accessLevel: 'vip', createdDate: 'Jan 3, 2026', lastActive: '5m ago', currentGuests: ['Nike VP Sports Marketing', 'Gatorade Regional Dir.', 'Apple Sports Lead', 'ESPN Exec Producer'], seriesAffiliation: 'ICCLA Championship' },
  { id: 'vr-3', name: 'Owner Suite — Court A', type: 'vip', status: 'active', capacity: 12, currentOccupancy: 8, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '2m ago', currentGuests: ['Sammy Kalejaiye', 'FMU Front Office', 'Guest — Mark Cuban'], seriesAffiliation: 'ICCLA Championship' },
  { id: 'vr-4', name: 'Player Family Lounge', type: 'vip', status: 'active', capacity: 40, currentOccupancy: 28, series: 'ICCLA Championship', accessLevel: 'vip', createdDate: 'Jan 5, 2026', lastActive: '15m ago', currentGuests: ['Player families (28 guests)'], seriesAffiliation: 'ICCLA Championship' },
  ...
  { id: 'vr-6', name: 'Alumni Legacy Room', type: 'vip', status: 'idle', capacity: 20, currentOccupancy: 3, series: 'All ICCLA', accessLevel: 'vip', createdDate: 'Dec 1, 2025', lastActive: '1h ago', currentGuests: ['Alumni Association President', 'Hall of Fame Rep.'], seriesAffiliation: 'All ICCLA Events' },
  ...
  { id: 'vr-8', name: 'Draft Night VIP', type: 'vip', status: 'locked', capacity: 30, currentOccupancy: 0, series: 'FMU Draft 2026', accessLevel: 'vip', createdDate: 'Dec 20, 2025', lastActive: '10d ago', currentGuests: [], seriesAffiliation: 'FMU Draft 2026' },
  ...
  { id: 'vr-10', name: 'Luxury Box — Section 100', type: 'vip', status: 'active', capacity: 16, currentOccupancy: 14, series: 'ICCLA Championship', accessLevel: 'vip', createdDate: 'Jan 5, 2026', lastActive: '8m ago', currentGuests: ['Corporate Group A (14)'], seriesAffiliation: 'ICCLA Championship' },
];
...
const OPS_ROOMS: OpsRoom[] = [
  ...
  { id: 'opr-2', name: 'Venue Security Hub', type: 'operations', status: 'active', capacity: 10, currentOccupancy: 8, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '3m ago', activeTasks: 8, personnelCount: 8, priority: 'high' },
  ...
  { id: 'opr-4', name: 'Medical / Training Room Ops', type: 'operations', status: 'active', capacity: 8, currentOccupancy: 5, series: 'ICCLA Championship', accessLevel: 'restricted', createdDate: 'Jan 5, 2026', lastActive: '5m ago', activeTasks: 4, personnelCount: 5, priority: 'high' },
  ...
  { id: 'opr-7', name: 'Ticketing Operations', type: 'operations', status: 'active', capacity: 6, currentOccupancy: 4, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 3, 2026', lastActive: '15m ago', activeTasks: 3, personnelCount: 4, priority: 'normal' },
  ...
  { id: 'opr-9', name: 'Event Setup / Teardown', type: 'operations', status: 'idle', capacity: 10, currentOccupancy: 0, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Jan 10, 2026', lastActive: '6h ago', activeTasks: 5, personnelCount: 0, priority: 'normal' },
  ...
  { id: 'opr-11', name: 'Volunteer Coordination', type: 'operations', status: 'active', capacity: 8, currentOccupancy: 3, series: 'ICCLA Championship', accessLevel: 'staff', createdDate: 'Feb 1, 2026', lastActive: '30m ago', activeTasks: 7, personnelCount: 3, priority: 'normal' },
...
const ARCHIVED_ROOMS: ArchivedRoom[] = [
  ...
  { id: 'ar-2', name: 'Draft Combine Broadcast', type: 'broadcast', status: 'archived', capacity: 12, currentOccupancy: 0, series: 'FMU Combine 2025', accessLevel: 'staff', createdDate: 'Sep 5, 2025', lastActive: '60d ago', totalMessages: 189, totalFiles: 45, archivedDate: 'Oct 20, 2025' },
...
const ROOM_MESSAGES: RoomMessage[] = [
  { id: 'rm-1', roomId: 'wr-1', sender: 'Sammy Kalejaiye', text: 'Updated defensive scheme for second half adjustments. Review the clip reel.', timestamp: Date.now() - 120000, pinned: true },
  ...
  { id: 'rm-5', roomId: 'br-1', sender: 'Sarah Chen', text: 'Graphics package loaded for halftime. Sponsor overlays confirmed.', timestamp: Date.now() - 420000, pinned: false },
...
const ROOM_FILES: RoomFile[] = [
  ...
  { id: 'rf-3', roomId: 'br-1', name: 'Graphics Package — Finals.zip', type: 'document', size: '45.2 MB', uploadedBy: 'Sarah Chen', uploadedDate: 'Feb 12, 2026' },
