...
export const ROOM_ACCESS: RoomAccessEntry[] = [
  ...
  // 2. Fellowship Hall
  {
    roomId: 'pr-002',
    roomName: 'Fellowship Hall',
    canBook: ['Sarah Johnson', 'Deacon Robert Lee', 'Marcus Thompson'],
  ...
  // 4. Youth Room
  {
    roomId: 'pr-004',
    roomName: 'Youth Room',
    canBook: ['Marcus Thompson', 'Sarah Johnson'],
    canApprove: ['Pastor David Okoro', 'Marcus Thompson'],
    canUnlock: ['Marcus Thompson', 'Michael Williams'],
    keyCount: 3,
  },
  // 5. Classroom A
  {
  ...
  // 9. Parking Lot
  {
    roomId: 'pr-009',
    roomName: 'Parking Lot',
    canBook: ['Michael Williams', 'Sarah Johnson', 'Marcus Thompson'],
