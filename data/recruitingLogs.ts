...
export const RECRUITING_LOGS: RecruitingLog[] = [
  { id: 'rl-01', boardEntryId: 'be-01', playerId: 'pp-02', playerName: 'Marcus Thompson', actionType: 'Visit', date: '2026-01-15', outcome: 'Very positive — loved the campus and coaching staff', notes: 'Toured facilities, met with academic advisor. Family came along. Asked about housing.', nextAction: 'Follow-up call with family', nextActionDue: '2026-02-15', owner: 'Coach Davis' },
  { id: 'rl-02', boardEntryId: 'be-01', playerId: 'pp-02', playerName: 'Marcus Thompson', actionType: 'Call', date: '2026-01-08', outcome: 'Expressed strong interest', notes: 'Discussed program vision and his role. Wants to visit.', nextAction: 'Schedule campus visit', nextActionDue: '2026-01-12', owner: 'Coach Davis' },
  { id: 'rl-03', boardEntryId: 'be-01', playerId: 'pp-02', playerName: 'Marcus Thompson', actionType: 'Watched Film', date: '2025-12-20', outcome: '3 game films reviewed', notes: 'Elite mid-range scorer. Good in PnR. Defense needs work but coachable.', nextAction: 'Initial outreach call', nextActionDue: '2026-01-05', owner: 'Coach Davis' },
