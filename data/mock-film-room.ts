...
export const GAME_FILMS: GameFilm[] = [
  ...
  {
    id: 'gf-4',
    title: 'vs Pinecrest University',
    opponent: 'Pinecrest University',
    date: '2026-02-04',
    duration: 6300,
    thumbnailColor: '#1D9BF0',
    category: 'conference',
...
export const PRACTICE_SESSIONS: PracticeSession[] = [
  {
    id: 'ps-1',
    title: 'Pre-Game Shootaround — Ridgemont',
    date: '2026-02-15',
    duration: 2700,
...
export const BREAKDOWN_CLIPS: BreakdownClip[] = [
  {
    id: 'bc-1',
    title: 'Press Break Execution — Ridgemont',
    date: '2026-02-16',
    duration: 180,
    thumbnailColor: '#1D9BF0',
    category: 'offense',
    ...
    gameRef: 'vs Ridgemont',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-2',
    title: 'Fast Break Buckets — Clearwater',
    date: '2026-02-12',
    duration: 145,
    thumbnailColor: '#EF4444',
    category: 'offense',
    ...
    gameRef: 'vs Clearwater',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-3',
    title: 'Help Side Breakdowns — Bayshore',
    date: '2026-02-09',
    duration: 210,
    thumbnailColor: '#1D9BF0',
    category: 'defense',
  ...
  {
    id: 'bc-4',
    title: 'Pick & Roll Coverage — Pinecrest',
    date: '2026-02-05',
    duration: 165,
    thumbnailColor: '#1D9BF0',
    category: 'offense',
    ...
    gameRef: 'vs Pinecrest University',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-5',
    title: 'Zone Attack Sequences — Westfield',
    date: '2026-01-29',
    duration: 195,
    thumbnailColor: '#1D9BF0',
    category: 'offense',
    ...
    gameRef: 'vs Westfield',
    data_source: 'demo_seed',
  },
  {
    id: 'bc-6',
    title: 'Turnover Sequences — Bayshore',
    date: '2026-02-09',
    duration: 130,
    thumbnailColor: '#0B0F14',
    category: 'transition',
  ...
  {
    id: 'bc-7',
    title: 'End-of-Half Execution — Ridgemont',
    date: '2026-02-16',
    duration: 90,
    thumbnailColor: '#0B0F14',
    category: 'special',
  ...
  {
    id: 'bc-8',
    title: 'Post Defense Reel — Clearwater',
    date: '2026-02-12',
    duration: 155,
    thumbnailColor: '#0B0F14',
    category: 'defense',
...
export const VIDEO_FEED_POSTS: VideoFeedPost[] = [
  {
    id: 'vfp-1',
    title: 'Wolves Win! KaNeXT 81, Ridgemont 73',
    caption: 'Highlights from tonight\'s conference win at Lehman Center. The Wolves forced 22 turnovers and shot 48% from the field. #KXUWolves #SunConference',
    date: '2026-02-15',
    duration: 145,
    thumbnailColor: '#1D9BF0',
    category: 'highlight',
  ...
  },
  {
    ...
    caption: 'The Wolves are locked in. Coach Carter running the squad through defensive rotations ahead of the tournament push. #WorkHard #KXUBasketball',
    date: '2026-02-13',
    duration: 92,
    thumbnailColor: '#0B0F14',
    category: 'practice',
  ...
  },
  {
    ...
    caption: 'KaNeXT MBB team dinner in Nashville before the homestretch. These moments matter as much as the game reps. #KXUFamily #WolfPack',
    date: '2026-02-10',
    duration: 65,
...
export const STORY_ITEMS: StoryItem[] = [
  ...
  {
    id: 'story-2',
    title: 'Road Trip — Clearwater Game',
    date: '2026-02-11',
    duration: 25,
    thumbnailColor: '#EF4444',
    category: 'game-day',
...
export const TEACHING_SESSIONS: TeachingSession[] = [
  ...
  },
  {
    ...
    facilitator: 'Pastor James Carter',
    date: '2025-01-22',
    duration: 2400,
    thumbnailColor: '#22C55E',
    category: 'leadership',
