...
export const CHURCH_MEMBERS: ChurchMember[] = [
  // --- Leaders ---
  {
    ...
    status: 'active',
    phone: '(310) 555-0201',
    email: 'tolu.adeyemi@iccla.org',
    ministries: ['min-children-iccla'],
  ...
  },
  {
    ...
    status: 'active',
    phone: '(310) 555-0202',
    email: 'kevin.osei@iccla.org',
    ministries: ['min-youth-iccla'],
    safetyClearance: 'cleared',
    lastAttendance: '2026-02-16',
    followUpCount: 0,
    baptized: true,
  ...
  },
  {
    ...
    ministries: ['min-children-iccla', 'min-youth-iccla'],
    safetyClearance: 'cleared',
