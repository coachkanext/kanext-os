...
const ACTIVITY_FEED: RoomActivityItem[] = [
  ...
  { id: 'af-2', roomName: 'KaNeXT Broadcast Center', action: 'Stream went live — Match 7', actor: 'Jordan Ellis', timestampMs: Date.now() - 420000, color: '#EF4444' },
  ...
  { id: 'af-8', roomName: 'KaNeXT Broadcast Center', action: 'Camera 3 audio sync fixed', actor: 'Jordan Ellis', timestampMs: Date.now() - 7200000, color: '#F59E0B' },
...
const WAR_ROOMS: CompRoom[] = [
  ...
  { id: 'wr-5', name: 'KaNeXT Grand Prix Ops', type: 'war-room', status: 'locked', capacity: 8, currentOccupancy: 0, series: 'KaNeXT Grand Prix', accessLevel: 'restricted', createdDate: 'Nov 22, 2025', lastActive: '3d ago' },
...
const BROADCAST_ROOMS: BroadcastRoom[] = [
  { id: 'br-1', name: 'KaNeXT Broadcast Center', type: 'broadcast', status: 'active', capacity: 30, currentOccupancy: 22, series: 'KaNeXT Grand Prix', accessLevel: 'staff', createdDate: 'Nov 10, 2025', lastActive: '1m ago', streamUrl: 'rtmp://stream.kanext.io/k1-main', viewers: 4820, isLive: true, producer: 'Jordan Ellis' },
...
const OFFICIAL_ROOMS: OfficialRoom[] = [
  ...
  { id: 'or-4', name: 'KaNeXT Judges Panel Room', type: 'officials', status: 'active', capacity: 6, currentOccupancy: 5, series: 'KaNeXT Grand Prix', accessLevel: 'restricted', createdDate: 'Nov 15, 2025', lastActive: '6m ago', matchId: 'K1-GP-2026-012', officials: ['Judge Tanaka', 'Judge Morales', 'Judge Fischer'], rulingsPending: 0 },
...
const MEDIA_ROOMS: MediaRoom[] = [
  ...
  { id: 'mr-3', name: 'KaNeXT Media Center', type: 'media', status: 'active', capacity: 40, currentOccupancy: 28, series: 'KaNeXT Grand Prix', accessLevel: 'public', createdDate: 'Nov 12, 2025', lastActive: '8m ago', pressMembers: 28, deadlineTime: '12:00 AM ET', contentType: 'Mixed Media' },
...
const VIP_ROOMS: VIPRoom[] = [
  ...
  { id: 'vr-5', name: 'KaNeXT Hospitality Suite', type: 'vip', status: 'active', capacity: 16, currentOccupancy: 10, series: 'KaNeXT Grand Prix', accessLevel: 'vip', createdDate: 'Nov 10, 2025', lastActive: '20m ago', currentGuests: ['KaNeXT President Takeda', 'Fighter Management Teams', 'Sponsor Delegates'], seriesAffiliation: 'KaNeXT Grand Prix' },
