...
export const FMU_LINEUPS: LineupPreset[] = [
  {
    ...
    players: [
      ...
      { jersey: '13', name: 'Noel', position: 'SG', minutes: 30 },
      { jersey: '11', name: 'Mentor', position: 'SF', minutes: 28 },
      { jersey: '41', name: 'Brewer', position: 'PF', minutes: 26 },
      { jersey: '5', name: 'Selden', position: 'C', minutes: 28 },
    ],
    netRating: 8.4,
    minutesTogether: 412,
  },
  {
    ...
    players: [
      ...
      { jersey: '55', name: 'Munir-Jones', position: 'SG', minutes: 18 },
      { jersey: '0', name: 'Thomas', position: 'SF', minutes: 20 },
      { jersey: '7', name: 'Moratinos', position: 'PF', minutes: 14 },
      { jersey: '1', name: 'Asceric', position: 'C', minutes: 12 },
    ],
    netRating: -2.1,
    minutesTogether: 186,
  },
  {
    ...
    players: [
      ...
      { jersey: '13', name: 'Noel', position: 'SG', minutes: 8 },
      { jersey: '11', name: 'Mentor', position: 'SF', minutes: 8 },
      { jersey: '41', name: 'Brewer', position: 'PF', minutes: 8 },
      { jersey: '5', name: 'Selden', position: 'C', minutes: 8 },
    ],
    netRating: 12.6,
    minutesTogether: 88,
  },
  {
    ...
    players: [
      ...
      { jersey: '11', name: 'Mentor', position: 'SG', minutes: 6 },
      { jersey: '13', name: 'Noel', position: 'SF', minutes: 6 },
      { jersey: '55', name: 'Munir-Jones', position: 'PF', minutes: 6 },
      { jersey: '41', name: 'Brewer', position: 'C', minutes: 6 },
    ],
    netRating: 5.2,
    minutesTogether: 64,
  },
