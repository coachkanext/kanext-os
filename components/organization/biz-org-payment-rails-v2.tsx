          ...
          <View style={s.cardRow}>
            <View style={{ flex: 1 }}>
              ...
              <View style={s.chipRow}>
                ...
                />
                <StatusBadge label={item.entityName} color={ACCENT} />
              </View>
            </View>
            <View style={s.cardRight}>
              <ThemedText style={[s.cardAmount, { color: colors.text }]}>
      ...
      <BizCard>
        <View style={s.cardRow}>
          <View style={{ flex: 1 }}>
            <ThemedText style={[s.cardName, { color: BP.smoke }]}>{item.batchName}</ThemedText>
            <View style={s.chipRow}>
              <StatusBadge label="Authorized" color={ACCENT} />
              <StatusBadge label={item.entityName} color={ACCENT} />
            </View>
          </View>
          <View style={s.cardRight}>
        ...
        <View style={s.actionRow}>
          ...
          >
            ...
            <ThemedText style={[s.actionButtonText, { color: ACCENT }]}>
              Release
            </ThemedText>
          </Pressable>
        </View>
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={
        <BizCard style={{ marginBottom: Spacing.md }}>
          <View style={s.cardRow}>
            <IconSymbol name="arrow.up.circle.fill" size={24} color={ACCENT} />
            <View style={{ flex: 1, marginLeft: Spacing.sm }}>
              <ThemedText style={[s.totalLabel, { color: BP.ash }]}>
                Release Queue
              </ThemedText>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={s.chipRow}>
                <StatusBadge
                  ...
                  color={RECEIPT_TYPE_COLORS[item.type]}
                />
                <StatusBadge label={entityName} color={ACCENT} />
              </View>
            </View>
          </View>
