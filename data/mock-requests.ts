...
function getRequestTypeColor(type: RequestType): string {
  switch (type) {
    case 'recruit_inbound': return '#5A8A6E';
    case 'parent_inbound': return '#1A1714';
    case 'unknown_contact': return '#9C9790';
    case 'scout_inquiry': return '#B8943E';
  }
}
...
export const MOCK_PENDING_REQUESTS: RequestItem[] = [
  ...
  },
  {
    ...
    name: 'Amir Jackson',
    initials: 'AJ',
    context: '2027 SG · Helena, MT',
    message: 'Coach Davis, my AAU coach said to reach out. I\'m interested in Carroll College.',
    timestamp: ago(2880),
    status: 'pending',
  },
];
