/**
 * Sports KPay Side Panel.
 * Head Coach: Program Finances · Pay · Invest · Card + Dipson/Settings/Help
 * Player:     Wallet           · Pay · Invest · Card + Dipson/Settings/Help
 */
...
const ADMIN_NAV: NavItem[] = [
  { icon: 'trophy.fill',               label: 'Program Finances', route: '/(tabs)/(main)/kaypay/program-finances' },
...
export function SportsKPayPanel() {
  const C = useColors();
