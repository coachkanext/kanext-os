...
export const SPORTS_EXPLORE_SHELVES: ExploreShelf[] = [
  ...
  // C) Player Hub
  {
    ...
    items: [
      ...
      { id: 'ph-6', title: 'Isaiah Brooks: Post Moves', subtitle: 'Low Post Repertoire', thumbnailColor: '#0B0F14', duration: '4:12', date: 'Jan 30', viewCount: 340, source: 'Player Channel' },
    ],
  },
