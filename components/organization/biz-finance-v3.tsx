...
const EXPENSES = [
  ...
  { id: 'ex3', label: 'Legal', amount: 3_000, color: '#8B5CF6' },
  { id: 'ex4', label: 'Infrastructure', amount: 2_500, color: '#3B82F6' },
  { id: 'ex5', label: 'Marketing', amount: 1_500, color: '#EC4899' },
  { id: 'ex6', label: 'Travel', amount: 1_000, color: '#14B8A6' },
];
...
const INVESTOR_PIPELINE = [
  ...
  { id: 'ip2', name: 'Horizon Capital', stage: 'Term Sheet', amount: '$200K', color: '#3B82F6' },
  { id: 'ip3', name: 'Meridian Partners', stage: 'Meeting', amount: '$150K', color: '#F59E0B' },
  { id: 'ip4', name: 'Atlas Fund', stage: 'Intro', amount: '$100K', color: '#6B7280' },
];
