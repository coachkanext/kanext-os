...
"[project]/src/app/api/players/[id]/similar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const { rows: meta } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query(`SELECT kr.position, t.id AS team_id
     FROM players p
  ...
  `;
    const [byPositionRes, byTeamRes] = await Promise.all([
        position ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query(`${similarQuery} AND kr.position = $2
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query(`${similarQuery} AND t.id = $2
       ORDER BY kr.npd_final_kr DESC LIMIT 3`, [
            id,
            team_id
        ])
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b142d53._.js.map