...
export function getCompSponsorsData(_scope: string) {
  ...
  const dashboard: SponsorsDashboardBlock[] = [
    { id: 'ds-1', label: 'Total Sponsors', value: '5', delta: '+1 this quarter', icon: 'building.2.fill', color: '#1A1714' },
    { id: 'ds-2', label: 'Annual Revenue', value: '$720K', delta: '+$95K vs last year', icon: 'dollarsign.circle.fill', color: '#5A8A6E' },
    { id: 'ds-3', label: 'Active Activations', value: '18', delta: '6 launching this month', icon: 'bolt.fill', color: '#B8943E' },
    { id: 'ds-4', label: 'Fulfillment Rate', value: '87%', delta: '+4% from last quarter', icon: 'checkmark.seal.fill', color: '#1A1714' },
    { id: 'ds-5', label: 'Pipeline Value', value: '$340K', delta: '3 proposals pending', icon: 'binoculars.fill', color: '#B85C5C' },
    { id: 'ds-6', label: 'Assets Delivered', value: '42', delta: '8 pending approval', icon: 'photo.stack.fill', color: '#1A1714' },
  ];

  const quickActions = [
    { id: 'qa-1', label: 'Add Sponsor', icon: 'plus.circle.fill', color: '#1A1714' },
    { id: 'qa-2', label: 'New Package', icon: 'shippingbox.fill', color: '#5A8A6E' },
    { id: 'qa-3', label: 'Create Activation', icon: 'bolt.fill', color: '#B8943E' },
    { id: 'qa-4', label: 'Revenue Report', icon: 'chart.bar.fill', color: '#1A1714' },
    { id: 'qa-5', label: 'Send Invoice', icon: 'paperplane.fill', color: '#B85C5C' },
    { id: 'qa-6', label: 'Upload Asset', icon: 'arrow.up.doc.fill', color: '#1A1714' },
  ];

  const recentActivity = [
    { id: 'ra-1', text: 'Nike activation "Court Branding" went live for 3SSB Invitational Round of 16', time: '1h ago' },
    { id: 'ra-2', text: '3SSB title sponsorship fulfillment report submitted — 92% complete', time: '3h ago' },
    ...
    { id: 'ra-5', text: 'Daktronics scoreboard integration confirmed for 3SSB Arena', time: '10h ago' },
    ...
    { id: 'ra-8', text: '3SSB naming rights banner assets approved for Spring Showcase', time: '1d ago' },
    { id: 'ra-9', text: 'Gatorade halftime activation plan finalized for 2819 Church League matches', time: '2d ago' },
    ...
    { id: 'ra-14', text: '3SSB mid-season fulfillment audit scheduled for March 1', time: '5d ago' },
  ...
  const sponsors: CompSponsor[] = [
    {
      id: 'sp-1', name: 'Adidas', tier: 'title', status: 'active',
      annualValue: 250000, annualValueFormatted: '$250,000',
      contactName: 'David Chen', contactEmail: 'david.chen@valuetainment.com',
  ...
  const activations: Activation[] = [
    { id: 'act-1', name: 'Adidas Title Branding', sponsor: 'Adidas', type: 'naming-rights', status: 'active', startDate: 'Jul 2025', endDate: 'Jun 2026', impressions: '2.4M', series: 'All Series' },
    { id: 'act-2', name: 'Nike Court Branding', sponsor: 'Nike', type: 'signage', status: 'active', startDate: 'Jan 2026', endDate: 'Jun 2026', impressions: '850K', series: '2819 Church Premier League' },
    ...
    { id: 'act-5', name: 'Daktronics Scoreboard Integration', sponsor: 'Daktronics', type: 'digital', status: 'active', startDate: 'Nov 2025', endDate: 'Oct 2026', impressions: '1.2M', series: '2819 Church Premier League' },
    { id: 'act-6', name: 'Nike Social Media Campaign', sponsor: 'Nike', type: 'media', status: 'active', startDate: 'Jan 2026', endDate: 'May 2026', impressions: '580K', series: '3SSB Invitational' },
    { id: 'act-7', name: 'Adidas Halftime Show', sponsor: 'Adidas', type: 'event', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '340K', series: '2819 Church Premier League' },
    { id: 'act-8', name: 'Gatorade Player of the Match', sponsor: 'Gatorade', type: 'media', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '290K', series: '2819 Church Premier League' },
    ...
    { id: 'act-10', name: 'Adidas Jersey Patch', sponsor: 'Adidas', type: 'signage', status: 'active', startDate: 'Jul 2025', endDate: 'Jun 2026', impressions: '3.1M', series: 'All Series' },
    ...
    { id: 'act-12', name: 'Local Print Co Programs', sponsor: 'Local Print Co', type: 'product', status: 'active', startDate: 'Sep 2025', endDate: 'May 2026', impressions: '45K', series: '2819 Church Premier League' },
    ...
    { id: 'act-14', name: 'TechVault Live Stats Display', sponsor: 'TechVault', type: 'digital', status: 'active', startDate: 'Jan 2026', endDate: 'Jun 2026', impressions: '120K', series: '3SSB Invitational' },
    ...
    { id: 'act-16', name: 'Adidas Broadcast Overlay', sponsor: 'Adidas', type: 'media', status: 'active', startDate: 'Sep 2025', endDate: 'Jun 2026', impressions: '1.8M', series: 'All Series' },
  ...
  const contracts: SponsorContract[] = [
    { id: 'con-1', sponsor: 'Adidas', tier: 'title', status: 'active', totalValue: '$750,000', startDate: 'Jul 2025', endDate: 'Jun 2028', autoRenew: true, terms: '3-year title sponsorship with annual $250K payments. Includes naming rights, jersey front placement, and broadcast integration.' },
  ...
  const fulfillment: FulfillmentItem[] = [
    { id: 'ff-1', obligation: 'Adidas logo on all match jerseys', sponsor: 'Adidas', status: 'completed', dueDate: 'Aug 2025', category: 'Signage', notes: 'All team jerseys printed and distributed.' },
    { id: 'ff-2', obligation: 'Adidas center-court decal at 3SSB Arena', sponsor: 'Adidas', status: 'completed', dueDate: 'Sep 2025', category: 'Signage', notes: 'Installed before season opener.' },
    { id: 'ff-3', obligation: 'Nike courtside LED panels — 2819 Church League', sponsor: 'Nike', status: 'completed', dueDate: 'Jan 2026', category: 'Signage', notes: 'Panels active for all home matches.' },
    { id: 'ff-4', obligation: 'Gatorade product delivery — Q1 2026', sponsor: 'Gatorade', status: 'completed', dueDate: 'Jan 2026', category: 'Product', notes: '500 units delivered to 3SSB Arena.' },
    ...
    { id: 'ff-7', obligation: 'Adidas broadcast overlay — 3SSB Invitational', sponsor: 'Adidas', status: 'completed', dueDate: 'Jan 2026', category: 'Media', notes: 'Overlay active for all broadcast matches.' },
    ...
    { id: 'ff-12', obligation: 'Adidas quarterly impact report — Q3', sponsor: 'Adidas', status: 'overdue', dueDate: 'Jan 2026', category: 'Reporting', notes: 'Report delayed due to data compilation. ETA: Feb 20.' },
    { id: 'ff-13', obligation: 'Nike VIP hospitality — Adidas Round of 16', sponsor: 'Nike', status: 'upcoming', dueDate: 'Feb 2026', category: 'Hospitality', notes: '10 VIP seats reserved. Catering confirmed.' },
    ...
    { id: 'ff-16', obligation: '3SSB naming rights signage — Spring Showcase', sponsor: 'Adidas', status: 'upcoming', dueDate: 'Mar 2026', category: 'Signage', notes: 'Design approved. Production in progress.' },
  ...
  const assets: SponsorAsset[] = [
    { id: 'ast-1', name: 'Adidas Logo — Primary (SVG)', type: 'logo', sponsor: 'Adidas', uploadDate: 'Jul 2025', fileSize: '245 KB', status: 'approved', usageCount: 34 },
    { id: 'ast-2', name: 'Adidas Logo — White on Dark', type: 'logo', sponsor: 'Adidas', uploadDate: 'Jul 2025', fileSize: '198 KB', status: 'approved', usageCount: 28 },
    ...
    { id: 'ast-10', name: 'Adidas 30s Broadcast Spot', type: 'video', sponsor: 'Adidas', uploadDate: 'Aug 2025', fileSize: '42 MB', status: 'approved', usageCount: 44 },
    ...
    { id: 'ast-15', name: 'Adidas Spring Showcase Banner', type: 'banner', sponsor: 'Adidas', uploadDate: 'Feb 2026', fileSize: '6.1 MB', status: 'pending', usageCount: 0 },
  ...
  const revenue: SponsorRevenue[] = [
    { id: 'rev-1', period: 'Q3 2025', sponsor: 'Adidas', amount: '$62,500', amountValue: 62500, type: 'cash', status: 'received', date: 'Jul 2025' },
    { id: 'rev-2', period: 'Q4 2025', sponsor: 'Adidas', amount: '$62,500', amountValue: 62500, type: 'cash', status: 'received', date: 'Oct 2025' },
    { id: 'rev-3', period: 'Q1 2026', sponsor: 'Adidas', amount: '$62,500', amountValue: 62500, type: 'cash', status: 'received', date: 'Jan 2026' },
    { id: 'rev-4', period: 'Q2 2026', sponsor: 'Adidas', amount: '$62,500', amountValue: 62500, type: 'cash', status: 'projected', date: 'Apr 2026' },
    ...
    { id: 'rev-21', period: 'Renewal Bonus', sponsor: 'Adidas', amount: '$25,000', amountValue: 25000, type: 'bonus', status: 'received', date: 'Jul 2025' },
