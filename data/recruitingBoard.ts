 ...
 * 4 Kanban columns: Watchlist → Active Targets → Priority → Committed
 */

export type BoardStatus = 'Watchlist' | 'Active Targets' | 'Priority' | 'Committed';
export const BOARD_COLUMNS: BoardStatus[] = ['Watchlist', 'Active Targets', 'Priority', 'Committed'];

export const BOARD_COLUMN_COLORS: Record<BoardStatus, string> = {
  Watchlist: '#FF9800',
  'Active Targets': '#2196F3',
  Priority: '#4CAF50',
  Committed: '#9C27B0',
};
