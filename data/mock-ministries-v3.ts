...
export const CATEGORY_COLOR_MAP: Record<MinistryCategory, string> = {
  ...
  women: '#F472B6',
  'young-adults': '#A78BFA',
  'outreach-service': '#14B8A6',
  'worship-media': '#7A5CFF',
  prayer: '#EF4444',
  care: '#EC4899',
  'education-catechism': '#F59E0B',
  'operations-volunteers': '#64748B',
};
...
export const MINISTRIES_FULL: MinistryFull[] = [
  // 1. Sunday Discipleship Groups
  {
    ...
    icon: 'book.fill',
    leaders: [
      { id: 'ldr-olu', name: 'Deacon Olu Adeyemi', initials: 'OA', role: 'Lead', avatarColor: '#6366F1' },
      { id: 'ldr-nkechi', name: 'Sister Nkechi Okafor', initials: 'NO', role: 'Co-Lead', avatarColor: '#818CF8' },
    ],
    members: [
      { id: 'mem-001', name: 'Brother Tunde Bakare', initials: 'TB', role: 'Group Facilitator', avatarColor: '#4F46E5', joinedAt: '2024-09-01' },
      { id: 'mem-002', name: 'Sister Amara Eze', initials: 'AE', role: 'Member', avatarColor: '#7C3AED', joinedAt: '2024-10-15' },
      { id: 'mem-003', name: 'Brother Chidi Nwosu', initials: 'CN', role: 'Group Facilitator', avatarColor: '#6D28D9', joinedAt: '2024-11-03' },
      { id: 'mem-004', name: 'Sister Bimpe Akinola', initials: 'BA', role: 'Member', avatarColor: '#8B5CF6', joinedAt: '2025-01-12' },
      { id: 'mem-005', name: 'Brother Femi Ogundimu', initials: 'FO', role: 'Member', avatarColor: '#5B21B6', joinedAt: '2025-03-20' },
    ],
    memberCount: 42,
    status: 'active',
  ...
  // 2. Youth Ministry
  {
    ...
    icon: 'person.2.fill',
    leaders: [
      { id: 'ldr-david', name: 'Brother David Nwachukwu', initials: 'DN', role: 'Lead', avatarColor: '#6AA9FF' },
      { id: 'ldr-kemi', name: 'Sister Kemi Adeola', initials: 'KA', role: 'Co-Lead', avatarColor: '#93C5FD' },
      { id: 'ldr-seyi', name: 'Brother Seyi Oladipo', initials: 'SO', role: 'Coordinator', avatarColor: '#3B82F6' },
    ],
    members: [
      { id: 'mem-010', name: 'Sister Chioma Onyekachi', initials: 'CO', role: 'Worship Lead', avatarColor: '#60A5FA', joinedAt: '2024-08-15' },
      { id: 'mem-011', name: 'Brother Emeka Igwe', initials: 'EI', role: 'Member', avatarColor: '#2563EB', joinedAt: '2024-09-20' },
      { id: 'mem-012', name: 'Sister Adaeze Chukwu', initials: 'AC', role: 'Member', avatarColor: '#1D4ED8', joinedAt: '2025-01-05' },
      { id: 'mem-013', name: 'Brother Kolade Ogunlesi', initials: 'KO', role: 'Small Group Leader', avatarColor: '#1E40AF', joinedAt: '2025-02-10' },
      { id: 'mem-014', name: 'Sister Folake Balogun', initials: 'FB', role: 'Member', avatarColor: '#3B82F6', joinedAt: '2025-06-01' },
      { id: 'mem-015', name: 'Brother Dayo Ajayi', initials: 'DA', role: 'Member', avatarColor: '#2563EB', joinedAt: '2025-09-14' },
    ],
    memberCount: 18,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 3. Men's Ministry
  {
    ...
    leaders: [
      ...
      { id: 'ldr-gbenga', name: 'Deacon Gbenga Fashola', initials: 'GF', role: 'Co-Lead', avatarColor: '#16A34A' },
    ],
    members: [
      { id: 'mem-020', name: 'Brother Yinka Olumide', initials: 'YO', role: 'Accountability Lead', avatarColor: '#15803D', joinedAt: '2024-03-10' },
      { id: 'mem-021', name: 'Brother Chukwuma Okoye', initials: 'CO', role: 'Member', avatarColor: '#166534', joinedAt: '2024-06-22' },
      { id: 'mem-022', name: 'Brother Kayode Adeniyi', initials: 'KA', role: 'Member', avatarColor: '#14532D', joinedAt: '2024-11-08' },
      { id: 'mem-023', name: 'Brother Obinna Aham', initials: 'OA', role: 'Member', avatarColor: '#4ADE80', joinedAt: '2025-02-01' },
    ],
    memberCount: 20,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 4. Women's Ministry
  {
    ...
    leaders: [
      { id: 'ldr-grace', name: 'Sister Grace Adekunle', initials: 'GA', role: 'Lead', avatarColor: '#F472B6' },
      { id: 'ldr-ngozi', name: 'Sister Ngozi Amadi', initials: 'NA', role: 'Co-Lead', avatarColor: '#EC4899' },
    ],
    members: [
      { id: 'mem-030', name: 'Sister Funke Oladele', initials: 'FO', role: 'Bible Study Lead', avatarColor: '#DB2777', joinedAt: '2024-01-15' },
      { id: 'mem-031', name: 'Sister Ifeoma Okwu', initials: 'IO', role: 'Member', avatarColor: '#BE185D', joinedAt: '2024-04-20' },
      { id: 'mem-032', name: 'Sister Toyin Bello', initials: 'TB', role: 'Member', avatarColor: '#9D174D', joinedAt: '2024-08-10' },
      { id: 'mem-033', name: 'Sister Adaugo Nnaji', initials: 'AN', role: 'Outreach Coordinator', avatarColor: '#831843', joinedAt: '2025-01-03' },
      { id: 'mem-034', name: 'Sister Yewande Akinsanya', initials: 'YA', role: 'Member', avatarColor: '#F9A8D4', joinedAt: '2025-05-18' },
    ],
    memberCount: 32,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 5. Young Adults Fellowship
  {
    ...
    icon: 'person.3.fill',
    leaders: [
      { id: 'ldr-tolu', name: 'Brother Tolu Adesanya', initials: 'TA', role: 'Lead', avatarColor: '#A78BFA' },
      { id: 'ldr-ada', name: 'Sister Ada Uche', initials: 'AU', role: 'Co-Lead', avatarColor: '#8B5CF6' },
    ],
    members: [
      { id: 'mem-040', name: 'Brother Ifeanyi Agu', initials: 'IA', role: 'Worship Lead', avatarColor: '#7C3AED', joinedAt: '2024-07-01' },
      { id: 'mem-041', name: 'Sister Lola Okeowo', initials: 'LO', role: 'Member', avatarColor: '#6D28D9', joinedAt: '2024-09-15' },
      { id: 'mem-042', name: 'Brother Uchenna Nwoke', initials: 'UN', role: 'Member', avatarColor: '#5B21B6', joinedAt: '2025-01-20' },
      { id: 'mem-043', name: 'Sister Temi Oyedele', initials: 'TO', role: 'Social Media', avatarColor: '#4C1D95', joinedAt: '2025-03-08' },
      { id: 'mem-044', name: 'Brother Jide Alabi', initials: 'JA', role: 'Member', avatarColor: '#DDD6FE', joinedAt: '2025-08-12' },
    ],
    memberCount: 22,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 6. Outreach & Missions
  {
    ...
    leaders: [
      { id: 'ldr-daniel', name: 'Brother Daniel Ekwueme', initials: 'DE', role: 'Lead', avatarColor: '#14B8A6' },
      { id: 'ldr-bukola', name: 'Sister Bukola Oni', initials: 'BO', role: 'Coordinator', avatarColor: '#0D9488' },
    ],
    members: [
      { id: 'mem-050', name: 'Brother Nonso Okafor', initials: 'NO', role: 'Logistics', avatarColor: '#0F766E', joinedAt: '2024-02-18' },
      { id: 'mem-051', name: 'Sister Aisha Bello', initials: 'AB', role: 'Member', avatarColor: '#115E59', joinedAt: '2024-06-30' },
      { id: 'mem-052', name: 'Brother Uche Dimka', initials: 'UD', role: 'Member', avatarColor: '#134E4A', joinedAt: '2025-04-10' },
    ],
    memberCount: 10,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 7. Worship Team
  {
    ...
    members: [
      { id: 'mem-060', name: 'Sister Sade Awolowo', initials: 'SA', role: 'Vocalist', avatarColor: '#8B5CF6', joinedAt: '2023-09-01' },
      { id: 'mem-061', name: 'Brother Kunle Fashanu', initials: 'KF', role: 'Keyboardist', avatarColor: '#7C3AED', joinedAt: '2023-09-01' },
      { id: 'mem-062', name: 'Sister Mercy Ibekwe', initials: 'MI', role: 'Vocalist', avatarColor: '#6D28D9', joinedAt: '2024-01-15' },
      { id: 'mem-063', name: 'Brother Dotun Ogundipe', initials: 'DO', role: 'Drummer', avatarColor: '#5B21B6', joinedAt: '2024-03-20' },
      { id: 'mem-064', name: 'Sister Ronke Balogun', initials: 'RB', role: 'Vocalist', avatarColor: '#4C1D95', joinedAt: '2024-08-10' },
      { id: 'mem-065', name: 'Brother Emeka Okolie', initials: 'EO', role: 'Bassist', avatarColor: '#A78BFA', joinedAt: '2025-01-05' },
    ],
    memberCount: 24,
    status: 'active',
    visibility: 'private',
  ...
  // 8. Media Ministry
  {
    ...
    icon: 'video.fill',
    leaders: [
      { id: 'ldr-joy', name: 'Sister Joy Nnamdi', initials: 'JN', role: 'Lead', avatarColor: '#8B5CF6' },
    ],
    members: [
      { id: 'mem-070', name: 'Brother Tunde Ogunleye', initials: 'TO', role: 'Sound Engineer', avatarColor: '#7C3AED', joinedAt: '2024-01-10' },
      { id: 'mem-071', name: 'Sister Nneka Umeh', initials: 'NU', role: 'Camera Operator', avatarColor: '#6D28D9', joinedAt: '2024-04-22' },
      { id: 'mem-072', name: 'Brother Tobi Ayeni', initials: 'TA', role: 'Graphics & Social', avatarColor: '#5B21B6', joinedAt: '2024-08-05' },
      { id: 'mem-073', name: 'Sister Adeola Martins', initials: 'AM', role: 'Livestream Producer', avatarColor: '#4C1D95', joinedAt: '2025-02-20' },
    ],
    memberCount: 8,
    status: 'active',
    visibility: 'private',
  ...
  // 9. Prayer Ministry
  {
    ...
    members: [
      ...
      { id: 'mem-081', name: 'Brother Ikenna Uzoma', initials: 'IU', role: 'Member', avatarColor: '#991B1B', joinedAt: '2024-01-20' },
      { id: 'mem-082', name: 'Sister Bola Adebisi', initials: 'BA', role: 'Member', avatarColor: '#7F1D1D', joinedAt: '2024-07-15' },
      { id: 'mem-083', name: 'Brother Akin Olajide', initials: 'AO', role: 'Member', avatarColor: '#FCA5A5', joinedAt: '2025-03-10' },
    ],
    memberCount: 12,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 10. Care Team
  {
    ...
    members: [
      ...
      { id: 'mem-091', name: 'Brother Samson Olarewaju', initials: 'SO', role: 'Member', avatarColor: '#9D174D', joinedAt: '2024-02-10' },
      { id: 'mem-092', name: 'Sister Jumoke Olatunji', initials: 'JO', role: 'Meal Coordinator', avatarColor: '#831843', joinedAt: '2024-09-01' },
    ],
    memberCount: 8,
    status: 'active',
    visibility: 'private',
  ...
  // 11. Children's Ministry
  {
    ...
    leaders: [
      ...
      { id: 'ldr-titi', name: 'Sister Titilayo Ojo', initials: 'TO', role: 'Co-Lead', avatarColor: '#D97706' },
    ],
    members: [
      { id: 'mem-100', name: 'Sister Chinwe Eze', initials: 'CE', role: 'Teacher (Pre-K)', avatarColor: '#B45309', joinedAt: '2024-01-05' },
      { id: 'mem-101', name: 'Brother Joseph Anyanwu', initials: 'JA', role: 'Teacher (Grade School)', avatarColor: '#92400E', joinedAt: '2024-03-18' },
      { id: 'mem-102', name: 'Sister Osas Ekhator', initials: 'OE', role: 'Crafts & Activities', avatarColor: '#78350F', joinedAt: '2024-08-20' },
      { id: 'mem-103', name: 'Brother Wale Adeyinka', initials: 'WA', role: 'Security & Check-in', avatarColor: '#FCD34D', joinedAt: '2025-01-10' },
    ],
    memberCount: 15,
    status: 'active',
    visibility: 'discoverable',
  ...
  // 12. Ushers & Greeters
  {
    ...
    leaders: [
      { id: 'ldr-bayo', name: 'Deacon Bayo Akinwale', initials: 'BA', role: 'Lead', avatarColor: '#64748B' },
    ],
    members: [
      { id: 'mem-110', name: 'Sister Ronke Adeyemo', initials: 'RA', role: 'Greeter Captain', avatarColor: '#475569', joinedAt: '2024-01-01' },
      { id: 'mem-111', name: 'Brother Lanre Babalola', initials: 'LB', role: 'Usher', avatarColor: '#334155', joinedAt: '2024-05-15' },
      { id: 'mem-112', name: 'Sister Damilola Fashola', initials: 'DF', role: 'Usher', avatarColor: '#1E293B', joinedAt: '2025-01-20' },
      { id: 'mem-113', name: 'Brother Segun Akindele', initials: 'SA', role: 'Usher', avatarColor: '#94A3B8', joinedAt: '2025-06-10' },
    ],
    memberCount: 14,
    status: 'seasonal',
    visibility: 'discoverable',
