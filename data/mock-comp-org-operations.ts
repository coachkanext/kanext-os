 ...
 *
 * ICCLA events at FMU Arena, K-1 Invitational at KaNeXT Center, etc.
 */
...
const MOCK_EVENTS: CompEvent[] = [
  { id: 'evt-1', name: 'ICCLA Championship — Men\'s Basketball', series: 'ICCLA', date: 'Mar 15, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'match', attendees: 4200, staff: 85 },
  { id: 'evt-2', name: 'ICCLA Championship — Women\'s Basketball', series: 'ICCLA', date: 'Mar 16, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'match', attendees: 3800, staff: 82 },
  ...
  { id: 'evt-6', name: 'ICCLA Media Day', series: 'ICCLA', date: 'Mar 12, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'media-day', attendees: 350, staff: 40 },
  ...
  { id: 'evt-8', name: 'ICCLA Teams Practice — Day 1', series: 'ICCLA', date: 'Mar 13, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'practice', attendees: 0, staff: 30 },
  { id: 'evt-9', name: 'ICCLA Teams Practice — Day 2', series: 'ICCLA', date: 'Mar 14, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'practice', attendees: 0, staff: 30 },
  ...
  { id: 'evt-11', name: 'ICCLA Awards Banquet', series: 'ICCLA', date: 'Mar 17, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'ceremony', attendees: 500, staff: 35 },
  ...
  { id: 'evt-13', name: 'ICCLA — Women\'s Semifinals', series: 'ICCLA', date: 'Mar 14, 2026', venue: 'FMU Arena', status: 'scheduled', type: 'match', attendees: 3200, staff: 78 },
  ...
  { id: 'evt-15', name: 'ICCLA Pre-Tournament Reception', series: 'ICCLA', date: 'Mar 11, 2026', venue: 'FMU Arena', status: 'cancelled', type: 'ceremony', attendees: 0, staff: 0 },
];

const MOCK_LOGISTICS: LogisticsItem[] = [
  { id: 'log-1', name: 'Team Charter Bus Fleet — ICCLA', category: 'transport', status: 'confirmed', event: 'ICCLA Championship', vendor: 'Premiere Charter Services', cost: 18500, dueDate: 'Mar 12, 2026' },
  ...
  { id: 'log-3', name: 'Scoreboard Transport Crate', category: 'equipment', status: 'in-transit', event: 'ICCLA Championship', vendor: 'AV Logistics Co.', cost: 3400, dueDate: 'Mar 11, 2026' },
  { id: 'log-4', name: 'Hotel Block — Teams & Officials', category: 'accommodation', status: 'confirmed', event: 'ICCLA Championship', vendor: 'Marriott Convention Center', cost: 42000, dueDate: 'Mar 12, 2026' },
  { id: 'log-5', name: 'Security Detail — Championship Finals', category: 'security', status: 'pending', event: 'ICCLA Championship', vendor: 'Sentinel Security Group', cost: 12600, dueDate: 'Mar 15, 2026' },
  ...
  { id: 'log-7', name: 'Team Meals — K-1 Championship', category: 'catering', status: 'pending', event: 'K-1 Invitational — Final', vendor: 'Blue Flame Catering', cost: 6500, dueDate: 'Mar 10, 2026' },
  { id: 'log-8', name: 'Media Credentials & Lanyards', category: 'equipment', status: 'delivered', event: 'ICCLA Media Day', vendor: 'PrintFast Solutions', cost: 1200, dueDate: 'Mar 10, 2026' },
  { id: 'log-9', name: 'VIP Shuttle Service', category: 'transport', status: 'confirmed', event: 'ICCLA Championship', vendor: 'Executive Transport LLC', cost: 4800, dueDate: 'Mar 15, 2026' },
  ...
  { id: 'log-12', name: 'Awards & Trophies Shipment', category: 'equipment', status: 'in-transit', event: 'ICCLA Awards Banquet', vendor: 'Crown Trophy & Awards', cost: 4500, dueDate: 'Mar 15, 2026' },
  ...
  { id: 'log-14', name: 'Team Shuttle — Airport Transfers', category: 'transport', status: 'pending', event: 'ICCLA Championship', vendor: 'Premiere Charter Services', cost: 7200, dueDate: 'Mar 12, 2026' },
  { id: 'log-15', name: 'Catering — Awards Banquet', category: 'catering', status: 'confirmed', event: 'ICCLA Awards Banquet', vendor: 'Savory Events Group', cost: 11400, dueDate: 'Mar 17, 2026' },
  { id: 'log-16', name: 'Court Flooring Installation Crew', category: 'equipment', status: 'confirmed', event: 'ICCLA Championship', vendor: 'Connor Sports', cost: 22000, dueDate: 'Mar 11, 2026' },
];

const MOCK_VENUES: CompVenue[] = [
  { id: 'ven-1', name: 'FMU Arena', city: 'Miami, FL', capacity: 5200, type: 'arena', status: 'booked', amenities: ['LED Scoreboard', 'Press Box', 'Luxury Suites', 'Video Replay', 'Locker Rooms'], contactName: 'Marcus Reeves' },
  ...
  { id: 'ven-3', name: 'FMU Practice Courts', city: 'Miami, FL', capacity: 200, type: 'court', status: 'available', amenities: ['Film Room', 'Weight Room', 'Athletic Training'], contactName: 'David Okafor' },
  ...
  { id: 'ven-7', name: 'FMU Outdoor Complex', city: 'Miami, FL', capacity: 1500, type: 'field', status: 'available', amenities: ['Press Box', 'Bleachers', 'LED Board'], contactName: 'David Okafor' },
  ...
  { id: 'ven-11', name: 'FMU Tennis Center', city: 'Miami, FL', capacity: 800, type: 'court', status: 'available', amenities: ['Scoreboard', 'Shade Structure', 'Officials Area'], contactName: 'David Okafor' },
...
const MOCK_EQUIPMENT: Equipment[] = [
  { id: 'eq-1', name: 'Daktronics Scoreboard — Main', category: 'scoring', quantity: 1, condition: 'excellent', assignedTo: 'FMU Arena', lastInspected: 'Feb 28, 2026' },
  ...
  { id: 'eq-3', name: 'Hawk-Eye Line Calling System', category: 'scoring', quantity: 1, condition: 'excellent', assignedTo: 'FMU Arena', lastInspected: 'Mar 1, 2026' },
  ...
  { id: 'eq-5', name: 'TAG Heuer Shot Clock Set (4x)', category: 'timing', quantity: 4, condition: 'good', assignedTo: 'FMU Arena', lastInspected: 'Feb 22, 2026' },
  ...
  { id: 'eq-7', name: 'Courtside LED Display Panels (12x)', category: 'broadcast', quantity: 12, condition: 'excellent', assignedTo: 'FMU Arena', lastInspected: 'Feb 27, 2026' },
  ...
  { id: 'eq-10', name: 'Trauma Kit — Courtside', category: 'safety', quantity: 4, condition: 'fair', assignedTo: 'FMU Arena / KaNeXT Center', lastInspected: 'Feb 10, 2026' },
  ...
  { id: 'eq-14', name: 'Wireless Referee Mic System', category: 'broadcast', quantity: 3, condition: 'needs-repair', assignedTo: 'FMU Arena', lastInspected: 'Feb 8, 2026' },
  { id: 'eq-15', name: 'Instant Replay Monitor Station', category: 'scoring', quantity: 2, condition: 'excellent', assignedTo: 'FMU Arena', lastInspected: 'Mar 1, 2026' },
...
const MOCK_SCHEDULE: ScheduleBlock[] = [
  ...
  { id: 'sch-8', date: 'Mar 11, 2026', timeStart: '8:00 AM', timeEnd: '12:00 PM', event: 'FMU Arena Court Install', venue: 'FMU Arena', type: 'setup', notes: 'Connor Sports crew; logo paint 10 AM' },
  { id: 'sch-9', date: 'Mar 12, 2026', timeStart: '10:00 AM', timeEnd: '2:00 PM', event: 'ICCLA Media Day', venue: 'FMU Arena', type: 'media-day', notes: 'All 8 teams rotating 20-min slots' },
  { id: 'sch-10', date: 'Mar 13, 2026', timeStart: '9:00 AM', timeEnd: '5:00 PM', event: 'ICCLA Teams Practice — Day 1', venue: 'FMU Arena', type: 'practice', notes: '1-hour slots; shootaround schedule in notes' },
  { id: 'sch-11', date: 'Mar 14, 2026', timeStart: '9:00 AM', timeEnd: '5:00 PM', event: 'ICCLA Teams Practice — Day 2', venue: 'FMU Arena', type: 'practice', notes: 'Same rotation; film room available' },
  { id: 'sch-12', date: 'Mar 14, 2026', timeStart: '7:00 PM', timeEnd: '10:00 PM', event: 'ICCLA — Women\'s Semifinals', venue: 'FMU Arena', type: 'match', notes: '2 games; ESPN2 broadcast' },
  { id: 'sch-13', date: 'Mar 15, 2026', timeStart: '7:00 PM', timeEnd: '10:30 PM', event: 'ICCLA Championship — Men\'s Basketball', venue: 'FMU Arena', type: 'match', notes: 'ESPN broadcast; trophy ceremony on-court' },
  { id: 'sch-14', date: 'Mar 16, 2026', timeStart: '3:00 PM', timeEnd: '6:30 PM', event: 'ICCLA Championship — Women\'s Basketball', venue: 'FMU Arena', type: 'match', notes: 'ESPN2 broadcast; trophy ceremony on-court' },
  { id: 'sch-15', date: 'Mar 17, 2026', timeStart: '6:00 PM', timeEnd: '9:00 PM', event: 'ICCLA Awards Banquet', venue: 'FMU Arena', type: 'ceremony', notes: 'Formal attire; cocktail hour 5:00 PM' },
  { id: 'sch-16', date: 'Mar 18, 2026', timeStart: '8:00 AM', timeEnd: '4:00 PM', event: 'Post-Tournament Teardown', venue: 'FMU Arena', type: 'setup', notes: 'Court removal, signage, AV breakdown' },
];
...
const MOCK_TASKS: OpsTask[] = [
  { id: 'tsk-1', title: 'Confirm ICCLA championship court branding', assignee: 'Marcus Reeves', dueDate: 'Mar 10, 2026', priority: 'urgent', status: 'in-progress', event: 'ICCLA Championship' },
  { id: 'tsk-2', title: 'Distribute media credentials for ICCLA Media Day', assignee: 'Aisha Thompson', dueDate: 'Mar 11, 2026', priority: 'high', status: 'todo', event: 'ICCLA Media Day' },
  { id: 'tsk-3', title: 'Verify hotel block rooming list', assignee: 'Sandra Wen', dueDate: 'Mar 10, 2026', priority: 'high', status: 'in-progress', event: 'ICCLA Championship' },
  { id: 'tsk-4', title: 'Finalize K-1 Championship trophy engraving', assignee: 'Carlos Mendez', dueDate: 'Mar 9, 2026', priority: 'urgent', status: 'todo', event: 'K-1 Invitational' },
  { id: 'tsk-5', title: 'Test Hawk-Eye system calibration', assignee: 'Tech Ops', dueDate: 'Mar 12, 2026', priority: 'high', status: 'todo', event: 'ICCLA Championship' },
  { id: 'tsk-6', title: 'Coordinate shuttle schedule for team arrivals', assignee: 'David Okafor', dueDate: 'Mar 12, 2026', priority: 'medium', status: 'todo', event: 'ICCLA Championship' },
  { id: 'tsk-7', title: 'Repair wireless referee mic system', assignee: 'AV Team', dueDate: 'Mar 11, 2026', priority: 'urgent', status: 'blocked', event: 'ICCLA Championship' },
  { id: 'tsk-8', title: 'Update venue signage for ICCLA branding', assignee: 'Facility Ops', dueDate: 'Mar 11, 2026', priority: 'medium', status: 'in-progress', event: 'ICCLA Championship' },
  { id: 'tsk-9', title: 'Submit security deployment plan to local PD', assignee: 'Sentinel Security', dueDate: 'Mar 13, 2026', priority: 'high', status: 'todo', event: 'ICCLA Championship' },
  ...
  { id: 'tsk-11', title: 'Set up press conference backdrop', assignee: 'Aisha Thompson', dueDate: 'Mar 12, 2026', priority: 'medium', status: 'todo', event: 'ICCLA Media Day' },
  { id: 'tsk-12', title: 'Confirm catering headcount for awards banquet', assignee: 'Sandra Wen', dueDate: 'Mar 14, 2026', priority: 'medium', status: 'todo', event: 'ICCLA Awards Banquet' },
  ...
  { id: 'tsk-14', title: 'Print & distribute event programs (5000 copies)', assignee: 'PrintFast Solutions', dueDate: 'Mar 13, 2026', priority: 'low', status: 'todo', event: 'ICCLA Championship' },
...
const MOCK_REPORTS: OpsReport[] = [
  ...
  { id: 'rpt-4', name: 'Logistics Cost Breakdown — ICCLA', type: 'Financial', date: 'Mar 10, 2026', format: 'XLSX' },
  { id: 'rpt-5', name: 'Equipment Condition Audit — March 2026', type: 'Audit', date: 'Mar 5, 2026', format: 'PDF' },
  { id: 'rpt-6', name: 'Security Deployment Plan — ICCLA Championship', type: 'Operations', date: 'Mar 12, 2026', format: 'PDF' },
  ...
  { id: 'rpt-12', name: 'Transportation Manifest — ICCLA Teams', type: 'Logistics', date: 'Mar 12, 2026', format: 'CSV' },
];
...
const MOCK_ACTIVITY_FEED: ActivityFeedItem[] = [
  ...
  { id: 'af-6', description: 'Security detail for ICCLA finals still pending approval', timestamp: '4h ago', icon: 'shield.fill', color: '#F59E0B' },
