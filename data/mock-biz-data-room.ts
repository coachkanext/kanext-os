 ...
 *
 * All data references KaNeXT entities: Sammy, PBD, Tom, Jordan, potential investors.
 */
...
export const VERSION_HISTORY: VersionEntry[] = [
  ...
  },
  {
    ...
    changeType: 'minor',
    summary: 'Refreshed traction slide with FMU media value data and updated team slide.',
  },
  {
    id: 'ver-003',
    docId: 'doc-009',
    ...
    changeType: 'patch',
    summary: 'Corrected DE registration date and added ICCLA data handling addendum.',
  },
  {
    id: 'ver-004',
    docId: 'doc-002',
...
export const DATA_PACKETS: DataPacket[] = [
  {
    ...
    description: 'Curated bundle for angel and retail investors — pitch deck, 2-page memo, product demo, FMU case study, team bios, and SAFE template.',
    docCount: 6,
    audience: 'retail',
    status: 'active',
