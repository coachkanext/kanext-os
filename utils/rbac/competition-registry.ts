/**
 * Competition Mode RBAC Registry — Constitutional 4D Role Definitions
 *
 * Maps membership_id to Competition Role Lens (CO0-CO11), then provides
 * declarative visibility matrices for every tab/section across Series,
 * Entrant, Event, Dashboard, Org, and Home pill surfaces.
 *
...
export const COMPETITION_ROLES: Record<CompetitionRoleLens, UniversalRoleDefinition> = {
  CO0:  { id: 'CO0',  label: 'System Owner',                authority: Authority.Institutional, scope: 'global',     visibility: Vis.Institutional, decision: Decision.Institutional },
  CO1:  { id: 'CO1',  label: 'Commissioner / League Owner',  authority: Authority.Institutional, scope: 'global',     visibility: Vis.Institutional, decision: Decision.Institutional },
  CO2:  { id: 'CO2',  label: 'Deputy Commissioner / Ops',    authority: Authority.DomainGov,     scope: 'domain',     visibility: Vis.Strategic,     decision: Decision.Strategic },
  CO3:  { id: 'CO3',  label: 'Event Director',               authority: Authority.ProgramGov,    scope: 'program',    visibility: Vis.Competitive,   decision: Decision.Tactical },
  CO4:  { id: 'CO4',  label: 'Head Official / Ref Director',  authority: Authority.Execution,     scope: 'sub-domain', visibility: Vis.Tactical,      decision: Decision.Operational, domainLane: 'officiating' },
  CO5:  { id: 'CO5',  label: 'Official / Referee',            authority: Authority.Execution,     scope: 'sub-domain', visibility: Vis.Community,      decision: Decision.Operational, domainLane: 'officiating' },
  CO6:  { id: 'CO6',  label: 'Team Manager / Head Coach',     authority: Authority.ProgramGov,    scope: 'program',    visibility: Vis.Competitive,   decision: Decision.Tactical },
  CO7:  { id: 'CO7',  label: 'Player / Athlete / Driver',     authority: Authority.Personal,      scope: 'personal',   visibility: Vis.Community,     decision: Decision.Self, isSelfOnly: true },
  CO8:  { id: 'CO8',  label: 'Team Staff / Crew',             authority: Authority.Personal,      scope: 'personal',   visibility: Vis.Community,     decision: Decision.Self },
  CO9:  { id: 'CO9',  label: 'Media / Broadcaster',           authority: Authority.Observer,       scope: 'personal',   visibility: Vis.Public,        decision: Decision.None, isExternal: true },
  CO10: { id: 'CO10', label: 'Sponsor / Partner',             authority: Authority.Observer,       scope: 'personal',   visibility: Vis.Public,        decision: Decision.None, isExternal: true },
  CO11: { id: 'CO11', label: 'Fan / Public',                  authority: Authority.Observer,       scope: 'personal',   visibility: Vis.Public,        decision: Decision.None },
};
...
/** Constitutional: authority >= DomainGov (CO0-CO2) have full access. */
export function isFullAccess(role: CompetitionRoleLens): boolean {
  return COMPETITION_ROLES[role].authority >= Authority.DomainGov;
}

/** Constitutional: authority >= ProgramGov (CO0-CO3, CO6) are staff or above. */
export function isStaffOrAbove(role: CompetitionRoleLens): boolean {
  return COMPETITION_ROLES[role].authority >= Authority.ProgramGov;
}
