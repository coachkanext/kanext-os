...
const ROOMS: EduOrgRoom[] = [
  ...
  // --- FMU (Florida Memorial University) ---
  {
    ...
    memberCount: 14,
    description: 'FMU admissions funnel — applications, reviews, yield campaigns, deposit tracking.',
  ...
  },
  {
    ...
    memberCount: 7,
    description: 'FMU-specific compliance — Title IV status, Clery, FERPA, accreditation prep.',
  ...
  },
  {
    ...
    owner: 'VP Enrollment',
    memberCount: 6,
    description: 'Active incident — FMU Fall 2026 deposits 22% below target. War-room triage.',
