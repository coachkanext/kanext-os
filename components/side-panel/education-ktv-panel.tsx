/**
 * Education KTV Side Panel — President/Student role-aware.
 * President: Channel · Upload · Analytics · Library + Dipson/Settings/Help
 * Student:   Channel · Library + Dipson/Settings/Help
 */
...
export function EducationKtvPanel() {
  const C = useColors();
  ...
  const navItems = isPresident ? OWNER_NAV : MEMBER_NAV;
