...
export const RECRUITING_BOARD: BoardEntry[] = [
  ...
  // Offer Out (1 more to reach 2 total)
  {
    ...
    tags: ['Athletic', 'Versatile', 'Immediate Impact'], shortNotes: 'Portal wing from Pinecrest, top target at the 3', fitScore: 89, motivations: ['Playing Time', 'Culture'], portalEntryDate: '2026-01-05', eligibilityRemaining: 2,
    longNotes: 'Transfer from Pinecrest University (NAIA). 15.8 PPG, 6.3 RPG, 2.1 APG. Long, athletic wing who can score at all three levels. Knows our conference. Multiple KaNeXT Conference programs pursuing. Need to close fast. data_source: demo_seed',
    ...
    relationships: {
      ...
      trustNotes: ['Self-directed but grandmother is influential', 'Left Pinecrest for playing style disagreement, not character issue', 'Former coach vouches strongly'],
    },
    log: [
      ...
      { id: 'log-17-5', type: 'Note', timestamp: daysAgo(2), author: 'Coach Davis', summary: 'Southeastern and Clearwater also have offers out. Visit on Feb 28 is critical.' },
    ],
  },
  ...
  // Visited (1 more to reach 2 total)
  {
    ...
    relationships: {
      ...
      trustNotes: ['Father is very involved, wants to know the 4-year graduation plan', 'JUCO coach says he is the hardest worker on the team', 'Also visited Westfield last week'],
    },
    log: [
  ...
  // Missed (2 to fill the pipeline)
  {
    ...
    longNotes: 'Was a top target at the 2. 6-4 combo guard from Daytona State College. 16.9 PPG, 41% from three. We made strong push but he committed to Summit University (NAIA) on Feb 3 — closer to family in Lakeland. data_source: demo_seed',
    ...
    log: [
      ...
      { id: 'log-19-4', type: 'Status', timestamp: daysAgo(15), author: 'System', summary: 'Committed to Summit University. Closed.', isPinned: true },
    ],
  },
  {
    ...
    tags: ['Rim Protector', 'Immediate Impact'], shortNotes: 'Lost to Clearwater — NIL gap too large',
    longNotes: 'Portal big from South Ridgemont State College. 6-11, 245. 10.2 PPG, 8.8 RPG, 3.5 BPG. Was our top center target. Visited campus Jan 20 and loved it, but Clearwater offered significantly more NIL through their collective. Could not match. data_source: demo_seed',
    ...
    log: [
      ...
      { id: 'log-20-4', type: 'Call', timestamp: daysAgo(18), author: 'Coach Williams', summary: 'Player says Clearwater NIL offer is $12K vs our $5K. Family leaning Clearwater.', who: 'Player' },
      { id: 'log-20-5', type: 'Status', timestamp: daysAgo(11), author: 'System', summary: 'Committed to Clearwater University. NIL gap was deciding factor. Closed.', isPinned: true },
    ],
  },
];
