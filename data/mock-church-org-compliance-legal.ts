...
const POLICIES: CompliancePolicy[] = [
  {
    ...
    version: 2,
    status: 'published',
    owner: 'Pastor Philip Anthony Mitchell',
...
const LEGAL_DOCS: LegalDocument[] = [
  {
    ...
    description: 'Governing bylaws of 2819 Church defining organizational structure, officer roles, membership, voting procedures, and amendment process.',
  },
  {
    id: 'ldoc-002',
...
const EVIDENCE_ITEMS: EvidenceItem[] = [
  ...
  },
  {
    ...
    type: 'attestation',
    status: 'pending',
    submittedBy: 'Pastor Philip Anthony Mitchell',
