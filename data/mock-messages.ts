...
const AUTHORS = {
  ...
  assistant: { name: 'Coach Miller', initials: 'CM', role: 'Assistant', roleBadgeColor: '#9C9790' },
  videoCoord: { name: 'Coach Brooks', initials: 'CB', role: 'Video Coord', roleBadgeColor: '#9C9790' },
  system: { name: 'System', initials: 'SY', role: 'System', roleBadgeColor: '#52525B' },
  player: { name: 'Marcus Johnson', initials: 'MJ', role: 'Player', roleBadgeColor: '#52525B' },
  strength: { name: 'Coach Turner', initials: 'CT', role: 'Strength', roleBadgeColor: '#9C9790' },
  compliance: { name: 'Lisa Chen', initials: 'LC', role: 'Compliance', roleBadgeColor: '#9C9790' },
} as const;
...
export const MOCK_FEED: FeedPost[] = [
  ...
  },
  {
    ...
    timestamp: ago(120),
    filter: 'team',
    gameTitle: 'FINAL — Carroll 81, Coastal Carolina 74',
  ...
  },
  {
    ...
    timestamp: ago(4320),
    filter: 'team',
    gameTitle: 'FINAL — Carroll 69, UNC Asheville 72',
...
const CHURCH_THREADS: InboxThread[] = [
  {
    id: 'ch-th-1',
    title: 'Pastor Lisa Brooks',
    icon: 'person.fill',
    participants: ['Pastor James', 'Pastor Sarah'],
  ...
  },
  {
    ...
    icon: 'person.fill',
    participants: ['Pastor James', 'Elder James'],
  ...
  {
    id: 'ch-th-3',
    title: 'Deacon Mary Thompson',
    icon: 'person.fill',
    participants: ['Pastor James', 'Deacon Ruth'],
  ...
  {
    id: 'ch-th-4',
    title: 'David Brooks (Worship)',
    icon: 'person.fill',
    participants: ['Pastor James', 'David Brooks'],
    lastMessage: 'Sunday setlist is finalized. Rehearsal Thursday 7pm.',
    timestamp: ago(180),
    unread: 0,
    messages: [
      { id: 'ch-m4', sender: 'David Brooks', initials: 'DE', isMe: false, content: 'Sunday setlist is finalized. Rehearsal Thursday 7pm.', timestamp: ago(180) },
    ],
  },
  {
    id: 'ch-th-5',
    title: 'Minister David Balogun',
    icon: 'person.fill',
    participants: ['Pastor James', 'Minister David'],
    lastMessage: 'Youth retreat registration closes Friday — 32 signed up so far.',
    timestamp: ago(100),
    unread: 2,
    messages: [
      { id: 'ch-m5', sender: 'Minister David', initials: 'TB', isMe: false, content: 'Youth retreat registration closes Friday — 32 signed up so far.', timestamp: ago(100) },
    ],
  },
  {
    id: 'ch-th-6',
    title: 'Deaconess Angela Ade',
    icon: 'person.fill',
    participants: ['Pastor James', 'Deaconess Angela'],
    lastMessage: 'New members class — 8 people confirmed for Sunday orientation.',
    timestamp: ago(240),
    unread: 0,
    messages: [
      { id: 'ch-m6', sender: 'Deaconess Angela', initials: 'FA', isMe: false, content: 'New members class — 8 people confirmed for Sunday orientation.', timestamp: ago(240) },
    ],
  },
  {
    id: 'ch-th-7',
    title: 'Sister Grace Wilson',
    icon: 'person.fill',
    participants: ['Pastor James', 'Sister Grace'],
  ...
  },
  {
    ...
    icon: 'person.fill',
    participants: ['Pastor James', 'Deacon Michael'],
  ...
  {
    id: 'ch-th-9',
    title: 'New Member — Andrew Davis',
    icon: 'person.fill',
    participants: ['Pastor James', 'Andrew Davis'],
    lastMessage: 'Thank you for the warm welcome Sunday, Pastor. Looking forward to serving.',
    timestamp: ago(1440),
    unread: 1,
    messages: [
      { id: 'ch-m9', sender: 'Andrew Davis', initials: 'AO', isMe: false, content: 'Thank you for the warm welcome Sunday, Pastor. Looking forward to serving.', timestamp: ago(1440) },
    ],
  },
  {
    id: 'ch-th-10',
    ...
    icon: 'person.fill',
    participants: ['Pastor James', 'Brother Michael'],
    lastMessage: 'Live stream equipment upgrade quote attached. Under budget.',
    timestamp: ago(360),
    unread: 1,
    pinned: true,
    messages: [
      { id: 'ch-m10', sender: 'Brother Michael', initials: 'EU', isMe: false, content: 'Live stream equipment upgrade quote attached. Under budget.', timestamp: ago(360) },
    ],
  },
];
...
export function getSourceTagColor(sourceTag: string): { bg: string; text: string } {
  switch (sourceTag) {
    case 'Culture':
      return { bg: '#1A171420', text: '#1A1714' };
    case 'Film':
    case 'Game Ops':
      return { bg: '#B85C5C20', text: '#B85C5C' };
    case 'Player Dev':
      return { bg: '#B8943E20', text: '#B8943E' };
    case 'Recruiting':
      return { bg: '#5A8A6E20', text: '#5A8A6E' };
    case 'Mention':
      return { bg: '#1A171420', text: '#1A1714' };
    case 'System':
      return { bg: '#9C979020', text: '#9C9790' };
    default:
      return { bg: '#1A171420', text: '#1A1714' };
  }
}
