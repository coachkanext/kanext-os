...
export const RECRUITING_BOARD: BoardEntry[] = [
  ...
  },
  {
    ...
    nextStep: 'Contact agent', dueDate: '2026-03-01', recruiter: 'Coach Pearson', updated: '2026-01-20',
    temperature: 'Ice', riskLevel: 'Medium', riskFlags: ['Eligibility / Academics'],
    dueDiligence: makeDueDiligence([], 'Coach Pearson'),
    log: [
      { id: 'log-09-1', type: 'Note', timestamp: daysAgo(25), author: 'Coach Pearson', summary: 'Watching European tape. Visa/eligibility questions to research.' },
    ],
  },
  ...
  // Evaluating
  {
    ...
    nextStep: 'Request game film from coach', dueDate: '2026-02-18', recruiter: 'Coach Pearson', updated: '2026-02-03',
    temperature: 'Warm', riskLevel: 'Low', riskFlags: [],
    dueDiligence: makeDueDiligence([0, 3], 'Coach Pearson'),
    log: [
      { id: 'log-06-1', type: 'Note', timestamp: daysAgo(11), author: 'Coach Pearson', summary: 'Film shows elite shot-blocking instincts. Needs offensive development.' },
      { id: 'log-06-2', type: 'Call', timestamp: daysAgo(7), author: 'Coach Pearson', summary: 'Spoke with HS coach. Very coachable kid, high character.', who: 'HS Coach', nextStep: 'Request game film' },
    ],
  },
  {
  ...
  // Contacted
  {
    ...
    nextStep: 'Watch Feb 14 game vs Olney Central', dueDate: '2026-02-14', recruiter: 'Coach Pearson', updated: '2026-02-01',
    temperature: 'Warm', riskLevel: 'Low', riskFlags: [],
    dueDiligence: makeDueDiligence([0, 3], 'Coach Pearson'),
    relationships: {
      primaryDecisionMaker: { role: 'Father', name: 'James Thompson', commPref: 'call', bestTime: 'Evenings after 7pm', staffOwner: 'Coach Pearson' },
      influencers: [
    ...
    log: [
      { id: 'log-04-1', type: 'Text', timestamp: daysAgo(13), author: 'Coach Pearson', summary: 'DM\'d on Instagram. Responded positively.', who: 'Player' },
      { id: 'log-04-2', type: 'Note', timestamp: daysAgo(10), author: 'Coach Pearson', summary: 'Watching more film. Needs to see defense before moving forward.' },
      { id: 'log-04-3', type: 'Call', timestamp: daysAgo(4), author: 'Coach Pearson', summary: 'Spoke with father. Interested in visiting campus.', who: 'Father', nextStep: 'Watch Feb 14 game' },
    ],
  },
  {
  ...
  // Priority
  {
    ...
    relationships: {
      ...
      influencers: [
        ...
        { role: 'Trainer', name: 'Mike Sanders', commPref: 'call', staffOwner: 'Coach Pearson' },
      ],
  ...
  // Visited
  {
    ...
    relationships: {
      ...
      influencers: [
        ...
        { role: 'AAU Coach', name: 'Tony Williams', commPref: 'call', staffOwner: 'Coach Pearson' },
      ],
  ...
  // Offer Out
  {
    ...
    nextStep: 'Official visit scheduling', dueDate: '2026-02-20', recruiter: 'Coach Pearson', updated: '2026-02-05',
    temperature: 'Hot', riskLevel: 'Medium', riskFlags: ['NIL Expectations Mismatch'],
    dueDiligence: makeDueDiligence([0, 1, 2, 3, 4], 'Coach Pearson'),
    ...
    visit: { visitType: 'Official', proposedDate: '2026-02-22', host: 'Coach Pearson', transportation: 'Program-provided', lodging: 'Overnight with team' },
    relationships: {
      primaryDecisionMaker: { role: 'Mother', name: 'Patricia Johnson', commPref: 'call', bestTime: 'Afternoons', staffOwner: 'Coach Pearson' },
      influencers: [
        { role: 'Father', name: 'Ray Johnson', commPref: 'text', staffOwner: 'Coach Pearson' },
    ...
    log: [
      { id: 'log-02-1', type: 'Visit', timestamp: daysAgo(20), author: 'Coach Pearson', summary: 'Watched 3rd game in person. Dominant on glass.', outcome: 'Ready to extend full offer.' },
      { id: 'log-02-2', type: 'Offer', timestamp: daysAgo(17), author: 'Coach Pearson', summary: 'Extended 100% scholarship. Written offer sent.', isPinned: true },
      { id: 'log-02-3', type: 'NIL', timestamp: daysAgo(16), author: 'Coach Pearson', summary: 'NIL: $8K annual + performance. Through collective.', isPinned: true },
      { id: 'log-02-4', type: 'Call', timestamp: daysAgo(9), author: 'Coach Pearson', summary: 'Spoke with mother. D1 programs offering more NIL. Need to sell culture.', who: 'Mother' },
      { id: 'log-02-5', type: 'Campus Visit', timestamp: daysAgo(3), author: 'Coach Pearson', summary: 'Official visit scheduled for Feb 22.', isPinned: true },
    ],
  },
  ...
  // Committed (3 more to reach 4 total)
  {
    ...
    relationships: {
      ...
      trustNotes: ['Self-directed decision', 'Wants to play in South MSU-Northern close to family in Ft. Lauderdale'],
    },
    log: [
  ...
  },
  {
    ...
    nextStep: 'Academic clearance + housing', dueDate: '2026-05-01', recruiter: 'Coach Pearson', updated: '2026-02-10',
    temperature: 'Close', riskLevel: 'Low', riskFlags: [],
    dueDiligence: makeDueDiligence([0, 1, 2, 3, 5], 'Coach Pearson'),
    ...
    relationships: {
      primaryDecisionMaker: { role: 'Player', name: 'Darius Okafor (self)', commPref: 'text', staffOwner: 'Coach Pearson' },
      influencers: [
        { role: 'Father', name: 'Emmanuel Okafor', commPref: 'call', staffOwner: 'Coach Pearson' },
      ],
      trustNotes: ['Father played professionally in Nigeria', 'Wants son to develop NBA-level physicality', 'Chose Carroll College for playing time and culture'],
    },
    log: [
      { id: 'log-12-1', type: 'Call', timestamp: daysAgo(38), author: 'Coach Pearson', summary: 'Portal outreach. Wants a bigger role and more minutes.', who: 'Player' },
      { id: 'log-12-2', type: 'Campus Visit', timestamp: daysAgo(22), author: 'Coach Pearson', summary: 'First campus visit. Practiced with team.', outcome: 'Good chemistry with current bigs.' },
      { id: 'log-12-3', type: 'Offer', timestamp: daysAgo(17), author: 'Coach Pearson', summary: '75% scholarship. Written offer sent.' },
      { id: 'log-12-4', type: 'Campus Visit', timestamp: daysAgo(10), author: 'Coach Pearson', summary: 'Second visit with father. Met academic advisors.', outcome: 'Father approved. Ready to commit.' },
  ...
  },
  {
    ...
    relationships: {
      ...
      trustNotes: ['Mother wants him close to home', 'HS coach is Carroll College alum — strong connection', 'Chose Carroll College over two D2 offers'],
    },
    log: [
      ...
      { id: 'log-13-2', type: 'Call', timestamp: daysAgo(42), author: 'Coach Davis', summary: 'Spoke with mother. Very interested in Carroll College academics and location.', who: 'Mother' },
  ...
  // Evaluating (1 more to reach 3 total)
  {
    ...
    tags: ['Versatile', 'Athletic'], shortNotes: 'Long wing from College of Central MSU-Northern, two-way potential',
    ...
    nextStep: 'Attend Feb 25 game vs Santa Fe', dueDate: '2026-02-25', recruiter: 'Coach Pearson', updated: '2026-02-12',
    temperature: 'Warm', riskLevel: 'Low', riskFlags: [],
    dueDiligence: makeDueDiligence([0, 3], 'Coach Pearson'),
    log: [
      { id: 'log-14-1', type: 'Note', timestamp: daysAgo(14), author: 'Coach Pearson', summary: 'Film review: excellent length and defensive instincts. Needs to tighten handle.' },
      { id: 'log-14-2', type: 'Call', timestamp: daysAgo(9), author: 'Coach Pearson', summary: 'Spoke with JUCO coach. Says he is very coachable, great in the locker room.', who: 'JUCO Coach', nextStep: 'See him live vs Santa Fe' },
      { id: 'log-14-3', type: 'Note', timestamp: daysAgo(5), author: 'Coach Pearson', summary: 'Updated film notes. Catch-and-shoot looks improved from November tape.' },
    ],
  },
  ...
  // Contacted (1 more to reach 3 total)
  {
    ...
    nextStep: 'Schedule phone call with player and family', dueDate: '2026-02-22', recruiter: 'Coach Pearson', updated: '2026-02-09',
    temperature: 'Warm', riskLevel: 'Medium', riskFlags: ['Eligibility / Academics'],
    dueDiligence: makeDueDiligence([0], 'Coach Pearson'),
    relationships: {
      primaryDecisionMaker: { role: 'Mother', name: 'Denise Brooks', commPref: 'call', bestTime: 'Evenings', staffOwner: 'Coach Pearson' },
      influencers: [
        { role: 'JUCO Coach', name: 'Donnie Tyndall', commPref: 'call', staffOwner: 'Coach Pearson' },
      ],
      trustNotes: ['Mother wants him to graduate — academics are top priority', 'Also hearing from two other NAIA programs'],
    },
    log: [
      { id: 'log-15-1', type: 'Text', timestamp: daysAgo(15), author: 'Coach Pearson', summary: 'Sent initial DM on Instagram. Responded same day — open to learning more.', who: 'Player' },
      { id: 'log-15-2', type: 'Note', timestamp: daysAgo(10), author: 'Coach Pearson', summary: 'Pulled Hudl film. Shot-blocking is elite. Needs a lot of post footwork development.' },
      { id: 'log-15-3', type: 'Call', timestamp: daysAgo(6), author: 'Coach Pearson', summary: 'Quick intro call with player. Wants to know about academic support for student-athletes.', who: 'Player', nextStep: 'Schedule call with mother' },
    ],
  },
  ...
  // Offer Out (1 more to reach 2 total)
  {
    ...
    tags: ['Athletic', 'Versatile', 'Immediate Impact'], shortNotes: 'Portal wing from Dakota State, top target at the 3', fitScore: 89, motivations: ['Playing Time', 'Culture'], portalEntryDate: '2026-01-05', eligibilityRemaining: 2,
    longNotes: 'Transfer from Dakota State University (NAIA). 15.8 PPG, 6.3 RPG, 2.1 APG. Long, athletic wing who can score at all three levels. Knows our conference. Multiple Frontier Conference programs pursuing. Need to close fast. data_source: demo_seed',
    ...
    relationships: {
      ...
      influencers: [
        ...
        { role: 'Grandmother', name: 'Dorothy Washington', commPref: 'call', bestTime: 'Mornings', staffOwner: 'Coach Pearson' },
      ],
      trustNotes: ['Self-directed but grandmother is influential', 'Left Dakota State for playing style disagreement, not character issue', 'Former coach vouches strongly'],
    },
    log: [
      ...
      { id: 'log-17-5', type: 'Note', timestamp: daysAgo(2), author: 'Coach Davis', summary: 'Southeastern and Bellevue also have offers out. Visit on Feb 28 is critical.' },
    ],
  },
  ...
  // Visited (1 more to reach 2 total)
  {
    ...
    nextStep: 'Finalize scholarship offer with AD', dueDate: '2026-02-20', recruiter: 'Coach Pearson', updated: '2026-02-15',
    temperature: 'Hot', riskLevel: 'Low', riskFlags: [],
    dueDiligence: makeDueDiligence([0, 1, 2, 3], 'Coach Pearson'),
    visit: { visitType: 'Official', confirmedDate: '2026-02-08', host: 'Coach Pearson', transportation: 'Self', lodging: 'Overnight with team' },
    relationships: {
      primaryDecisionMaker: { role: 'Father', name: 'Calvin Mitchell', commPref: 'call', bestTime: 'Evenings after 7pm', staffOwner: 'Coach Pearson' },
      influencers: [
        { role: 'JUCO Coach', name: 'Scott Wharton', commPref: 'email', staffOwner: 'Coach Pearson' },
      ],
      trustNotes: ['Father is very involved, wants to know the 4-year graduation plan', 'JUCO coach says he is the hardest worker on the team', 'Also visited Montana Tech last week'],
    },
    log: [
      { id: 'log-18-1', type: 'Call', timestamp: daysAgo(25), author: 'Coach Pearson', summary: 'Initial call. Very interested in our up-tempo system.', who: 'Player' },
      { id: 'log-18-2', type: 'Call', timestamp: daysAgo(18), author: 'Coach Pearson', summary: 'Spoke with father. Wants strong academic support and a graduation path.', who: 'Father' },
      { id: 'log-18-3', type: 'Campus Visit', timestamp: daysAgo(10), author: 'Coach Pearson', summary: 'Official visit Feb 8. Toured campus, practiced with team, dinner with coaches.', outcome: 'Very positive. Said Carroll College felt like home.' },
      { id: 'log-18-4', type: 'Call', timestamp: daysAgo(4), author: 'Coach Pearson', summary: 'Follow-up. Father says they are waiting on our scholarship number.', who: 'Father', nextStep: 'Get offer approved by AD' },
    ],
  },
  ...
  // Missed (2 to fill the pipeline)
  {
    ...
    longNotes: 'Was a top target at the 2. 6-4 combo guard from Daytona State College. 16.9 PPG, 41% from three. We made strong push but he committed to Rocky Mountain College (NAIA) on Feb 3 — closer to family in Lakeland. data_source: demo_seed',
    ...
    log: [
      ...
      { id: 'log-19-2', type: 'Campus Visit', timestamp: daysAgo(30), author: 'Coach Davis', summary: 'Unofficial visit. Toured campus, watched practice.', outcome: 'Liked Carroll College but said distance from family was a concern.' },
      ...
      { id: 'log-19-4', type: 'Status', timestamp: daysAgo(15), author: 'System', summary: 'Committed to Rocky Mountain College. Closed.', isPinned: true },
    ],
  },
  {
    ...
    tags: ['Rim Protector', 'Immediate Impact'], shortNotes: 'Lost to Bellevue — NIL gap too large',
    longNotes: 'Portal big from South MSU-Northern State College. 6-11, 245. 10.2 PPG, 8.8 RPG, 3.5 BPG. Was our top center target. Visited campus Jan 20 and loved it, but Bellevue offered significantly more NIL through their collective. Could not match. data_source: demo_seed',
    nextStep: '', dueDate: '', recruiter: 'Coach Pearson', updated: '2026-02-07',
    temperature: 'Ice', riskLevel: 'Low', riskFlags: ['NIL Expectations Mismatch'],
    dueDiligence: makeDueDiligence([0, 1, 2, 3, 4], 'Coach Pearson'),
    log: [
      { id: 'log-20-1', type: 'Call', timestamp: daysAgo(50), author: 'Coach Pearson', summary: 'Portal outreach. Immediately interested — wants a winning program.', who: 'Player' },
      { id: 'log-20-2', type: 'Campus Visit', timestamp: daysAgo(35), author: 'Coach Pearson', summary: 'Official visit Jan 20. Practiced with team. Dominated in scrimmage.', outcome: 'Staff unanimous — make this offer.' },
      { id: 'log-20-3', type: 'Offer', timestamp: daysAgo(30), author: 'Coach Pearson', summary: '100% scholarship offer extended. Written.', isPinned: true },
      { id: 'log-20-4', type: 'Call', timestamp: daysAgo(18), author: 'Coach Pearson', summary: 'Player says Bellevue NIL offer is $12K vs our $5K. Family leaning Bellevue.', who: 'Player' },
      { id: 'log-20-5', type: 'Status', timestamp: daysAgo(11), author: 'System', summary: 'Committed to Bellevue University. NIL gap was deciding factor. Closed.', isPinned: true },
    ],
  },
];
