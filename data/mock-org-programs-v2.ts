...
export const CROSS_PROGRAM_ALERTS: CrossProgramAlert[] = [
  { id: 'cpa-1', programId: 'prog-base', programName: 'Baseball', type: 'attention', title: 'Baseball: 2 Ops Blockers + Compliance Warning', description: 'Travel bus confirmation overdue for Westfield series. Roster eligibility form for 2 transfers pending NAIA clearinghouse.', severity: 'high', icon: 'exclamationmark.triangle.fill', color: '#EF4444' },
