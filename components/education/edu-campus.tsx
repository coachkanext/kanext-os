...
const ALERT_SEVERITY_COLOR: Record<string, string> = { info: '#3B82F6', warning: '#F59E0B', urgent: '#EF4444' };
...
const BUILDING_STATUS_COLOR: Record<string, string> = { operational: '#22C55E', renovation: '#F59E0B', construction: '#3B82F6', closed: '#EF4444' };
...
const WORK_ORDER_PRIORITY_COLOR: Record<string, string> = { low: '#6B7280', medium: '#F59E0B', high: '#F97316', critical: '#EF4444' };
...
const WORK_ORDER_STATUS_COLOR: Record<string, string> = { open: '#3B82F6', in_progress: '#F59E0B', pending_parts: '#8B5CF6', completed: '#22C55E' };
...
const RENOVATION_STATUS_COLOR: Record<string, string> = {
  on_track: '#22C55E', delayed: '#EF4444', ahead: '#3B82F6', completed: '#22C55E',
};
...
const INCIDENT_SEVERITY_COLOR: Record<string, string> = { minor: '#F59E0B', moderate: '#F97316', major: '#EF4444' };
const INCIDENT_STATUS_COLOR: Record<string, string> = { resolved: '#22C55E', under_investigation: '#F59E0B', open: '#3B82F6' };
...
const INTRAMURAL_STATUS_COLOR: Record<string, string> = { active: '#22C55E', registration_open: '#3B82F6', upcoming: '#8B5CF6', completed: '#6B7280' };
...
const TREND_COLOR: Record<string, string> = { up: '#22C55E', down: '#EF4444', flat: '#6B7280' };
