...
export const TEMPLATE_COLORS: Record<RoomTemplate, string> = {
  executive_ops: '#8B5CF6',
  fundraising: '#22C55E',
  board_governance: '#3B82F6',
  partner: '#F59E0B',
  acquisition_diligence: '#EF4444',
  finance_close: '#14B8A6',
  payment_rails_launch: '#EC4899',
  compliance_legal: '#6366F1',
  proof_demo: '#F97316',
};
...
const SEEDED_ROOMS: BizRoom[] = [
  // ---- 1. Q1 2026 Executive Ops ----
  {
    ...
    members: [
      { id: 'mem-eo-1', name: 'Sammy Kalejaiye', role: 'Founder / CEO', avatarInitials: 'SK' },
    ...
    artifacts: [
      ...
      { id: 'art-eo-2', name: 'Leadership Sync Deck — Jan.pdf', type: 'presentation', uploadedBy: 'Sammy Kalejaiye', uploadDate: 'Jan 12, 2026' },
    ...
    receipts: [
      { id: 'rcpt-eo-1', type: 'approval', action: 'Q1 hiring plan approved — 15 engineering headcount authorized', actor: 'Sammy Kalejaiye', timestamp: 'Jan 10, 2026 10:32 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-exec-ops-q1', immutable: true },
      { id: 'rcpt-eo-2', type: 'approval', action: 'Budget reallocation approved — $500K Marketing → Product R&D', actor: 'Sammy Kalejaiye', timestamp: 'Jan 18, 2026 3:15 PM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-exec-ops-q1', immutable: true },
      { id: 'rcpt-eo-3', type: 'creation', action: 'Room created — Q1 2026 Executive Ops', actor: 'Sammy Kalejaiye', timestamp: 'Jan 2, 2026 9:00 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-exec-ops-q1', immutable: true },
    ...
    timeline: [
      { id: 'tl-eo-1', action: 'Room created', actor: 'Sammy Kalejaiye', timestamp: 'Jan 2, 2026 9:00 AM' },
      { id: 'tl-eo-2', action: 'Uploaded Q1 2026 OKR Scorecard', actor: 'Jordan Ellis', timestamp: 'Jan 8, 2026 10:15 AM' },
      { id: 'tl-eo-3', action: 'Q1 hiring plan decision approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 10, 2026 10:32 AM' },
      { id: 'tl-eo-4', action: 'Uploaded Leadership Sync Deck — Jan', actor: 'Sammy Kalejaiye', timestamp: 'Jan 12, 2026 4:00 PM' },
      { id: 'tl-eo-5', action: 'Budget reallocation decision approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 18, 2026 3:15 PM' },
  ...
  // ---- 2. Series B Fundraising ----
  {
    ...
    members: [
      { id: 'mem-fb-1', name: 'Sammy Kalejaiye', role: 'Founder / CEO', avatarInitials: 'SK' },
    ...
    artifacts: [
      { id: 'art-fb-1', name: 'Series B Pitch Deck v4.pdf', type: 'presentation', uploadedBy: 'Sammy Kalejaiye', uploadDate: 'Jan 15, 2026' },
    ...
    decisions: [
      { id: 'dec-fb-1', title: 'Set Series B target valuation at $250M pre-money', status: 'approved', proposedBy: 'Sammy Kalejaiye', date: 'Jan 20, 2026', receiptId: 'rcpt-fb-1' },
      ...
      { id: 'dec-fb-3', title: 'Accept Sequoia lead term sheet', status: 'open', proposedBy: 'Sammy Kalejaiye', date: 'Feb 10, 2026' },
    ],
    receipts: [
      { id: 'rcpt-fb-1', type: 'approval', action: 'Series B target valuation set — $250M pre-money', actor: 'Sammy Kalejaiye', timestamp: 'Jan 20, 2026 2:00 PM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-fundraising-b', immutable: true },
      ...
      { id: 'rcpt-fb-3', type: 'creation', action: 'Room created — Series B Fundraising', actor: 'Sammy Kalejaiye', timestamp: 'Jan 5, 2026 9:00 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-fundraising-b', immutable: true },
    ],
    timeline: [
      { id: 'tl-fb-1', action: 'Room created', actor: 'Sammy Kalejaiye', timestamp: 'Jan 5, 2026 9:00 AM' },
      { id: 'tl-fb-2', action: 'Uploaded Series B Pitch Deck v4', actor: 'Sammy Kalejaiye', timestamp: 'Jan 15, 2026 11:00 AM' },
      { id: 'tl-fb-3', action: 'Valuation target decision approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 20, 2026 2:00 PM' },
  ...
  // ---- 3. Board Governance ----
  {
    ...
    members: [
      { id: 'mem-bg-1', name: 'Sammy Kalejaiye', role: 'Chairman / CEO', avatarInitials: 'SK' },
    ...
    artifacts: [
      ...
      { id: 'art-bg-3', name: 'Q1 Board Meeting Agenda.pdf', type: 'document', uploadedBy: 'Sammy Kalejaiye', uploadDate: 'Feb 1, 2026' },
    ],
    decisions: [
      ...
      { id: 'dec-bg-3', title: 'Authorize Series B fundraising process', status: 'approved', proposedBy: 'Sammy Kalejaiye', date: 'Jan 5, 2026', receiptId: 'rcpt-bg-3' },
    ],
    receipts: [
      ...
      { id: 'rcpt-bg-4', type: 'creation', action: 'Room created — Board Governance', actor: 'Sammy Kalejaiye', timestamp: 'Sep 1, 2025 9:00 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-board-gov', immutable: true },
    ],
    timeline: [
      { id: 'tl-bg-1', action: 'Room created', actor: 'Sammy Kalejaiye', timestamp: 'Sep 1, 2025 9:00 AM' },
  ...
  // ---- 5. Target Bank Acquisition ----
  {
    ...
    members: [
      { id: 'mem-tb-1', name: 'Sammy Kalejaiye', role: 'CEO / Deal Lead', avatarInitials: 'SK' },
    ...
    decisions: [
      { id: 'dec-tb-1', title: 'Proceed to Phase 2 due diligence — full financial audit', status: 'approved', proposedBy: 'Sammy Kalejaiye', date: 'Jan 25, 2026', receiptId: 'rcpt-tb-1' },
      ...
      { id: 'dec-tb-3', title: 'Final acquisition offer — $42M all-stock', status: 'draft', proposedBy: 'Sammy Kalejaiye', date: 'Feb 12, 2026' },
    ],
    receipts: [
      { id: 'rcpt-tb-1', type: 'approval', action: 'Phase 2 due diligence approved — full financial audit authorized', actor: 'Sammy Kalejaiye', timestamp: 'Jan 25, 2026 4:00 PM', linkedEntity: 'ent-target-bank', linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-target-bank', immutable: true },
      { id: 'rcpt-tb-2', type: 'approval', action: 'External auditor engagement approved — bank charter review', actor: 'Sammy Kalejaiye', timestamp: 'Jan 30, 2026 2:30 PM', linkedEntity: 'ent-target-bank', linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-target-bank', immutable: true },
      { id: 'rcpt-tb-3', type: 'creation', action: 'Room created — Target Bank Acquisition', actor: 'Sammy Kalejaiye', timestamp: 'Jan 15, 2026 9:00 AM', linkedEntity: 'ent-target-bank', linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-target-bank', immutable: true },
    ...
    timeline: [
      { id: 'tl-tb-1', action: 'Room created', actor: 'Sammy Kalejaiye', timestamp: 'Jan 15, 2026 9:00 AM' },
      ...
      { id: 'tl-tb-5', action: 'Phase 2 DD approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 25, 2026 4:00 PM' },
      { id: 'tl-tb-6', action: 'External auditor engagement approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 30, 2026 2:30 PM' },
  ...
  // ---- 8. SOC 2 Compliance ----
  {
    ...
    receipts: [
      { id: 'rcpt-sc-1', type: 'approval', action: 'Deloitte engaged for SOC 2 Type II audit', actor: 'Sammy Kalejaiye', timestamp: 'Jan 5, 2026 4:00 PM', linkedEntity: KANEXT_OPSCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-soc2-compliance', immutable: true },
    ...
    timeline: [
      ...
      { id: 'tl-sc-3', action: 'Deloitte engagement approved', actor: 'Sammy Kalejaiye', timestamp: 'Jan 5, 2026 4:00 PM' },
  ...
  // ---- 9. Product Demo — Investor Day (archived) ----
  {
    ...
    members: [
      { id: 'mem-pd-1', name: 'Sammy Kalejaiye', role: 'CEO / Presenter', avatarInitials: 'SK' },
    ...
    artifacts: [
      { id: 'art-pd-1', name: 'Investor Day Presentation.pdf', type: 'presentation', uploadedBy: 'Sammy Kalejaiye', uploadDate: 'Dec 5, 2025' },
    ...
    receipts: [
      { id: 'rcpt-pd-1', type: 'approval', action: 'Final demo script approved', actor: 'Sammy Kalejaiye', timestamp: 'Dec 9, 2025 6:00 PM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-investor-day-demo', immutable: true },
      { id: 'rcpt-pd-2', type: 'approval', action: 'Live production data (sanitized) approved for demo', actor: 'Sammy Kalejaiye', timestamp: 'Dec 10, 2025 9:00 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-investor-day-demo', immutable: true },
      { id: 'rcpt-pd-3', type: 'creation', action: 'Room created — Product Demo — Investor Day', actor: 'Sammy Kalejaiye', timestamp: 'Nov 20, 2025 9:00 AM', linkedEntity: KANEXT_HOLDCO, linkedTab: 'rooms' as BizOrgTab, linkedId: 'room-investor-day-demo', immutable: true },
    ],
    timeline: [
      { id: 'tl-pd-1', action: 'Room created', actor: 'Sammy Kalejaiye', timestamp: 'Nov 20, 2025 9:00 AM' },
      { id: 'tl-pd-2', action: 'Uploaded Investor Day Presentation', actor: 'Sammy Kalejaiye', timestamp: 'Dec 5, 2025 4:00 PM' },
      { id: 'tl-pd-3', action: 'Uploaded Demo Script — Final', actor: 'David Okafor', timestamp: 'Dec 8, 2025 2:00 PM' },
      { id: 'tl-pd-4', action: 'Demo script approved', actor: 'Sammy Kalejaiye', timestamp: 'Dec 9, 2025 6:00 PM' },
      { id: 'tl-pd-5', action: 'Live data for demo approved', actor: 'Sammy Kalejaiye', timestamp: 'Dec 10, 2025 9:00 AM' },
