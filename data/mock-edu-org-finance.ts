...
const LEDGER_POSTINGS: LedgerPosting[] = [
  ...
  },
  {
    ...
    explainChain: [
      ...
      'Coach Pearson notified to submit documentation by Feb 18',
    ],
...
const EXCEPTION_RISKS: ExceptionRiskItem[] = [
  ...
  },
  {
    ...
    severity: 'warning',
    category: 'Budget',
    description: 'Howard Athletics at 92% forecast burn with only 67% of fiscal year elapsed. Team travel costs driving variance. Conference schedule changes contributing factor.',
