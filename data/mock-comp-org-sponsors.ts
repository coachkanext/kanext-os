...
export function getCompSponsorsData(_scope: string) {
  ...
  const recentActivity = [
    { id: 'ra-1', text: 'Nike activation "Court Branding" went live for KaNeXT Invitational Round of 16', time: '1h ago' },
  ...
  const activations: Activation[] = [
    ...
    { id: 'act-6', name: 'Nike Social Media Campaign', sponsor: 'Nike', type: 'media', status: 'active', startDate: 'Jan 2026', endDate: 'May 2026', impressions: '580K', series: 'KaNeXT Invitational' },
    ...
    { id: 'act-14', name: 'TechVault Live Stats Display', sponsor: 'TechVault', type: 'digital', status: 'active', startDate: 'Jan 2026', endDate: 'Jun 2026', impressions: '120K', series: 'KaNeXT Invitational' },
  ...
  const fulfillment: FulfillmentItem[] = [
    ...
    { id: 'ff-7', obligation: 'KaNeXT broadcast overlay — KaNeXT Invitational', sponsor: 'KaNeXT', status: 'completed', dueDate: 'Jan 2026', category: 'Media', notes: 'Overlay active for all broadcast matches.' },
    ...
    { id: 'ff-13', obligation: 'Nike VIP hospitality — KaNeXT Round of 16', sponsor: 'Nike', status: 'upcoming', dueDate: 'Feb 2026', category: 'Hospitality', notes: '10 VIP seats reserved. Catering confirmed.' },
