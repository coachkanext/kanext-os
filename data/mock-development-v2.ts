  ...
  days: [
    ...
    },
    {
      ...
      sessions: [
        ...
        { id: 'w22-t3', type: 'film', title: 'Scouting Report: Dakota State', time: '5:00 PM', duration: '30 min', focus: 'Dakota State defensive tendencies' },
      ],
    },
    {
      day: 'Wednesday',
      ...
      sessions: [
        ...
        { id: 'w22-w2', type: 'practice', title: 'Walk-Through + Scrimmage', time: '2:00 PM', duration: '2 hr', focus: 'Game plan install: Dakota State' },
      ],
    },
    {
      day: 'Thursday',
      ...
      sessions: [
        ...
        { id: 'w22-th3', type: 'film', title: 'Pre-Game Film', time: '3:00 PM', duration: '30 min', focus: 'Dakota State key actions' },
      ],
    },
    {
      day: 'Friday',
      ...
      sessions: [
        ...
        { id: 'w22-f2', type: 'practice', title: 'Game vs Dakota State University', time: '7:00 PM', duration: '2 hr', focus: 'GAME DAY' },
      ],
    },
    {
      day: 'Saturday',
    ...
    },
    {
      ...
      date: 'Feb 23',
      sessions: [
        { id: 'w22-su1', type: 'film', title: 'Post-Game Film Review', time: '4:00 PM', duration: '45 min', focus: 'Dakota State game review' },
  ...
  days: [
    {
      ...
      date: 'Feb 10',
      sessions: [
        { id: 'w21-m1', type: 'film', title: 'Post-Game Film: Montana Tech', time: '9:00 AM', duration: '45 min', focus: 'Transition offense execution review — 18 fast break points' },
        { id: 'w21-m2', type: 'practice', title: 'Full Practice', time: '2:00 PM', duration: '2 hr', focus: 'Ball security drills, half-court offense flow', notes: 'Emphasis on reducing turnovers — 16 TOs vs Montana Tech' },
    ...
    },
    {
      ...
      sessions: [
        ...
        { id: 'w21-f2', type: 'practice', title: 'Game vs Multnomah', time: '7:00 PM', duration: '2 hr', focus: 'GAME DAY — Carroll W, final score 78-62' },
      ],
    },
    {
      day: 'Saturday',
      ...
      sessions: [
        ...
        { id: 'w21-s2', type: 'film', title: 'Quick-Hits Film: STT Scout', time: '4:00 PM', duration: '30 min', focus: 'Initial scout look at MSU-Northern — Frontier Conference rival game tomorrow' },
      ],
    },
    {
      day: 'Sunday',
      date: 'Feb 16',
      sessions: [
        { id: 'w21-su1', type: 'practice', title: 'Game vs MSU-Northern', time: '4:00 PM', duration: '2 hr', focus: 'GAME DAY — Carroll W 72-65. Carter 18-11-3. Plantey 14 pts (5-9 3PT).' },
...
export const DRILL_ASSIGNMENTS: DrillAssignment[] = [
  ...
  },
  {
    ...
    assignedDate: 'Feb 18',
    status: 'assigned',
    coachNotes: 'Providence top-20 nationally in OREB%. Bigs must box out Carter every possession. Drill with game-speed reps.',
    data_source: 'demo_seed',
  },
  {
    id: 'da-7',
...
export const PLAYER_DEV_NOTES: PlayerDevNote[] = [
  ...
  // Priority 3: Free Throw Improvement
  {
    ...
    actionItems: [
      ...
      'Mental rehearsal: visualize FT routine for 2 minutes before bed (Coach Pearson to check in)',
    ],
    progressIndicator: 'needs-work',
    weekUpdated: 'W22',
    data_source: 'demo_seed',
