...
const MOCK_DECISIONS: OpsDecision[] = [
  {
    ...
    status: 'open',
    proposedBy: 'Sammy Kalejaiye',
    voters: ['Sammy Kalejaiye', 'Board Member A', 'Board Member B'],
    date: 'Mar 3, 2026',
    entityName: SEEDED_ENTITY_NAMES[KANEXT_HOLDCO],
  ...
  },
  {
    ...
    voters: ['Sammy Kalejaiye', 'Derek Novak', 'Marcus Chen'],
    date: 'Feb 15, 2026',
  ...
  },
  {
    ...
    voters: ['Sammy Kalejaiye', 'Derek Novak'],
    date: 'Feb 22, 2026',
