...
export const ENTITY_SCOPE_CHIPS: EntityScopeChip[] = [
  ...
  { key: 'kanext', label: 'Valuetainment' },
...
export const UNIFIED_ENTITIES: UnifiedEntity[] = [
  ...
  },
  {
    ...
    name: 'Valuetainment Events LLC',
    type: 'company',
    scope: 'Valuetainment Events',
    owner: 'Alex Morgan',
    ownerInitials: 'SK',
    status: 'active',
  ...
  // ── Projects (5) ──
  {
    ...
    type: 'project',
    scope: 'Valuetainment \u2192 Engineering',
    owner: 'Adewale Ogundimu',
    ownerInitials: 'AO',
    status: 'active',
  ...
  },
  {
    ...
    type: 'project',
    scope: 'Valuetainment Events \u2192 Events',
    owner: 'Alex Morgan',
    ownerInitials: 'SK',
    status: 'proposed',
  ...
  // ── Opportunities (4) ──
  {
    ...
    name: 'Frontier Conference Package',
    type: 'opportunity',
    scope: 'Valuetainment \u2192 Sales',
    owner: 'Dan Pearson',
    ownerInitials: 'MW',
  ...
  },
  {
    ...
    name: 'Valuetainment School District',
    type: 'opportunity',
    scope: 'Valuetainment \u2192 Sales',
    owner: 'Dan Pearson',
    ownerInitials: 'MW',
...
export const ENTITY_AUDIT_LOG: EntityAuditEntry[] = [
  ...
  },
  {
    ...
    entityName: 'Frontier Conference Package',
...
export function filterEntities(
  ...
  if (scope && scope !== 'all') {
    if (scope === 'my-companies') {
      ...
      result = result.filter(
        (e) => e.type === 'company' || e.scope.includes('Valuetainment'),
      );
    } else if (scope === 'kanext') {
      result = result.filter((e) => e.scope.startsWith('Valuetainment'));
