/**
 * KPay Help — tile-level help for the KPay tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'WALLET',
    rows: [
      { icon: 'wallet.bifold.fill',       title: 'Understanding your balance',     keywords: 'balance wallet funds overview'       },
      { icon: 'arrow.left.arrow.right',   title: 'Sending and receiving money',    keywords: 'send receive transfer payment'       },
      { icon: 'clock',                    title: 'Transfer timing',                keywords: 'transfer timing ach bank days'       },
    ],
  },
  {
    header: 'YOUR CARD',
    rows: [
      { icon: 'creditcard.fill',          title: 'KaNeXT card overview',           keywords: 'card debit spending atm'             },
      { icon: 'dollarsign.circle',        title: 'Spending limits and controls',   keywords: 'limit control freeze spending'       },
      { icon: 'building.columns.fill',    title: 'ATM access',                     keywords: 'atm cash withdrawal bank'            },
    ],
  },
  {
    header: 'INVOICES',
    rows: [
      { icon: 'doc.text.fill',            title: 'Creating and sending invoices',  keywords: 'invoice create send client'          },
      { icon: 'checkmark.circle.fill',    title: 'Tracking invoice payments',      keywords: 'track paid unpaid invoice status'    },
    ],
  },
  {
    header: 'TAX',
    rows: [
      { icon: 'doc.richtext.fill',        title: 'Tax center and 1099s',           keywords: 'tax 1099 irs form income'            },
      { icon: 'number',                   title: 'Adding your SSN or EIN',         keywords: 'ssn ein tax id number'               },
      { icon: 'calendar',                 title: 'Tax year overview',              keywords: 'year annual summary earnings'        },
    ],
  },
];
...
export default function KPayHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>KPay Help</Text>
            </View>
          </View>
