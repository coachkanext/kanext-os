...
export const MOCK_FOLLOWING: FollowingEntry[] = [
  { id: 'w1',  name: 'LeBron James',       handle: '@kingjames',       type: 'person', modeTag: 'Sports',   initials: 'LJ', avatarHue: 30  },
  { id: 'w2',  name: 'Nike',               handle: '@nike',             type: 'brand',  modeTag: 'Sports',   initials: 'NK', avatarHue: 0   },
  ...
  { id: 'w5',  name: 'Serena Williams',    handle: '@serenawilliams',   type: 'person', modeTag: 'Sports',   initials: 'SW', avatarHue: 150 },
  { id: 'w6',  name: 'Adidas',             handle: '@adidas',           type: 'brand',  modeTag: 'Sports',   initials: 'AD', avatarHue: 220 },
  { id: 'w7',  name: 'Obama Foundation',   handle: '@obamafoundation',  type: 'brand',  modeTag: 'Community',initials: 'OF', avatarHue: 260 },
  { id: 'w8',  name: 'Steph Curry',        handle: '@stephcurry30',     type: 'person', modeTag: 'Sports',   initials: 'SC', avatarHue: 240 },
  ...
  { id: 'w12', name: 'Kevin Durant',       handle: '@easymoneysniper',  type: 'person', modeTag: 'Sports',   initials: 'KD', avatarHue: 120 },
  ...
  { id: 'w15', name: 'ESPN',               handle: '@espn',             type: 'brand',  modeTag: 'Sports',   initials: 'ES', avatarHue: 10  },
  { id: 'w16', name: 'Ryan Reynolds',      handle: '@vancityreynolds',  type: 'person', modeTag: 'Personal', initials: 'RR', avatarHue: 160 },
  { id: 'w17', name: 'Peloton',            handle: '@peloton',          type: 'brand',  modeTag: 'Sports',   initials: 'PL', avatarHue: 110 },
  ...
  { id: 'w20', name: 'Simone Biles',       handle: '@simonebiles',      type: 'person', modeTag: 'Sports',   initials: 'SB', avatarHue: 55  },
  { id: 'w21', name: 'Red Bull',           handle: '@redbull',          type: 'brand',  modeTag: 'Sports',   initials: 'RB', avatarHue: 0   },
  ...
  { id: 'w24', name: 'Kobe Bryant Est.',   handle: '@kobebryant',       type: 'person', modeTag: 'Sports',   initials: 'KB', avatarHue: 230 },
  { id: 'w25', name: 'Gates Foundation',   handle: '@gatesfoundation',  type: 'brand',  modeTag: 'Community',initials: 'GF', avatarHue: 170 },
  { id: 'w26', name: 'Dwyane Wade',        handle: '@dwyanewade',       type: 'person', modeTag: 'Sports',   initials: 'DW', avatarHue: 360 },
  ...
  { id: 'w30', name: 'Naomi Osaka',        handle: '@naomiosaka',       type: 'person', modeTag: 'Sports',   initials: 'NO', avatarHue: 300 },
  { id: 'w31', name: 'Anthropic',          handle: '@anthropic',        type: 'brand',  modeTag: 'Business', initials: 'AN', avatarHue: 245 },
  { id: 'w32', name: 'Marcus Rashford',    handle: '@MarcusRashford',   type: 'person', modeTag: 'Sports',   initials: 'MR', avatarHue: 100 },
];
