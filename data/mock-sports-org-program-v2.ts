...
export const PROGRAM_IDENTITY: ProgramIdentity = {
  ...
  season: '2025-26',
  colors: { primary: '#1A1714', secondary: '#B8943E' },
...
export const CALENDAR_MILESTONES: CalendarMilestone[] = [
  ...
  {
    id: 'cm-7',
    title: 'NAA Conference Tournament Bid Deadline',
    date: '2026-03-05',
    type: 'deadline',
    status: 'upcoming',
...
export const PENDING_DECISIONS: PendingDecision[] = [
  ...
  },
  {
    ...
    description: 'Finalize terms with KXU Pack NIL collective. Legal review of revenue-sharing model required.',
    category: 'compliance',
    urgency: 'medium',
...
export const PROGRAM_PARTNERS: ProgramPartner[] = [
  ...
  {
    id: 'pp-4',
    name: 'KXU Pack NIL Collective',
    type: 'nil-collective',
    contact: 'ops@kxupack.com',
