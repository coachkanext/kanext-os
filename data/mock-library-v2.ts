...
export function getTypeColor(type: LibraryItemType): string {
  switch (type) {
    ...
    case 'document': return '#1A1714';
    case 'link': return '#5A8A6E';
    case 'image': return '#B8943E';
    case 'audio': return '#1A1714';
    case 'pack': return '#9C9790';
  }
}
...
const CHURCH_ITEMS: LibraryItem[] = [
  ...
  },
  {
    ...
    type: 'document',
    source: 'Pastor Philip Anthony Mitchell',
    date: 'Feb 5, 2026',
    thumbnailColor: '#1A1714',
    pinned: true,
    shared: true,
...
const EDUCATION_ITEMS: LibraryItem[] = [
  ...
  },
  {
    ...
    type: 'video',
    source: 'Howard University Media',
    date: 'Feb 7, 2026',
    thumbnailColor: '#B85C5C',
    pinned: false,
    shared: true,
  ...
  },
  {
    ...
    type: 'link',
    source: 'Howard University Library',
    date: 'Sep 1, 2025',
    thumbnailColor: '#5A8A6E',
    pinned: false,
    shared: true,
...
const BUSINESS_ITEMS: LibraryItem[] = [
  ...
  {
    id: 'bl-2',
    title: 'Valuetainment Platform Demo Recording',
    type: 'video',
    source: 'Product Team',
    date: 'Feb 10, 2026',
    thumbnailColor: '#B85C5C',
