/**
 * Sports Mode RBAC Registry — Constitutional 4D Role Definitions
 *
...
export const SPORTS_ROLES: Record<SportsRoleLens, UniversalRoleDefinition> = {
  R0:  { id: 'R0',  label: 'System Owner',              authority: Authority.Institutional, scope: 'global',     visibility: Vis.Institutional, decision: Decision.Institutional },
  R1:  { id: 'R1',  label: 'Institution Leadership',    authority: Authority.Institutional, scope: 'global',     visibility: Vis.Institutional, decision: Decision.Institutional },
  R2:  { id: 'R2',  label: 'Athletic Director',         authority: Authority.DomainGov,     scope: 'domain',     visibility: Vis.Strategic,     decision: Decision.Strategic },
  R3:  { id: 'R3',  label: 'Head Coach / GM',           authority: Authority.ProgramGov,    scope: 'program',    visibility: Vis.Competitive,   decision: Decision.Tactical },
  R4:  { id: 'R4',  label: 'Assistant Coach / RC',      authority: Authority.Execution,     scope: 'program',    visibility: Vis.Tactical,      decision: Decision.Operational },
  R5:  { id: 'R5',  label: 'Medical / Performance',     authority: Authority.Execution,     scope: 'sub-domain', visibility: Vis.Tactical,      decision: Decision.Operational, domainLane: 'health' },
  R6:  { id: 'R6',  label: 'Academic / Compliance',     authority: Authority.Execution,     scope: 'sub-domain', visibility: Vis.Tactical,      decision: Decision.Operational, domainLane: 'academic' },
  R7:  { id: 'R7',  label: 'Housing / Meals Operations',authority: Authority.Execution,     scope: 'sub-domain', visibility: Vis.Community,     decision: Decision.Operational, domainLane: 'operations' },
  R8:  { id: 'R8',  label: 'Player',                    authority: Authority.Personal,      scope: 'personal',   visibility: Vis.Community,     decision: Decision.Self, isSelfOnly: true },
  R9:  { id: 'R9',  label: 'Family / Advisors',         authority: Authority.Observer,      scope: 'personal',   visibility: Vis.Community,     decision: Decision.None },
  R10: { id: 'R10', label: 'Student (Non-Athlete)',      authority: Authority.Observer,      scope: 'personal',   visibility: Vis.Public,        decision: Decision.None },
  R11: { id: 'R11', label: 'Fan',                        authority: Authority.Observer,      scope: 'personal',   visibility: Vis.Public,        decision: Decision.None },
  R12: { id: 'R12', label: 'Booster / Donor / NIL',      authority: Authority.Observer,      scope: 'personal',   visibility: Vis.Public,        decision: Decision.None, isExternal: true, domainLane: 'finance' },
  R13: { id: 'R13', label: 'Agent / Scout (External)',    authority: Authority.Observer,      scope: 'personal',   visibility: Vis.Public,        decision: Decision.None, isExternal: true },
};
...
// =============================================================================
// SENSITIVE DATA POLICY — Constitutional enforcement
// =============================================================================

/** Constitutional: authority >= Tactical (R0-R3) can see sensitive data. */
export function canSeeSensitive(role: SportsRoleLens): boolean {
  return SPORTS_ROLES[role].visibility >= Vis.Competitive;
}

/** Constitutional: authority >= Execution (R0-R4) can see coaching actions. */
export function canSeeCoachActions(role: SportsRoleLens): boolean {
  return SPORTS_ROLES[role].authority >= Authority.Execution;
}

/** Constitutional: authority >= DomainGov (R0-R2) can see admin actions. */
export function canSeeAdminActions(role: SportsRoleLens): boolean {
  return SPORTS_ROLES[role].authority >= Authority.DomainGov;
}
