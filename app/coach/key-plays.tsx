    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        {keyPlays.map((play, idx) => {
          ...
          const dotColor = isFmu ? colors.text : '#6B8E6B';
            ...
            <View key={idx}>
              ...
              <View style={[styles.keyPlayCard, { backgroundColor: colors.backgroundSecondary }]}>
                ...
                <View style={styles.keyPlayFooter}>
                  ...
                  {play.impact === 'high' && (
                    <View style={[styles.impactBadge, { backgroundColor: '#c8102e' + '20' }]}>
                      <Text style={[styles.impactText, { color: '#c8102e' }]}>Key Moment</Text>
                    </View>
                  )}
                </View>
              </View>
