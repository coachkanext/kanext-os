...
export const TOP_RACES: TopRace[] = [
  ...
  { id: 'tr-3', title: 'COTA Endurance 500', track: 'Circuit of the Americas', date: 'Feb 1', duration: '2:10:00', thumbnailColor: '#1D9BF0', winner: 'Yuki Tanaka' },
  ...
  { id: 'tr-5', title: 'Road Atlanta Challenge', track: 'Road Atlanta', date: 'Jan 18', duration: '1:35:00', thumbnailColor: '#1D9BF0', winner: 'Diego Reyes' },
  { id: 'tr-6', title: 'Sebring Karting Classic', track: 'Sebring International', date: 'Jan 11', duration: '1:18:40', thumbnailColor: '#1D9BF0', winner: 'Liam Torres' },
  { id: 'tr-7', title: 'Daytona Kart Festival', track: 'Daytona International', date: 'Jan 4', duration: '1:42:15', thumbnailColor: '#1D9BF0', winner: 'Aiden Park' },
...
export const DRIVER_SPOTLIGHTS: DriverSpotlight[] = [
  ...
  { id: 'ds-6', name: 'Kai Okafor', team: 'Thunder Kart Racing', points: 110, thumbnailColor: '#1D9BF0', position: 6 },
];
...
export const TEAM_PROFILES: TeamProfile[] = [
  ...
  { id: 'tp-3', name: 'Rising Sun Motorsport', drivers: 3, wins: 4, thumbnailColor: '#1D9BF0' },
  { id: 'tp-4', name: 'Maximo Racing', drivers: 2, wins: 3, thumbnailColor: '#22C55E' },
  { id: 'tp-5', name: 'Thunder Kart Racing', drivers: 3, wins: 2, thumbnailColor: '#1D9BF0' },
  { id: 'tp-6', name: 'Iron Grid Motorsport', drivers: 2, wins: 1, thumbnailColor: '#1D9BF0' },
];
...
export const CHAMPIONSHIP_STANDINGS: ChampionshipStanding[] = [
  ...
  { id: 'cs-3', driverName: 'Yuki Tanaka', team: 'Rising Sun Motorsport', points: 148, thumbnailColor: '#1D9BF0' },
