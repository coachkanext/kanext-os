...
export const V2_ORGANIZATIONS: V2Organization[] = [
  ...
  { org_id: 'edu_kx',    org_name: 'Lincoln University',   mode: 'education', org_type: 'university',        initials: 'LU', location: 'Oakland, CA'                                    },
  { org_id: 'sports_kx', org_name: "LU Men's Basketball",  mode: 'sports',    org_type: 'college_athletics', initials: 'LU', location: 'Oakland, CA', description: "Lincoln University Men's Basketball" },
...
export const V2_MEMBERSHIPS: V2Membership[] = [
  { membership_id: 'mem_pb_kx',     mode: 'personal',  org_id: 'pb_kx',     role_titles: ['Owner'], permission_tier: 'Full', program_scopes: ['*'] },
  { membership_id: 'mem_biz_kx',    mode: 'business',  org_id: 'biz_kx',    role_titles: ['Owner'], permission_tier: 'Full', program_scopes: ['*'] },
  { membership_id: 'mem_edu_kx',    mode: 'education', org_id: 'edu_kx',    role_titles: ['Owner'], permission_tier: 'Full', program_scopes: ['*'] },
  { membership_id: 'mem_sports_kx', mode: 'sports',    org_id: 'sports_kx', role_titles: ['Owner'], permission_tier: 'Full', program_scopes: ['*'] },
  { membership_id: 'mem_church_kx', mode: 'community', org_id: 'church_kx', role_titles: ['Owner'], permission_tier: 'Full', program_scopes: ['*'] },
];
...
export const V2_PROGRAMS: V2Program[] = [
  { program_id: 'pb_kx_main',     org_id: 'pb_kx',     mode: 'personal',  program_name: 'Personal Brand',    program_type: 'Personal',    source_tag: 'OFFICIAL',    status: 'Active' },
...
export const SEEDED_RECENT_CONTEXTS: RecentContext[] = [
  { mode: 'business',  org_id: 'biz_kx',    program_id: 'biz_kx_ops',     season_id: 'biz_kx_fy2026',  membership_id: 'mem_biz_kx',    derived_role_badge: 'Owner', timestamp: Date.now() - 1000 },
  { mode: 'sports',    org_id: 'sports_kx', program_id: 'kx_mbb',         season_id: 'kx_2025_26',     membership_id: 'mem_sports_kx', derived_role_badge: 'Owner', timestamp: Date.now() - 2000 },
  { mode: 'community', org_id: 'church_kx', program_id: 'church_kx_main', season_id: 'church_kx_2026', membership_id: 'mem_church_kx', derived_role_badge: 'Owner', timestamp: Date.now() - 3000 },
  { mode: 'education', org_id: 'edu_kx',    program_id: 'edu_kx_main',    season_id: 'edu_kx_2025_26', membership_id: 'mem_edu_kx',    derived_role_badge: 'Owner', timestamp: Date.now() - 4000 },
  { mode: 'personal',  org_id: 'pb_kx',     program_id: 'pb_kx_main',     season_id: 'pb_kx_2026',     membership_id: 'mem_pb_kx',     derived_role_badge: 'Owner', timestamp: Date.now() - 5000 },
];
