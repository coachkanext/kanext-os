/**
 * Hub Help — FAQ and support for the Personal Hub tile.
...
const FAQ_SECTIONS: FaqSection[] = [
  {
    header: 'YOUR PROFILE',
    rows: [
      { icon: 'person.crop.rectangle', title: 'Setting up your Hub',          keywords: 'setup hub profile start'           },
      { icon: 'pencil',                 title: 'Editing your bio and links',   keywords: 'bio edit links social handles'      },
      { icon: 'photo',                  title: 'Adding a profile photo',       keywords: 'photo avatar image profile'         },
      { icon: 'qrcode',                 title: 'Your QR code and share link',  keywords: 'qr code share link url'             },
    ],
  },
  {
    header: 'SUBSCRIBERS',
    rows: [
      { icon: 'sparkles',    title: 'Creating subscriber tiers',       keywords: 'tiers subscribers paid membership' },
      { icon: 'envelope.fill', title: 'Welcome DM to new subscribers', keywords: 'welcome dm message new subscriber' },
      { icon: 'tag.fill',    title: 'Managing subscriber perks',       keywords: 'perks benefits subscriber access'  },
    ],
  },
  {
    header: 'CONTENT',
    rows: [
      { icon: 'rectangle.stack',   title: 'Content tab overview',       keywords: 'content posts videos articles'    },
      { icon: 'doc.richtext.fill', title: 'Generating your media kit',  keywords: 'media kit press brand pdf'        },
      { icon: 'chart.bar.fill',    title: 'Reading your analytics',     keywords: 'analytics views engagement stats' },
    ],
  },
  {
    header: 'EARNINGS',
    rows: [
      { icon: 'dollarsign.circle.fill', title: 'Tracking your revenue',    keywords: 'revenue earnings income money'    },
      { icon: 'arrow.up.right.circle',  title: 'Understanding payouts',    keywords: 'payout transfer bank timing'      },
    ],
  },
];
...
export default function HubHelpScreen() {
  const C      = useColors();
        ...
        <View style={s.topBar}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={[s.titlePill, { backgroundColor: C.surface, borderColor: C.separator }]}>
              <Text style={[s.titlePillText, { color: C.label }]}>Hub Help</Text>
            </View>
          </View>
