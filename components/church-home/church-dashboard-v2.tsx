...
const styles = StyleSheet.create({
  ...
  liveBadge: { position: 'absolute', top: 14, right: 14, backgroundColor: '#EF4444', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  ...
  heroSpeaker: { color: 'rgba(255,255,255,0.6)', fontSize: 12, letterSpacing: 0.2 },

  // Next Event
  nextEventCard: { borderRadius: 14, borderWidth: StyleSheet.hairlineWidth, padding: 16, marginBottom: 16 },
  nextEventLabel: { fontSize: 10, fontWeight: '800', letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 4 },
  nextEventTitle: { fontSize: 16, fontWeight: '800', letterSpacing: -0.5, marginBottom: 2 },
  nextEventMeta: { fontSize: 12, marginTop: 2, letterSpacing: 0.1 },
  nextEventSpeaker: { fontSize: 12, marginTop: 2, letterSpacing: 0.1 },
  nextEventSeries: { fontSize: 11, fontWeight: '700', fontStyle: 'italic', marginTop: 4, letterSpacing: 0.3 },
  ...
  commerceTitle: { color: '#fff', fontSize: 14, fontWeight: '800', letterSpacing: -0.3, marginTop: 2 },
  commerceSubtitle: { color: 'rgba(255,255,255,0.5)', fontSize: 10, letterSpacing: 0.2, marginTop: 4 },
  commerceDetail: { color: 'rgba(255,255,255,0.35)', fontSize: 9, letterSpacing: 0.3, marginTop: 2 },
  ...
  metricCell: { width: '50%', paddingVertical: 10, paddingHorizontal: 6 },
  metricValue: { color: '#fff', fontSize: 22, fontWeight: '800', letterSpacing: -0.3 },
  metricLabelRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 3 },
  statusDot: { width: 6, height: 6, borderRadius: 3 },
  metricLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 10, fontWeight: '700', letterSpacing: 0.5, textTransform: 'uppercase' },
  metricDetail: { color: 'rgba(255,255,255,0.35)', fontSize: 9, letterSpacing: 0.2, marginTop: 3 },
});
