...
export const EDU_NEWS: EduNewsItem[] = [
  ...
  },
  {
    ...
    type: 'video',
    duration: '4:15',
    summary: 'The Lions baseball team started the 2026 season with three consecutive wins, highlighted by a no-hitter from freshman pitcher Darius Cole.',
  },
  {
    id: 'news-05',
...
export const ADMISSIONS_PIPELINE: AdmissionsPipelineEntry[] = [
  { id: 'adm-01', name: 'Tiana Brooks', stage: 'Registered', programOfInterest: 'Nursing', previousInstitution: 'Miami-Dade College', gpa: 3.72, applicationDate: '2025-10-15', financialAidStatus: 'approved' },
  { id: 'adm-02', name: 'Darius Washington', stage: 'Enrolled', programOfInterest: 'Business Administration', previousInstitution: 'Broward College', gpa: 3.45, applicationDate: '2025-11-02', financialAidStatus: 'approved' },
  ...
  { id: 'adm-11', name: 'Destiny Moore', stage: 'Inquiry', programOfInterest: 'Public Health', previousInstitution: 'Miami Central HS', gpa: 3.10, applicationDate: '2026-02-10', financialAidStatus: 'not_applied' },
...
export const OUTREACH_EVENTS: OutreachEvent[] = [
  ...
  { id: 'out-07', name: 'Broward County College Fair', date: '2026-02-01', type: 'college_fair', targetAudience: 'High School Students', leadsGenerated: 42, recruiterName: 'Tamika Johnson', status: 'completed' },
  ...
  { id: 'out-09', name: 'North Miami Beach HS Visit', date: '2026-01-20', type: 'high_school_visit', targetAudience: 'Juniors & Seniors', leadsGenerated: 22, recruiterName: 'Marcus Reid', status: 'completed' },
