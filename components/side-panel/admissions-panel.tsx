/**
 * Admissions Side Panel — swipe right on any admissions page.
 * Education mode only. 5 navigation items:
 * Financial Aid, Events, Campaigns, Analytics, Settings.
 */
...
const NAV_ITEMS = [
  { icon: 'dollarsign.circle.fill', label: 'Financial Aid', route: '/(tabs)/(main)/recruits/financial-aid' },
  { icon: 'calendar',               label: 'Events',        route: '/(tabs)/(main)/recruits/events' },
