...
export const COMPANIES: Company[] = [
  ...
  {
    id: 'co-kanext',
    displayName: 'Valuetainment',
    legalName: 'Valuetainment Media LLC',
    dbaName: 'Valuetainment',
    jurisdiction: 'Tennessee',
    entityType: 'LLC',
    addressBlock: [
      'Oluwadara Carter',
...
export const PROOF_EVENTS: ProofEvent[] = [
  {
    id: 'pe-fmu',
    companyId: 'co-kanext',
    name: 'Valuetainment Men\'s Basketball \u2014 Live Proof',
    stage: 'active',
    overview:
      'Deploying Valuetainment OS as the primary operational intelligence layer for the Carroll College men\'s basketball program. This proof event validates the Sports domain end-to-end: recruiting, game operations, player evaluation, team analytics, and coaching intelligence \u2014 all in a live D2 program.',
    kpis: [
...
export const ENGINES: Engine[] = [
  {
    ...
    whyItMatters: ['Every decision Valuetainment makes is filtered through the coach\'s philosophy', 'Eliminates generic recommendations \u2014 everything is contextual'],
  },
  {
    id: 'engine-01',
    name: 'Engine 01 \u2014 Player Evaluation',
    purpose: 'Evaluates individual players across 7 canonical clusters and their subclusters, producing a Valuetainment Rating (KR) for each player.',
...
export const DOCUMENTS_V2: DocumentV2[] = [
  ...
  },
  {
    ...
    summary: 'Guided walkthrough of Valuetainment OS Sports domain showing live game operations, recruiting board, and Nexus intelligence.',
    attachments: [],
  },
  // Governance
  {
    ...
    description: 'MSU-Northern LLC formation documents',
    category: 'governance',
    visibility: 'founder',
    fileType: 'pdf',
    ...
    summary: 'Official certificate of formation for Valuetainment Media LLC filed with the MSU-Northern Division of Corporations.',
    attachments: [],
  },
  {
    id: 'doc-v2-6',
  ...
  // Institutional
  {
    ...
    summary: 'One-page overview of Valuetainment \u2014 mission, product, market, and traction summary for general audiences.',
    attachments: [],
  },
  {
    id: 'doc-v2-10',
  ...
  {
    id: 'doc-v2-13',
    title: 'Valuetainment Proof Event Report',
    ...
    proofEventId: 'pe-fmu',
    summary: 'Detailed report on the Valuetainment men\'s basketball proof event \u2014 KPIs, milestones achieved, product validation findings, and next steps.',
    attachments: ['fmu-kpi-dashboard.png', 'game-ops-screenshots.pdf'],
  },
  {
    id: 'doc-v2-14',
    title: 'IP Assignment Agreement',
    description: 'Intellectual property assignment to Valuetainment',
    category: 'ip',
    visibility: 'founder',
    fileType: 'pdf',
    ...
    summary: 'Assignment of all founder-created intellectual property (code, algorithms, designs) to Valuetainment Media LLC.',
    attachments: [],
  },
  {
    id: 'doc-v2-15',
  ...
  },
  {
    ...
    summary: 'Overview of the Global Intelligence Index \u2014 Valuetainment\'s proprietary framework for cross-domain organizational intelligence scoring.',
    attachments: [],
  },
  {
    id: 'doc-v2-18',
...
export const REVENUE_STREAMS: RevenueStream[] = [
  {
    id: 'rev-1',
    name: 'Platform SaaS',
    description: 'Subscription-based access to Valuetainment OS for sports programs. Tiered by program size, division level, and feature set.',
  ...
  },
  {
    ...
    description: 'Programmatic access to Valuetainment evaluation engines, simulation outputs, and rating data for third-party integrations.',
  ...
  },
  {
    ...
    description: 'White-glove implementation and strategic advisory for enterprise clients deploying Valuetainment across multiple programs.',
...
export const RECENT_UPDATES: RecentUpdate[] = [
  {
    ...
    description: 'Valuetainment proof event metrics refreshed \u2014 24 games tracked, 78% sim accuracy.',
