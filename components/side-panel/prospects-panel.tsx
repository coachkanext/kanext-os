/**
 * Prospects Side Panel — swipe right on any prospects page.
 * Sports mode only. 5 navigation items:
...
const NAV_ITEMS = [
  ...
  { icon: 'eye.fill',                label: 'Watchlist',      route: '/(tabs)/(main)/recruits/watchlist' },
  { icon: 'bell.fill',               label: 'Alerts',         route: '/(tabs)/(main)/recruits/alerts' },
  { icon: 'rectangle.split.3x1',     label: 'Comparisons',    route: '/(tabs)/(main)/recruits/comparisons' },
