...
const BATCH_ITEMS_REIMBURSEMENT: RailsBatchItem[] = [
  { id: 'bi-rmb-001', description: 'Travel — CES Conference', amount: 4_200, recipient: 'Sam Kalejaiye', state: 'proposed' },
  { id: 'bi-rmb-002', description: 'Client Dinner — NYC', amount: 890, recipient: 'Sam Kalejaiye', state: 'proposed' },
