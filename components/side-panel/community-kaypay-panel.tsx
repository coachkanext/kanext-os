/**
 * Community KPay Side Panel.
 * Pastor: Giving · Pay · Invest · Card + Dipson/Settings/Help
 * Member: Wallet · Pay · Invest · Card + Dipson/Settings/Help
 */
...
const ADMIN_NAV: NavItem[] = [
  { icon: 'heart.fill',                label: 'Giving',  route: '/(tabs)/(main)/kaypay/giving'  },
...
export function CommunityKPayPanel() {
  const C = useColors();
    ...
    <View style={s.root}>
      <View style={s.header}>
        <View style={[s.avatar, { backgroundColor: C.separator }]}>
          <Text style={[s.avatarText, { color: C.label }]}>IC</Text>
        </View>
