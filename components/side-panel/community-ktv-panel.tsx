/**
 * Community KTV Side Panel — Pastor/Member role-aware.
 * Pastor: Sermons · Upload · Analytics · Library + Dipson/Settings/Help
 * Member: Sermons · Library + Dipson/Settings/Help
 */
...
export function CommunityKtvPanel() {
  ...
  const navItems = isPastor ? OWNER_NAV : MEMBER_NAV;
