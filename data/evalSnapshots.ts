...
export const EVAL_SNAPSHOTS: EvalSnapshot[] = [
  { id: 'es-01', playerId: 'pp-02', playerName: 'Marcus Thompson', boardEntryId: 'be-01', timestamp: '2026-01-20T14:30:00Z', evaluator: 'Coach Davis', season: '2025-26', summary: 'Elite mid-range scorer with JUCO-level competition. Projects as immediate starter at SG. Needs to improve off-ball defense and conditioning for NAIA pace. High-priority get — best available scorer in our range.', nexusThreadId: 'thread-eval-001' },
  { id: 'es-02', playerId: 'pp-06', playerName: 'Rashad Williams', boardEntryId: 'be-02', timestamp: '2026-01-12T10:15:00Z', evaluator: 'Coach Williams', season: '2025-26', summary: 'Physical PF with relentless motor. Dominant rebounder at JUCO level. Offensively raw — limited to dunks, putbacks, and short-range hooks. Could anchor our frontcourt immediately. Worth the full scholarship investment.', nexusThreadId: 'thread-eval-002' },
