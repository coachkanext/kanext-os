/**
 * Business KPay Side Panel.
 * CEO:    Company Finances · Pay · Invest · Card + Dipson/Settings/Help
 * Client: Wallet           · Pay · Invest · Card + Dipson/Settings/Help
 */
...
const ADMIN_NAV: NavItem[] = [
  { icon: 'building.2.fill',           label: 'Company Finances', route: '/(tabs)/(main)/kaypay/company-finances' },
...
export function BusinessKPayPanel() {
  const C = useColors();
