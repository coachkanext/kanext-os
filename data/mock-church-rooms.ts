...
const SERMON_FEED: ChurchRoomFeedItem[] = [
  { id: 'csr-1', title: 'Walking in Faith', subtitle: 'Faith Forward Series', type: 'sermon', date: daysAgo(1), duration: '42:15', thumbnailColor: '#1A1714', visibilityClass: 0, speaker: 'Pastor Philip Anthony Mitchell' },
  { id: 'csr-2', title: 'The Power of Prayer', subtitle: 'Faith Forward Series', type: 'sermon', date: daysAgo(8), duration: '38:20', thumbnailColor: '#1A1714', visibilityClass: 0, speaker: 'Pastor Philip Anthony Mitchell' },
  { id: 'csr-3', title: 'Grace Under Pressure', subtitle: 'Resilience Series', type: 'sermon', date: daysAgo(15), duration: '36:30', thumbnailColor: '#5A8A6E', visibilityClass: 0, speaker: 'Elder Arik Hayes' },
  { id: 'csr-4', title: 'Love Your Neighbor', subtitle: 'Community Series', type: 'sermon', date: daysAgo(22), duration: '40:10', thumbnailColor: '#B8943E', visibilityClass: 0, speaker: 'Pastor Philip Anthony Mitchell' },
  { id: 'csr-5', title: 'Strength in Surrender', subtitle: 'Resilience Series', type: 'sermon', date: daysAgo(29), duration: '35:45', thumbnailColor: '#B85C5C', visibilityClass: 0, speaker: 'Elder Arik Hayes' },
  ...
  { id: 'csr-7', title: 'Building on the Rock', subtitle: 'Foundations Series', type: 'sermon', date: daysAgo(36), duration: '44:00', thumbnailColor: '#1A1714', visibilityClass: 0, speaker: 'Pastor Philip Anthony Mitchell' },
  { id: 'csr-8', title: "The Shepherd's Voice", subtitle: 'Listening Series', type: 'sermon', date: daysAgo(43), duration: '33:50', thumbnailColor: '#1A1714', visibilityClass: 0, speaker: 'Tatjuana Phillips' },
];

const WORSHIP_FEED: ChurchRoomFeedItem[] = [
  { id: 'cwf-1', title: 'Sunday Morning Worship Set', subtitle: 'Feb 22 Service', type: 'worship', date: daysAgo(1), duration: '18:30', thumbnailColor: '#1A1714', visibilityClass: 0 },
  { id: 'cwf-2', title: 'Praise Night Highlights', subtitle: 'Special Event — Feb 14', type: 'worship', date: daysAgo(9), duration: '12:45', thumbnailColor: '#B8943E', visibilityClass: 0 },
  { id: 'cwf-3', title: '"Great Is Thy Faithfulness"', subtitle: 'Song Segment', type: 'clip', date: daysAgo(8), duration: '6:20', thumbnailColor: '#5A8A6E', visibilityClass: 0 },
  { id: 'cwf-4', title: 'Choir Anniversary Concert', subtitle: 'Full Concert Recording', type: 'worship', date: daysAgo(15), duration: '45:00', thumbnailColor: '#1A1714', visibilityClass: 0 },
  { id: 'cwf-5', title: '"How Great Is Our God"', subtitle: 'Song Segment', type: 'clip', date: daysAgo(22), duration: '5:50', thumbnailColor: '#B85C5C', visibilityClass: 0 },
  { id: 'cwf-6', title: 'Acoustic Worship Session', subtitle: 'Intimate Worship Night', type: 'worship', date: daysAgo(29), duration: '22:10', thumbnailColor: '#1A1714', visibilityClass: 0 },
  ...
  { id: 'cwf-8', title: 'Sunday Morning Worship Set', subtitle: 'Feb 15 Service', type: 'worship', date: daysAgo(8), duration: '20:10', thumbnailColor: '#1A1714', visibilityClass: 0 },
];

const MINISTRY_FEED: ChurchRoomFeedItem[] = [
  { id: 'cmf-1', title: 'Children\'s Church Recap — Feb 22', subtitle: 'Sunday Session', type: 'event', date: daysAgo(1), duration: '28:00', thumbnailColor: '#B85C5C', visibilityClass: 3, ministryName: "Children's Ministry" },
  { id: 'cmf-2', title: 'Volunteer Training: Safety Protocols', subtitle: 'Required Training', type: 'training', date: daysAgo(5), duration: '22:30', thumbnailColor: '#B8943E', visibilityClass: 3, ministryName: "Children's Ministry" },
  { id: 'cmf-3', title: 'Curriculum Walkthrough — March', subtitle: 'Lesson Planning', type: 'training', date: daysAgo(3), duration: '18:00', thumbnailColor: '#1A1714', visibilityClass: 3, ministryName: "Children's Ministry" },
  { id: 'cmf-4', title: 'Children\'s Church Recap — Feb 15', subtitle: 'Sunday Session', type: 'event', date: daysAgo(8), duration: '25:00', thumbnailColor: '#B85C5C', visibilityClass: 3, ministryName: "Children's Ministry" },
  { id: 'cmf-5', title: 'VBS Planning Meeting', subtitle: 'Vacation Bible School Prep', type: 'event', date: daysAgo(12), duration: '40:00', thumbnailColor: '#5A8A6E', visibilityClass: 3, ministryName: "Children's Ministry" },
  { id: 'cmf-6', title: 'Volunteer Briefing — February', subtitle: 'Monthly Check-in', type: 'training', date: daysAgo(15), duration: '15:00', thumbnailColor: '#B8943E', visibilityClass: 3, ministryName: "Children's Ministry" },
];

const TRAINING_FEED: ChurchRoomFeedItem[] = [
  { id: 'ctf-1', title: 'Leadership Training: Conflict Resolution', subtitle: 'Leadership Development', type: 'training', date: daysAgo(5), duration: '55:00', thumbnailColor: '#B8943E', visibilityClass: 2, speaker: 'Elder Arik Hayes' },
  { id: 'ctf-2', title: 'Volunteer Onboarding — 2026', subtitle: 'New Volunteer Orientation', type: 'training', date: daysAgo(10), duration: '32:00', thumbnailColor: '#1A1714', visibilityClass: 2 },
  { id: 'ctf-3', title: 'Safety & Emergency Procedures', subtitle: 'Annual Safety Training', type: 'training', date: daysAgo(14), duration: '28:00', thumbnailColor: '#B85C5C', visibilityClass: 2 },
  { id: 'ctf-4', title: 'Ministry Leader Roundtable', subtitle: 'Q1 Planning Session', type: 'event', date: daysAgo(18), duration: '1:05:00', thumbnailColor: '#5A8A6E', visibilityClass: 3, ministryName: 'Leadership' },
  { id: 'ctf-5', title: 'AV Team Training', subtitle: 'Sound & Media Setup', type: 'training', date: daysAgo(22), duration: '40:00', thumbnailColor: '#1A1714', visibilityClass: 2 },
  { id: 'ctf-6', title: 'Greeter & Usher Training', subtitle: 'Hospitality Ministry', type: 'training', date: daysAgo(28), duration: '20:00', thumbnailColor: '#B8943E', visibilityClass: 2 },
  { id: 'ctf-7', title: 'Pastoral Care Basics', subtitle: 'Deacon & Elder Training', type: 'training', date: daysAgo(35), duration: '48:00', thumbnailColor: '#1A1714', visibilityClass: 3, ministryName: 'Deacon Board' },
];
