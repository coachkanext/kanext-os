/**
 * Sports KTV Side Panel — Head Coach/Player role-aware.
 * Head Coach: Channel · Film · Upload · Analytics · Library + Dipson/Settings/Help
 * Player:     Channel · Highlights · Library + Dipson/Settings/Help
 */
...
const COACH_NAV: NavItem[] = [
  ...
  { icon: 'film.fill',            label: 'Film',            route: '/(tabs)/(main)/kaytv/film' },
...
const PLAYER_NAV: NavItem[] = [
  { icon: 'tv.fill',             label: 'Channel', route: '/(tabs)/(main)/kaytv/my-channel' },
  { icon: 'star.fill',           label: 'Highlights',      route: '/(tabs)/(main)/kaytv/highlights' },
  { icon: 'books.vertical.fill', label: 'Library',         route: '/(tabs)/(main)/kaytv/library' },
];
...
export function SportsKtvPanel() {
  const C = useColors();
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.header}>
        ...
        <Text style={[s.handle, { color: C.secondary }]}>@lumbb</Text>
      </View>
